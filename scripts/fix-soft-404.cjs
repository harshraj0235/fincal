...
const BROKEN_URLS = [
  ...
  // Additional festival/regional pages reported as 404
  '/festival-info/ancient-calendar-converter',
  '/festival-info/god-goddess-association',
  '/festival-info/celebrated-abroad',
  '/regional-tools/local-recipe-suggestion',
  
  // Legacy sitemap alias
  '/sitemap-news-economy.xml',
  
  // Legacy sections and blog aliases not present
  '/finance-blog/tax-saving-investments-section-80c-india-2025',
  
  // Legacy tools that were renamed
  '/finance-tools/flexi-sip-planner',
  '/finance-tools/long-term-capital-gains-estimator',
  
  // Religious tools mislinked
  '/religious-tools/nakshatra-rashi-compatibility',
  '/religious-tools/horoscope-festival-recommendation',
  '/religious-tools/which-god-worship-today',
  '/religious-tools/vrat-parana-time',
  '/religious-tools/personalized-bhajan-playlist',
