...
const REITsVsFDROIVisualizer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="REITsVsFDROIVisualizer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our REITsVsFDROIVisualizer"
...
export default REITsVsFDROIVisualizer;