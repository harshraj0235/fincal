...
import { Calculator, Target, TrendingUp, Shield, BookOpen, Users, DollarSign, PieChart, AlertCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/personal-finance/how-to-manage-personal-finances-india-beginners"
      />
