...
import { Calculator, RotateCcw, TrendingDown, Info, ExternalLink, FileText, AlertCircle, CheckCircle, ArrowRight, Zap, Target, BarChart3, RefreshCw } from 'lucide-react';
