...
// Cap to avoid heap OOM on Cloudflare Pages (build env often ~2GB; 100 pages keeps build under limit)
const MAX_PARAMS = parseInt(process.env.STATIC_PARAMS_LIMIT || '100', 10);
