...
export const digitalRupeeLaunch: NewsGuideSection = {
  ...
  coverage: { mainTopics: [{ title: "CBDC vs UPI vs Cash", description: "तीनों में क्या fark", subtopics: ["Cash: Anonymous, offline, but theft/counterfeit risks, inconvenient for large transactions | UPI: Convenient, instant, zero fees currently but banks want MDR, needs internet, not anonymous | CBDC (e₹): Best of both - Offline works, RBI-backed safety, programmable, but separate wallet friction, privacy questions, adoption uncertain"] }] },
  outlook: { whatToWatch: ["Adoption pace - 10L to 1 crore by March achievable? Merchant acceptance key", "Privacy framework - RBI's balance between traceability and anonymity defining adoption", "UPI MDR decision - If government allows charges on UPI, CBDC free forever becomes advantage"], questions: [{ question: "Should I use Digital Rupee?", answer: "Wait for wider adoption (1+ crore users, more merchants). Currently UPI more convenient with broader acceptance. Digital Rupee useful for offline areas, large cash users, but ecosystem building. Use both - UPI for daily, CBDC for testing/privacy transactions." }] },
  takeaway: { forReaders: ["Digital Rupee pilot at 10L users expanding to 1 cr by March 2025 - Privacy, offline features differentiating from UPI", "Not replacing UPI or cash entirely - Coexistence model, each serving different needs and contexts", "Adoption depends on use cases - If just payment method, UPI sufficient; If privacy, offline, programmability important, CBDC compelling"], forInvestors: ["Payment companies risk uncertain - PhonePe, Google Pay, Paytm business models if CBDC scales big; But near-term (3-5 years) UPI dominance intact", "Banking sector adapting - e₹ distributors earning fees, deposit risk overblown as RBI cautious on scale", "Long-term theme - India digital payments leader globally, infrastructure (UPI + CBDC) enabling fintech innovation exports"] },
