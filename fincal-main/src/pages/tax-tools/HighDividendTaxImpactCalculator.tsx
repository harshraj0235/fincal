...
import { Calculator, Download, Info, TrendingUp, AlertTriangle, FileText, DollarSign, PieChart, BarChart3, TrendingDown, Percent, Calendar } from 'lucide-react';
              ...
              <div className="lg:col-span-2">
                ...
                >
                  <h2 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                    <Calculator className="h-6 w-6 mr-2 text-green-500" />
                    Dividend Details
                  </h2>
