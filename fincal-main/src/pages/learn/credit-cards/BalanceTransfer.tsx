...
import { ArrowRightLeft, Calculator, CheckCircle, AlertCircle, TrendingUp, CreditCard } from 'lucide-react';
      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            What is Credit Card Balance Transfer? (बैलेंस ट्रांसफर क्या है?)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            How Balance Transfer Works (कैसे काम करता है)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Best Balance Transfer Offers 2024 (सबसे अच्छे ऑफर)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Calculate Your Savings (बचत की गणना)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Common Mistakes to Avoid (गलतियां न करें)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            When NOT to Do Balance Transfer (कब न करें)
          </h2>

          <div className="bg-yellow-50 border-2 border-yellow-400 rounded-xl p-6">
            <h3 className="font-bold text-lg text-gray-900 mb-4">⚠️ Avoid Balance Transfer If:</h3>
