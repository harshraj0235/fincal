...
import { 
  ...
  Target, AlertCircle, Briefcase, Search, CreditCard,
  Zap, TrendingDown, RefreshCw, Bike, ArrowRight, Star
} from 'lucide-react';
...
const vehicleLoansLessons = [
  ...
  { id: 4, title: 'Vehicle Loan Eligibility Calculator', titleHindi: 'वाहन लोन पात्रता', slug: 'eligibility-calculator', icon: Calculator, color: 'from-green-500 to-emerald-500', difficulty: 'Beginner', duration: '10 min', badge: 'Calculator' },
  ...
  { id: 10, title: 'Car Loan EMI Calculator', titleHindi: 'कार EMI कैलकुलेटर', slug: 'emi-calculator', icon: Calculator, color: 'from-red-500 to-pink-500', difficulty: 'Beginner', duration: '8 min', badge: 'Tool' },
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/learn/vehicle-loans"
        structuredData={{
