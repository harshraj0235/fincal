...
const GoldLoansHub: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gold Loans - Complete Guide to Gold Loans in India 2024 | MoneyCal Learn</title>
        <meta name="description" content="Complete guide to gold loans in India. Learn about gold loan interest rates, eligibility, application process, documents required, and best banks offering gold loans." />
        <meta name="keywords" content="gold loan, gold loan interest rate, gold loan eligibility, gold loan calculator, gold loan online, gold loan banks" />
        <link rel="canonical" href="https://moneycal.in/learn/gold-loans" />
      </Helmet>
