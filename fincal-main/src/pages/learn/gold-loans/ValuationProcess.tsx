...
import { Scale, Gem, Calculator, Shield, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/learn/gold-loans/valuation-process"
      />
      ...
      >
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start bg-white border-2 border-yellow-300 rounded-lg p-5">
              <Calculator className="h-6 w-6 text-yellow-600 mr-4 flex-shrink-0 mt-1" />
              <div>
