...
import { Calendar, Clock, MapPin, Sun, Moon, Users, Heart, Share2, ChevronRight, Home, ExternalLink, Sparkles, Star, Gift, Info, CheckCircle, AlertCircle, Calculator, Download, BookOpen, Award, TrendingUp, MessageCircle, ThumbsUp, Eye, Timer, Zap, Target, Shield, Bell, Smartphone, Wifi, Battery, Volume2 } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl={`https://moneycal.in/blog/chhath-puja-2025-schedule`}
      />
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }} className="bg-gray-50 rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Link to="/blog/chhath-puja-prasad-recipes" className="group">
                <div className="bg-white rounded-xl p-6 hover:shadow-lg transition-all group-hover:scale-105">
