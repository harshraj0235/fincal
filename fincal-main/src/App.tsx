...
// Lazy load tools (reduces initial bundle for better LCP)
...
function App() {
  useEffect(() => {
    // Defer non-critical init to after first paint (improves LCP)
  ...
  return (
    <>
      <WebVitalsMonitor />
    <Suspense fallback={
      <div className="min-h-screen bg-white flex flex-col" aria-busy="true">
        <div className="h-16 bg-white border-b border-gray-100" />
        <main className="flex-1 p-4 md:p-8">
          <div className="skeleton h-8 w-3/4 max-w-md rounded mb-6" />
      ...
      <Routes>
        ...
        <Route path="*" element={
          <Layout>
            <ScrollToTop />
            <Suspense fallback={
              <div className="min-h-[60vh] flex flex-col p-4 md:p-8" aria-busy="true">
                <div className="skeleton h-8 w-3/4 max-w-md rounded mb-6" />
                <div className="skeleton h-4 w-full rounded mb-2" />
                <div className="skeleton h-4 w-full rounded mb-2" />
                <div className="skeleton h-4 w-5/6 rounded" />
