...
export const NpsCalculator: React.FC = () => {
  ...
  const quickPresets = [
    { label: 'Young Professional (25)', contribution: 5000, employer: 5000, age: 25, equity: 75, return: 10 },
    { label: 'Mid-Career (35)', contribution: 12500, employer: 0, age: 35, equity: 60, return: 9.5 },
    { label: 'Max Tax Benefit', contribution: 16667, employer: 0, age: 30, equity: 50, return: 9 },
    { label: 'Government Employee', contribution: 4000, employer: 5600, age: 30, equity: 50, return: 10 },
    { label: 'Late Starter (45)', contribution: 20000, employer: 0, age: 45, equity: 40, return: 9 },
  ];

  const applyPreset = (preset: typeof quickPresets[0]) => {
    setMonthlyContribution(preset.contribution);
