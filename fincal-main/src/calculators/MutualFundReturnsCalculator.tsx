...
export const MutualFundReturnsCalculator: React.FC = () => {
  ...
  const quickPresets = [
    { label: 'SIP ₹5K 10Y', type: 'sip' as const, amount: 5000, period: 10, return: 12 },
    { label: 'SIP ₹10K 15Y', type: 'sip' as const, amount: 10000, period: 15, return: 12 },
    { label: 'Lumpsum ₹10L', type: 'lumpsum' as const, amount: 1000000, period: 10, return: 11 },
    { label: 'SIP ₹25K 20Y', type: 'sip' as const, amount: 25000, period: 20, return: 12 },
    { label: 'Lumpsum ₹5L 5Y', type: 'lumpsum' as const, amount: 500000, period: 5, return: 10 },
  ];
        ...
        <div className="bg-neutral-50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-[--accent-50] rounded-lg">
              <h3 className="text-lg font-medium text-[--accent-900] mb-2">Investment Tips (2025-2027)</h3>
              <ul className="list-disc list-inside space-y-2 text-sm text-[--accent-700]">
                <li>Start SIP early - compounding works best over 10-20+ years</li>
                <li>Don't stop SIP during market crashes - buy more at lower prices</li>
                <li>Diversify across large-cap, mid-cap, index funds for balanced portfolio</li>
                <li>Choose direct plans over regular plans - save 0.5-1% expense ratio</li>
                <li>Review portfolio annually - switch from underperforming funds</li>
                <li>Stay invested for minimum 7 years in equity funds for best returns</li>
                <li>Use conservative return estimates (10-12%) for financial planning</li>
              </ul>
            </div>
          </div>
        </div>
