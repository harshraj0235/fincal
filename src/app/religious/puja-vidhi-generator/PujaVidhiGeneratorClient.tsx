...
import { Calendar, MapPin, Clock, Sun, Sunrise, Home, ChevronRight, Share2, Download, Bell, ArrowRight, Info, Heart, Gift, Check, Copy, X, Star, Zap, Users, ShoppingBag, ExternalLink, Award, BookOpen, Sparkles, Target, AlertCircle, CheckCircle, XCircle, ListChecks, Flame, Flower2, Music } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600 flex-wrap">
              ...
              <Link href="/religious-tools" className="hover:text-orange-600 transition-colors">
                Religious Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/akshaya-tritiya-muhurat" className="group bg-gradient-to-br from-yellow-50 to-amber-50 p-6 rounded-2xl border-2 border-yellow-200 hover:shadow-xl transition-all">
              ...
              <Link href="/religious-tools" className="group bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-2xl border-2 border-orange-200 hover:shadow-xl transition-all">
