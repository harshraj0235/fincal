...
import { ArrowLeft, Percent, Building, BarChart3, Download, IndianRupee, TrendingUp, Link as LinkIcon } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            <button onClick={() => navigate.back()} className="flex items-center text-neutral-600 hover:text-neutral-900 transition-colors">
            ...
            <div ref={resultsRef} className="space-y-6">
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-emerald-700 hover:text-emerald-900 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-emerald-700 hover:text-emerald-900 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/fx-exposure-risk-calculator" className="text-emerald-700 hover:text-emerald-900 underline">FX Exposure Risk Calculator</Link>
                  <Link href="/corporate-finance/dividend-policy-impact-tool" className="text-emerald-700 hover:text-emerald-900 underline">Dividend Policy Impact Tool</Link>
                </div>
              </div>
            </div>
          </div>
