            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-emerald-50 rounded-3xl p-8 border border-emerald-100">
                ...
                <ul className="space-y-3">
                  <li><Link href="/loan-tools/emi-calculator" className="text-emerald-700 hover:underline flex items-center gap-2 text-sm font-bold"><ArrowRight size={14} /> EMI Calculator India</Link></li>
                  <li><Link href="/loan-tools/prepayment-calculator" className="text-emerald-700 hover:underline flex items-center gap-2 text-sm font-bold"><ArrowRight size={14} /> Prepayment Impact Tool</Link></li>
                  <li><Link href="/corporate-finance/business-valuation-calculator" className="text-emerald-700 hover:underline flex items-center gap-2 text-sm font-bold"><ArrowRight size={14} /> Business Valuation</Link></li>
                  <li><Link href="/loan-tools/loan-affordability" className="text-emerald-700 hover:underline flex items-center gap-2 text-sm font-bold"><ArrowRight size={14} /> Loan Affordability Tool</Link></li>
                </ul>
              </div>
            </div>
          </div>
