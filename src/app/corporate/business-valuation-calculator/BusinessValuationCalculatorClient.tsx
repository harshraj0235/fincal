...
import { ArrowLeft, IndianRupee, TrendingUp, DollarSign, BarChart3, Download, Link as LinkIcon, Building, Target, PieChart } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/ma-synergy-estimator" className="text-blue-600 hover:text-blue-800 underline">M&A Synergy Estimator</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-blue-600 hover:text-blue-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/cost-capital-benchmarking" className="text-blue-600 hover:text-blue-800 underline">Cost of Capital Benchmarking</Link>
                  <Link href="/corporate-finance/scenario-analysis-simulator" className="text-blue-600 hover:text-blue-800 underline">Scenario Analysis Simulator</Link>
                </div>
              </div>
            </div>
          </div>
