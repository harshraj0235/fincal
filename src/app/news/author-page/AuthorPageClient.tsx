...
import { Calendar, ArrowRight, ArrowLeft, User, Briefcase, BookOpen, Globe, ChevronLeft, ChevronRight } from "lucide-react";
                ...
                {author.socialProfiles && (
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    ...
                    {author.socialProfiles.twitter && (
                      ...
                      >
                        <Globe className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                        <span className="font-medium text-xs sm:text-sm">Globe</span>
                      </a>
                    )}
