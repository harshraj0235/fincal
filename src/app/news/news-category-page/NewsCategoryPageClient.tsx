      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <nav aria-label="Breadcrumb" className="text-sm text-neutral-600">
          <ol className="flex flex-wrap items-center gap-1">
            ...
            <li><Link href="/news" className="hover:text-blue-600 transition-colors">News</Link></li>
            <li aria-hidden="true"> &gt; </li>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12">
        ...
        <div className="bg-white/90 border border-gray-200 rounded-2xl shadow-sm p-6 mt-12">
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-sm">
            <Link href="/editorial-policy" className="text-blue-700 underline">Editorial policy</Link>
            <Link href="/about-us" className="text-blue-700 underline">About MoneyCal</Link>
            <Link href="/contact-us" className="text-blue-700 underline">Contact</Link>
          </div>
        </div>
      </div>
    </div>
