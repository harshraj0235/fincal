            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-auto lg:h-[600px]">
              ...
              <div className="lg:col-span-4 h-full hidden lg:block overflow-y-auto hide-scrollbar space-y-6">
                ...
                {trendingArticles.map((art) => (
                  <Link
                    key={art.id}
                    href={`/news/${art.category}/${art.slug}`}
        ...
        <section className="mt-32 space-y-8">
          ...
          <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-sm">
            ...
            <div className="text-sm text-slate-600 leading-relaxed space-y-3">
              ...
              <p>
                Our coverage includes <Link href="/ipo" className="text-blue-600 hover:text-blue-800 font-semibold">IPO tracking and analysis</Link> with GMP estimates, <Link href="/calculators/mutual-fund-returns-calculator" className="text-blue-600 hover:text-blue-800 font-semibold">mutual fund performance tracking</Link>, banking sector updates, and startup funding news. Pair our news with MoneyCal's <Link href="/calculators/sip-calculator" className="text-blue-600 hover:text-blue-800 font-semibold">SIP Calculator</Link>, <Link href="/calculators/emi-calculator" className="text-blue-600 hover:text-blue-800 font-semibold">EMI Calculator</Link>, and <Link href="/calculators/income-tax-calculator" className="text-blue-600 hover:text-blue-800 font-semibold">Income Tax Calculator</Link> for a complete financial planning experience.
              </p>
            </div>
            <div className="mt-4 flex flex-wrap gap-2">
              <Link href="/blog" className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full hover:bg-blue-100 transition-colors">Finance Blog →</Link>
              <Link href="/learn" className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full hover:bg-blue-100 transition-colors">Learn Finance →</Link>
              <Link href="/calculators" className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full hover:bg-blue-100 transition-colors">200+ Calculators →</Link>
              <Link href="/ipo" className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full hover:bg-emerald-100 transition-colors">IPO Dashboard →</Link>
            </div>
          </div>
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-sm relative overflow-hidden group">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4 border-t border-slate-50">
                  <Link href="/editorial-policy" className="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-blue-600 transition-colors italic border-b border-transparent hover:border-blue-600">Editorial Policy</Link>
                  <Link href="/about-us" className="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-blue-600 transition-colors italic border-b border-transparent hover:border-blue-600">Our Experts</Link>
                </div>
              </div>
            </div>
