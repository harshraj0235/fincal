...
import SimpleDailyExpenseTracker from '@/calculators/excel/SimpleDailyExpenseTracker';
import MonthlyBudgetPlanner from '@/calculators/excel/MonthlyBudgetPlanner';
import InvoiceGeneratorBusiness from '@/calculators/excel/InvoiceGeneratorBusiness';
import MonthlyBudgetTracker from '@/calculators/excel/MonthlyBudgetTracker';
import DebtPayoffCalculator from '@/calculators/excel/DebtPayoffCalculator';
import InvestmentPortfolioTracker from '@/calculators/excel/InvestmentPortfolioTracker';
import NetWorthCalculator from '@/calculators/excel/NetWorthCalculator';
import VacationBudgetPlanner from '@/calculators/excel/VacationBudgetPlanner';
        ...
        <nav className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <Link href="/excel-tools" className="hover:text-blue-600">Excel Tools</Link>
              <span>/</span>
