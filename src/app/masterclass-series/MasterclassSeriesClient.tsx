                  ...
                  <div className="p-10 flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {getLessonsByModule(mod.id).map((lesson) => (
                        <Link key={lesson.slug} href={`/series/corporate-wealth-masterclass/${lesson.slug}`} className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 border border-transparent hover:border-indigo-200 hover:bg-indigo-50/50 transition-all group/lesson">
                    ...
                    <div className="mt-10 pt-10 border-t border-slate-100 flex justify-between items-center">
                      ...
                      <Link href={`/series/corporate-wealth-masterclass/${getLessonsByModule(mod.id)[0]?.slug}`} className="flex items-center gap-2 text-indigo-600 font-black text-xs uppercase tracking-widest group/btn hover:text-indigo-800 transition-colors">
