...
import { BookOpen, Search, Filter, Book, History, Globe, Map, Music, Home, ChevronRight, X, Star, TrendingUp, Sparkles, Award, Library, GraduationCap, Heart, Users, MapPin, Calendar, FileText, Image, Video, Mic, ArrowRight, Lightbulb, Landmark, Languages, Scroll, Clock, Target, Compass, Flame, Gift, Camera, Film } from "lucide-react";
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-amber-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
