...
import { Calculator, Star, ArrowRight, Search, TrendingUp, DollarSign, FileText, Zap, BarChart3, Wrench, Clock, Rocket, TrendingDown, Percent, Activity, PieChart, Shield, RefreshCw, Gift, Eye, Calendar, Globe, Target, ArrowLeftRight, AlertTriangle, Home, Scale, IndianRupee } from "lucide-react";
...
const TaxToolsHub: React.FC = () => {
  ...
  const taxTools: TaxTool[] = [
    // Available Tools
    {
      ...
      path: '/tax-tools/stcgltcgclassifier',
      isPopular: true,
    ...
    },
    {
      ...
      path: '/tax-tools/section80ctally-analyzer',
    ...
    },
    {
      ...
      category: 'Capital Gains',
      path: '/tax-tools/offset-ltcgwith-annual-exemptions-tool',
    ...
    },
    {
      ...
      path: '/tax-tools/tdsimpact-visualizer-on-gains',
    ...
    },
    {
      ...
      icon: <Shield className="h-6 w-6" />,
      category: 'Tax Planning',
      path: '/tax-tools/npstax-benefit-vs-growth-estimator',
    ...
    },
    {
      ...
      icon: <FileText className="h-6 w-6" />,
      category: 'Tax Filing',
      path: '/tax-tools/itrform-type-helper',
      color: 'from-indigo-500 to-indigo-600',
      status: 'available'
    },
    {
    ...
    },
    {
      ...
      path: '/tax-tools/csvto-tax-summary-tool',
      isNew: true,
      color: 'from-indigo-500 to-indigo-600',
      status: 'available'
    },
    {
      ...
      icon: <Shield className="h-6 w-6" />,
      category: 'Tax Planning',
      path: '/tax-tools/elsslockin-vs-tax-benefit-visualizer',
      isNew: true,
      color: 'from-blue-500 to-blue-600',
      status: 'available'
    },
    {
      ...
      path: '/tax-tools/pfvs-npstax-growth-comparison',
      isNew: true,
      color: 'from-green-500 to-green-600',
      status: 'available'
    },
    {
      ...
      status: 'available'
       ...
       status: 'available'
        ...
        icon: <RefreshCw className="h-6 w-6" />,
        category: 'Mutual Funds',
        path: '/tax-tools/switch-mftax-calculator',
        isNew: true,
        color: 'from-cyan-500 to-cyan-600',
        status: 'available'
      },
      {
        ...
        icon: <PieChart className="h-6 w-6" />,
        category: 'Tax Planning',
        path: '/tax-tools/80cdeduction-bucket-visualizer',
        isNew: true,
        color: 'from-emerald-500 to-emerald-600',
        status: 'available'
      },
      ...
      },
      {
        ...
        icon: <Shield className="h-6 w-6" />,
        category: 'Retirement Planning',
        path: '/tax-tools/pfwithdrawal-tax-preview',
        isNew: true,
        color: 'from-blue-500 to-blue-600',
        status: 'available'
      },
      ...
      },
      {
        ...
        status: 'available'
         ...
         category: 'Tax Planning',
         path: '/tax-tools/hravs-ltatax-comparison-tool',
         isNew: true,
         color: 'from-teal-500 to-teal-600',
         status: 'available'
       },
