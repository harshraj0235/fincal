...
import { ArrowLeft, Heart, IndianRupee, TrendingUp, Users, DollarSign, Info, AlertCircle, Shield, Download, Link as LinkIcon } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/insurance-tools/life-insurance-calculator" className="text-red-600 hover:text-red-800 underline">Life Insurance Calculator</Link>
                  <Link href="/insurance-tools/critical-illness-calculator" className="text-red-600 hover:text-red-800 underline">Critical Illness Calculator</Link>
                  <Link href="/insurance-tools/term-insurance-planner" className="text-red-600 hover:text-red-800 underline">Term Insurance Planner</Link>
                  <Link href="/insurance-tools/portfolio-dashboard" className="text-red-600 hover:text-red-800 underline">Insurance Portfolio Dashboard</Link>
                </div>
              </div>
