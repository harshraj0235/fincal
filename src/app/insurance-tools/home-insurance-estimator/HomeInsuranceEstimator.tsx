...
import { ArrowLeft, Home, IndianRupee, MapPin, Shield, AlertCircle, Building, DollarSign, Download, Link as LinkIcon } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <IndianRupee className="h-6 w-6 text-indigo-600 mr-2" />
                Property Details
              </h2>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/insurance-tools/car-insurance-calculator" className="text-blue-600 hover:text-blue-800 underline">Car Insurance Calculator</Link>
                  <Link href="/insurance-tools/two-wheeler-tracker" className="text-blue-600 hover:text-blue-800 underline">Two-Wheeler Insurance Tracker</Link>
