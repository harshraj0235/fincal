...
import { ArrowLeft, Shield, IndianRupee, TrendingUp, Users, DollarSign, Info, AlertCircle, Download, Link as LinkIcon } from 'lucide-react';
          ...
          <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                ...
                For more comprehensive financial planning, explore our <Link href="/insurance-tools" className="text-blue-600 hover:text-blue-800 underline">complete suite of insurance tools</Link>.
              </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/insurance-tools/term-insurance-planner" className="text-blue-600 hover:text-blue-800 underline">Term Insurance Planner</Link>
                  <Link href="/insurance-tools/health-insurance-estimator" className="text-blue-600 hover:text-blue-800 underline">Health Insurance Estimator</Link>
                  <Link href="/insurance-tools/ulip-calculator" className="text-blue-600 hover:text-blue-800 underline">ULIP Calculator</Link>
                  <Link href="/insurance-tools/portfolio-dashboard" className="text-blue-600 hover:text-blue-800 underline">Insurance Portfolio Dashboard</Link>
                </div>
              </div>
