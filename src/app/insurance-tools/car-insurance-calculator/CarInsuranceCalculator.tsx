...
import { ArrowLeft, Car, IndianRupee, TrendingUp, AlertCircle, Shield, Download, Link as LinkIcon } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/insurance-tools/two-wheeler-tracker" className="text-green-600 hover:text-green-800 underline">Two-Wheeler Insurance Tracker</Link>
                  <Link href="/insurance-tools/home-insurance-estimator" className="text-green-600 hover:text-green-800 underline">Home Insurance Estimator</Link>
                  <Link href="/insurance-tools/portfolio-dashboard" className="text-green-600 hover:text-green-800 underline">Insurance Portfolio Dashboard</Link>
                  <Link href="/insurance-tools/life-insurance-calculator" className="text-green-600 hover:text-green-800 underline">Life Insurance Calculator</Link>
                </div>
              </div>
