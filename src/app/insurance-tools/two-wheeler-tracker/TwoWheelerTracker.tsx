...
import { ArrowLeft, Bike, IndianRupee, Calendar, Shield, AlertCircle, Plus, Trash2, Edit3, Download, Link as LinkIcon } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  ...
                  <Link href="/insurance-tools/home-insurance-estimator" className="text-blue-600 hover:text-blue-800 underline">Home Insurance Estimator</Link>
                  ...
                  <Link href="/insurance-tools/travel-insurance-selector" className="text-blue-600 hover:text-blue-800 underline">Travel Insurance Selector</Link>
                </div>
              </div>
            </div>
          </div>
