...
import { Languages, Search, Filter, Globe, Map, MapPin, Music, Calendar, Home, ChevronRight, X, Star, TrendingUp, MessageCircle, Book, Mic, FileText, Image, Gift, ShoppingBag, Heart, Video, Volume2, Award, Users, Camera, Hash, ArrowRight, Clock, Utensils, Landmark, DollarSign, Palette, Navigation, TrendingDown } from "lucide-react";
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-teal-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border rounded-xl p-4">
                ...
                <p className="text-gray-700 text-sm">Search your language or region, open the tool, and customize dates, greetings, or maps.</p>
              </div>
              <div className="border rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
                <p className="text-gray-700 text-sm">Choose calendar tools for dates, creation tools for posters or audio, and finder tools for local events.</p>
              </div>
              <div className="border rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
                <p className="text-gray-700 text-sm">Tamil calendar → add reminders. Marathi greetings → generate posters. Telugu dates → share in your group.</p>
              </div>
            </div>
          </div>
        </section>
