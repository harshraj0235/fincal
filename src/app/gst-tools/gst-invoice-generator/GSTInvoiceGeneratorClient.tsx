        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
              <Link href="/tools/gst-einvoice-qr-validator" className="text-blue-600 hover:text-blue-800 underline">E-Invoice QR Validator</Link>
              ...
              <Link href="/tools/gst-slab-finder" className="text-blue-600 hover:text-blue-800 underline">GST Slab Finder</Link>
            </div>
          </div>
        </div>
      </div>
