          ...
          <div ref={resultsRef} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <Link href="/gst-tools/gst-due-date-tracker" className="text-blue-600 hover:text-blue-800 underline">GST Due Date Tracker</Link>
                ...
                <Link href="/gst-tools/gst-hsn-sac-finder" className="text-blue-600 hover:text-blue-800 underline">HSN/SAC Code Finder</Link>
