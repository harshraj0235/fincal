        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/calculators" download="gstr3b_template.csv" className="inline-flex items-center px-3 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50">
          ...
          <div ref={resultsRef} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <Link href="/gst-tools/gst-calculator" className="text-blue-600 hover:text-blue-800 underline">GST Calculator</Link>
                <Link href="/gst-tools/gst-penalty-interest-calculator" className="text-blue-600 hover:text-blue-800 underline">Penalty & Interest</Link>
                <Link href="/gst-tools/gst-liability-calculator" className="text-blue-600 hover:text-blue-800 underline">GST Liability</Link>
                <Link href="/gst-tools/gst-hsn-sac-finder" className="text-blue-600 hover:text-blue-800 underline">HSN/SAC Finder</Link>
              </div>
            </div>
          </div>
