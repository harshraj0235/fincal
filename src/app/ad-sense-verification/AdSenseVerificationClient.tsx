...
import { CheckCircle, Copy, ExternalLink, ShieldCheck, FileCode, Terminal, Globe, ArrowLeft, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto">
        <Link href="/seo-tools" className="inline-flex items-center text-sm font-medium text-slate-600 hover:text-red-600 transition-colors mb-8">
