...
import { ChevronDown, ChevronRight, BookOpen, Calculator, FileText, FileSpreadsheet, Home, Car, GraduationCap, Briefcase, CreditCard, BarChart3, Coins, Shield, Wallet, PiggyBank, Globe, Sparkles, Brain, IndianRupee } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-yellow-50">
        <div className="max-w-5xl mx-auto px-4 py-12">
                ...
                >
                  <div className="p-6 grid md:grid-cols-2 gap-4">
                    {taxationLessons.map((lesson, i) => (
                      <Link
                        key={lesson.id}
                        href={`/learn/taxation-compliance/${lesson.slug}`}
              ...
              {allLearnOpen && (
                ...
                >
                  ...
                  <div className="px-6 pb-6">
                    <Link href="/learn" className="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-colors">
              ...
              {blogsOpen && (
                ...
                >
                  <div className="p-6">
                    ...
                    <Link href="/blog/tax-saving-investment-options" className="inline-block mt-4 text-sm text-green-700 font-medium hover:underline">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-8">
            <Link href="/tax-tools" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
              Tax Tools Hub
            </Link>
            <Link href="/learn/taxation-compliance" className="px-6 py-3 bg-amber-600 text-white rounded-xl font-semibold hover:bg-amber-700">
              Tax Learn
            </Link>
            <Link href="/calculators/income-tax-calculator" className="px-6 py-3 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700">
              Income Tax Calculator
            </Link>
            <Link href="/emi-simplifier" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
              EMI Simplifier
            </Link>
            <Link href="/sip-simplifier" className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700">
              SIP Simplifier
            </Link>
          </div>
        </div>
