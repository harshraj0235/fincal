...
export const GovernmentSchemes: React.FC = () => {
  ...
  }, [searchTerm, selectedCategory, selectedStatus, searchParams, pathname, router]);
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white" role="main" id="government-schemes-main">
        ...
        <section className="relative overflow-hidden pt-24 pb-20" style={{
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
            ...
            {/* Title */}
            <h2 className="text-center text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tight mb-4">
              Government{' '}
          ...
          <div className="mb-10 bg-white rounded-2xl shadow-md border border-indigo-100 overflow-hidden hover:shadow-lg transition-shadow relative">
            ...
            <div className="md:flex">
              ...
              <div className="md:w-2/3 p-6 md:p-8 flex flex-col justify-center">
                ...
                <div>
                  <Link href="/schemes-finder" className="inline-flex items-center justify-center px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors shadow-sm">
                ...
                >
                  ...
                  <div className="p-5 flex-grow flex flex-col">
                    ...
                    <h3 className="text-base font-bold text-gray-900 mb-1 line-clamp-2 leading-snug group-hover:text-indigo-600 transition-colors">
                      <Link href={`/government-schemes/${scheme.slug}`} className="focus:outline-none">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-3 text-sm">
                  <Link href="/editorial-policy" className="text-indigo-600 hover:text-indigo-800 font-medium transition-colors">Editorial policy</Link>
                  <Link href="/about-us" className="text-indigo-600 hover:text-indigo-800 font-medium transition-colors">About MoneyCal</Link>
                  <Link href="/contact-us" className="text-indigo-600 hover:text-indigo-800 font-medium transition-colors">Contact</Link>
                </div>
              </div>
