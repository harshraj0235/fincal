...
import { ArrowLeft, Globe, DollarSign, Download, Link as LinkIcon, TrendingUp, BarChart3, Target, AlertTriangle, Shield } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-cyan-600 hover:text-cyan-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-cyan-600 hover:text-cyan-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/dividend-policy-impact-tool" className="text-cyan-600 hover:text-cyan-800 underline">Dividend Policy Impact</Link>
                  <Link href="/corporate-finance/working-capital-optimizer" className="text-cyan-600 hover:text-cyan-800 underline">Working Capital Optimizer</Link>
                </div>
              </div>
            </div>
          </div>
