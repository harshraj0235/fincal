...
import { ArrowLeft, Zap, TrendingUp, DollarSign, BarChart3, Download, IndianRupee, Link as LinkIcon } from 'lucide-react';
            ...
            <div ref={resultsRef} className="space-y-6">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-amber-700 hover:text-amber-900 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/cost-capital-benchmarking" className="text-amber-700 hover:text-amber-900 underline">Cost of Capital Benchmarking</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-amber-700 hover:text-amber-900 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/dividend-policy-impact-tool" className="text-amber-700 hover:text-amber-900 underline">Dividend Policy Impact Tool</Link>
                </div>
              </div>
            </div>
          </div>
