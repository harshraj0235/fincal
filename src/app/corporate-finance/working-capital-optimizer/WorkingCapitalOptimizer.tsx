...
import { ArrowLeft, PieChart, DollarSign, Download, Link as LinkIcon, Building, BarChart3, Target, TrendingUp, Clock } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-orange-600 hover:text-orange-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/loan-amortization-generator" className="text-orange-600 hover:text-orange-800 underline">Loan Amortization Generator</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-orange-600 hover:text-orange-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/break-even-calculator" className="text-orange-600 hover:text-orange-800 underline">Break-Even Point Calculator</Link>
                </div>
              </div>
            </div>
          </div>
