...
import { ArrowLeft, Building, DollarSign, Download, Link as LinkIcon, PieChart, BarChart3, Target, TrendingUp, Shield } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-indigo-600 hover:text-indigo-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/working-capital-optimizer" className="text-indigo-600 hover:text-indigo-800 underline">Working Capital Optimizer</Link>
                  <Link href="/corporate-finance/cost-capital-benchmarking" className="text-indigo-600 hover:text-indigo-800 underline">Cost of Capital Benchmarking</Link>
                  <Link href="/corporate-finance/scenario-analysis-simulator" className="text-indigo-600 hover:text-indigo-800 underline">Scenario Analysis Simulator</Link>
                </div>
              </div>
            </div>
          </div>
