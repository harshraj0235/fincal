...
import { ArrowLeft, TrendingUp, DollarSign, Download, Link as LinkIcon, PieChart, BarChart3, Target, IndianRupee, Percent } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-emerald-600 hover:text-emerald-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-emerald-600 hover:text-emerald-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/fx-exposure-risk-calculator" className="text-emerald-600 hover:text-emerald-800 underline">FX Exposure Risk Calculator</Link>
                  <Link href="/corporate-finance/loan-amortization-generator" className="text-emerald-600 hover:text-emerald-800 underline">Corporate Loan Amortization</Link>
                </div>
              </div>
            </div>
          </div>
