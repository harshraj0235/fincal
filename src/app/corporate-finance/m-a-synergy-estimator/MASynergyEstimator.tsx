...
import { ArrowLeft, TrendingUp, DollarSign, Download, Link as LinkIcon, Building, BarChart3, Target, PieChart, Users } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-purple-600 hover:text-purple-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-purple-600 hover:text-purple-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/scenario-analysis-simulator" className="text-purple-600 hover:text-purple-800 underline">Scenario Analysis Simulator</Link>
                  <Link href="/corporate-finance/working-capital-optimizer" className="text-purple-600 hover:text-purple-800 underline">Working Capital Optimizer</Link>
                </div>
              </div>
            </div>
          </div>
