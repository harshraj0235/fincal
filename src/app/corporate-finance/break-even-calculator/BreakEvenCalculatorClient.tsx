...
import { ArrowLeft, BarChart3, DollarSign, Download, Link as LinkIcon, Target, TrendingUp, IndianRupee, PieChart } from 'lucide-react';
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <Link href="/corporate-finance/business-valuation-calculator" className="text-red-600 hover:text-red-800 underline">Business Valuation Calculator</Link>
                  <Link href="/corporate-finance/working-capital-optimizer" className="text-red-600 hover:text-red-800 underline">Working Capital Optimizer</Link>
                  <Link href="/corporate-finance/capital-structure-analyzer" className="text-red-600 hover:text-red-800 underline">Capital Structure Analyzer</Link>
                  <Link href="/corporate-finance/scenario-analysis-simulator" className="text-red-600 hover:text-red-800 underline">Scenario Analysis Simulator</Link>
                </div>
              </div>
            </div>
          </div>
