...
import { TrendingUp, BarChart2, PieChart, BookOpen, Search, ArrowRight, Target, Zap, ShieldCheck, Globe, Award, CircleDollarSign } from "lucide-react";
        ...
        <div className="bg-white border-b border-gray-100 pt-16 pb-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/ipo" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg flex items-center gap-2">
                Check Today's IPOs <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="/calculators" className="px-6 py-3 bg-white text-gray-700 border border-gray-200 hover:border-blue-300 hover:bg-blue-50 font-bold rounded-xl transition-all">
                Start Learning
              </Link>
            </div>
          </div>
