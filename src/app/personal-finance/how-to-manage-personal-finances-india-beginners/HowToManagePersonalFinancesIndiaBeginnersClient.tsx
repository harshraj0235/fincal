...
import { BarChart3, IndianRupee, Target, TrendingUp, Shield, BookOpen, Users, DollarSign, PieChart, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section id="tools" className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link href="/tools/monthly-budget-planner" className="bg-blue-50 rounded-lg p-6 hover:bg-blue-100 transition-colors">
              ...
              <Link href="/tools/savings-goal-calculator" className="bg-green-50 rounded-lg p-6 hover:bg-green-100 transition-colors">
              ...
              <Link href="/tools/emergency-fund-calculator" className="bg-red-50 rounded-lg p-6 hover:bg-red-100 transition-colors">
              ...
              <Link href="/tools/sip-calculator" className="bg-purple-50 rounded-lg p-6 hover:bg-purple-100 transition-colors">
              ...
              <Link href="/tools/compound-interest-calculator" className="bg-orange-50 rounded-lg p-6 hover:bg-orange-100 transition-colors">
              ...
              <Link href="/tools/personal-finance-dashboard" className="bg-indigo-50 rounded-lg p-6 hover:bg-indigo-100 transition-colors">
