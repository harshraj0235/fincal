            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-20 relative z-20">
                ...
                <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <Link href="/gold-tools" className="mt-10 inline-flex items-center px-8 py-4 bg-gray-900 text-white rounded-3xl font-black hover:bg-black transition-all transform hover:scale-105 shadow-xl">
