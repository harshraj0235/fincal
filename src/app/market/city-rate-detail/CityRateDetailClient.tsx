        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className={`pt-8 pb-16 ${isSilver ? 'bg-blue-600' : 'bg-amber-500'} text-white`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <Link href="/gold-rate" className="inline-flex items-center text-white/80 hover:text-white mb-6 transition-colors">
                        ...
                        <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100 prose max-w-none prose-amber">
                            ...
                            <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 my-10">
                                ...
                                <ul className="space-y-3 list-none pl-0">
                                    <li><Link href="/gold-rate" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ आज का गोल्ड रेट विवरण (Today's Gold Rate)</Link></li>
                                    <li><Link href="/silver-rate" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ आज का सिल्वर रेट विवरण (Today's Silver Rate)</Link></li>
                                    <li><Link href="/ipo" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ आगामी आईपीओ डैशबोर्ड (Upcoming IPOs)</Link></li>
                                    <li><Link href="/gold-tools/jewellery-price-estimator" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ गोल्ड ज्वेलरी प्राइस कैलकुलेटर</Link></li>
                                </ul>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-gradient-to-br from-amber-600 to-yellow-600 rounded-3xl p-8 text-white shadow-2xl sticky top-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <Link href="/gold-tools/jewellery-price-estimator" className="w-full bg-white text-amber-600 font-black py-4 rounded-2xl flex items-center justify-center hover:bg-amber-50 transition-colors">
                                    Full Invoice Tool →
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <button className="flex items-center justify-center p-3 rounded-2xl bg-[#1DA1F2]/10 text-[#1DA1F2] font-bold text-sm hover:bg-[#1DA1F2]/20 transition-colors">Globe (X)</button>
                            </div>
                        </div>
