          ...
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/savings-bank-products"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/learn/savings-bank-products/fixed-deposits-fd-interest-rates-tax-laddering-strategy-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/learn/savings-bank-products/high-interest-savings-accounts-digital-banks-india-comparison" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          >
            <div className="bg-gradient-to-r from-green-600 to-teal-700 rounded-2xl p-8 shadow-2xl text-white">
              ...
              <Link
                href="/tools/bank-returns-optimizer"
