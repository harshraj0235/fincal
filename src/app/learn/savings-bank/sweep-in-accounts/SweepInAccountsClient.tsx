...
import { 
  ...
  RefreshCw, Lock, Unlock, BarChart3, Sparkles, Clock, FileText, IndianRupee } from 'lucide-react';
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/savings-bank-products" className="flex items-center gap-2 text-gray-600 hover:text-teal-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/savings-bank-products/bank-charges-hidden-fees-minimum-balance-penalty-india"
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Link href="/calculators/savings-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
