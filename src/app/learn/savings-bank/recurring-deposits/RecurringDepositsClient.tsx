...
import { 
  ...
  Award, BarChart3, IndianRupee } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/savings-bank-products" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/savings-bank-products/high-interest-savings-accounts-digital-banks-india-comparison"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          {/* Try Full Standalone Calculator */}
          <section className="mb-12">
            <div className="bg-white border-2 border-dashed border-blue-300 rounded-2xl p-8 text-center shadow-sm">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Calculator className="h-8 w-8 text-blue-600" />
              </div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Want More Detailed RD Analysis?</h2>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our standalone RD Calculator offers advanced features like monthly payout planning, multi-bank rate comparisons, and senior citizen boost analysis.
              </p>
              <Link
                href="/calculators/rd-calculator"
                className="inline-flex items-center justify-center bg-blue-600 text-white font-bold py-4 px-10 rounded-xl hover:bg-blue-700 transition-all transform hover:scale-105 shadow-lg"
              >
                Try Full RD Calculator 🚀
              </Link>
            </div>
          </section>
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/calculators/rd-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/calculators/sip-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/calculators/income-tax-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
