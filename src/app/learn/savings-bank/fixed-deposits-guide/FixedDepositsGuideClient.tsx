...
import { 
  ArrowRight, ArrowLeft, PiggyBank, Calculator, CheckCircle, 
  Target, Award, AlertTriangle, Lightbulb, Zap,
  XCircle, IndianRupee } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/savings-bank-products" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/savings-bank-products/recurring-deposits-rd-vs-sip-monthly-savings-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="mb-12">
            <div className="bg-white border-2 border-dashed border-green-300 rounded-2xl p-8 text-center shadow-sm">
              <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Calculator className="h-8 w-8 text-green-600" />
              </div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Want More Detailed FD Analysis?</h2>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Our standalone FD Calculator offers advanced features like FD Ladder planning, multi-bank rate comparisons, and senior citizen boost analysis.
              </p>
              <Link
                href="/calculators/fd-calculator"
                className="inline-flex items-center justify-center bg-green-600 text-white font-bold py-4 px-10 rounded-xl hover:bg-green-700 transition-all transform hover:scale-105 shadow-lg"
              >
                Try Full FD Calculator 🚀
              </Link>
            </div>
          </section>
