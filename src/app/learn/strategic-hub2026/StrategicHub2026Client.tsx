...
import { Rocket, Shield, Zap, TrendingUp, Search, ArrowRight, Star, Target, Calculator, BookOpen, AlertTriangle, Briefcase, Globe, Smartphone, CheckCircle2, Award, Sparkles } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/calculators" className="px-8 py-4 bg-slate-800 text-white border border-slate-700 rounded-xl font-bold text-lg hover:bg-slate-700 transition-all">
                Interactive Tools
              </Link>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {silos.map((silo, index) => (
              <motion.div
                ...
                className="group"
              >
                <Link href={silo.route} className="block h-full">
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="/learn" className="text-lg font-bold text-slate-900 hover:text-blue-600 flex items-center gap-2 transition-colors">
              <BookOpen className="w-6 h-6" /> Back to Learn Hub
            </Link>
            <Link href="/calculators" className="text-lg font-bold text-slate-900 hover:text-blue-600 flex items-center gap-2 transition-colors">
