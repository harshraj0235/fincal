...
import { DollarSign, Award, Briefcase, IndianRupee, TrendingUp, CheckCircle, AlertCircle, ExternalLink, Factory, Building } from 'lucide-react';
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/business-loans/msme-loan-guide" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
          ...
          <Link href="/learn/business-loans/mudra-loan" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
