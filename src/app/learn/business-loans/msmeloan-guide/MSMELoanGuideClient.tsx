...
import { Factory, IndianRupee, TrendingUp, CheckCircle, AlertCircle, ExternalLink, Award, Building } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/business-loans/mudra-loan" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
            <div className="font-bold mb-1">Next: Mudra Loan Scheme</div>
            <div className="text-sm text-green-100">₹10L without collateral</div>
          </Link>
          <Link href="/learn/business-loans/working-capital-loan" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
