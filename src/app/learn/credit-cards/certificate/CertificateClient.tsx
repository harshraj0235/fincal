    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <nav className="mt-8">
        ...
        <ul className="list-disc ml-5 text-blue-700">
          <li>
            <Link href="/learn/credit-cards/statement-guide" className="hover:underline">
              Credit Card Statement Guide
            </Link>
          </li>
          <li>
            <Link href="/learn/credit-cards/closure-process" className="hover:underline">
              Credit Card Closure Process
            </Link>
          </li>
          <li>
            <Link href="/learn/credit-cards/fraud-safety" className="hover:underline">
