...
import { GraduationCap, IndianRupee, TrendingUp, CheckCircle, AlertCircle, ExternalLink, DollarSign } from 'lucide-react';
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/education-loans/study-in-india" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
          ...
          <Link href="/learn/education-loans/study-abroad" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
