...
import { Shield, IndianRupee, TrendingUp, CheckCircle, AlertCircle, Home, CreditCard } from 'lucide-react';
    ...
    >
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-orange-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Link href="/learn/education-loans/scholarships-alternatives" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
