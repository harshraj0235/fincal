  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-600 to-pink-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Link href="/learn/education-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
            <div className="font-bold mb-1">Back to Education Loans Hub</div>
            <div className="text-sm text-red-100">Review all 10 lessons</div>
          </Link>
          <Link href="/learn/vehicle-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
            <div className="font-bold mb-1">Vehicle Loans (15 lessons)</div>
            <div className="text-sm text-red-100">Car & bike loans</div>
          </Link>
          <Link href="/learn/business-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
