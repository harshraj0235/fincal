    ...
    >
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/education-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Back to Education Loans Hub</div><div className="text-sm text-indigo-100">Review all 10 lessons</div></Link>
          <Link href="/learn" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Explore More Courses</div><div className="text-sm text-indigo-100">Business, Gold, Credit Cards...</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
