...
import { BookOpen, IndianRupee, TrendingUp, CheckCircle, AlertCircle, ExternalLink, DollarSign, Award } from 'lucide-react';
    ...
    >
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/education-loans/study-abroad" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
            <div className="font-bold mb-1">Next: Study Abroad Loan</div>
            <div className="text-sm text-green-100">USA, UK, Canada, Australia</div>
          </Link>
          <Link href="/learn/education-loans/eligibility-documents" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
