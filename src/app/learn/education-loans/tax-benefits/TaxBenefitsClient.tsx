...
import { DollarSign, IndianRupee, TrendingDown, CheckCircle, AlertCircle, ExternalLink, Award, FileText } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/education-loans/repayment-moratorium" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
          ...
          <Link href="/learn/education-loans/emi-calculator" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30">
