...
import { 
  ...
  Home, Car, GraduationCap, Heart, Plane, Briefcase, PiggyBank, IndianRupee } from 'lucide-react';
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/money-management" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/money-management/budgeting-how-to-track-income-expenses-india"
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-300">
                  ...
                  <div className="bg-green-100 border-l-4 border-green-600 p-4 rounded-r-lg">
                    ...
                    <p className="text-sm text-gray-800 mt-2">
                      ...
                      based on market conditions. <Link href="/calculators/sip-calculator" className="text-blue-600 hover:underline font-bold">Calculate SIP →</Link>
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-300">
                  ...
                  <div className="bg-purple-100 border-l-4 border-purple-600 p-4 rounded-r-lg">
                    ...
                    <p className="text-sm text-gray-800 mt-2">
                      ...
                      <Link href="/calculators/compound-interest" className="text-blue-600 hover:underline font-bold ml-1">See Compounding Power →</Link>
                    </p>
                  </div>
                </div>
              )}
              ...
              {monthlySIP > 0 && (
                <div className="mt-6 bg-white rounded-lg p-5 text-gray-900">
                  ...
                  <p className="text-sm text-gray-600 mt-4 italic">
                    💡 Start this SIP today using our <Link href="/calculators/sip-calculator" className="text-blue-600 hover:underline font-bold">SIP Calculator</Link>!
                  </p>
                </div>
              )}
            </div>
