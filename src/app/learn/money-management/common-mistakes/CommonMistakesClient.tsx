...
import { BookOpen, ArrowRight, ArrowLeft, AlertTriangle, XCircle, CheckCircle, TrendingDown, DollarSign, CreditCard, ShoppingCart, Target, Award, Lightbulb, Shield, PiggyBank, Smartphone, Car, Home, Brain, Zap, Activity, Heart, Calendar, Clock } from "lucide-react";
...
const CommonMistakes: React.FC = () => {
  ...
  const mistakes = [
    ...
    },
    {
      ...
      why: "Flipkart sales, Globe ads, friend pressure → buy things you don't need. Salary increases but savings stay same (upgrade lifestyle instead of wealth).",
      solution: [
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/money-management" className="flex items-center gap-2 text-gray-600 hover:text-red-600 transition-colors">
