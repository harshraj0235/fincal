        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/money-management" className="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/money-management/reviewing-adjusting-budget-monthly-quarterly-annual"
