...
import { BookOpen, ArrowRight, ArrowLeft, Calculator, TrendingUp, DollarSign, PiggyBank, Wallet, BarChart3, Target, CheckCircle, AlertCircle, Lightbulb, Star, Award, Globe, Home, Car, GraduationCap, Heart, Briefcase, IndianRupee } from "lucide-react";
          ...
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/money-management/setting-financial-goals-short-medium-long-term"
            ...
            <div className="prose max-w-none">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-xl mb-6">
                ...
                <p className="text-sm text-gray-700 italic">
                  ...
                  12%+ in SIP). Use our <Link href="/calculators/inflation-calculator" className="text-blue-600 hover:underline font-semibold">Inflation Calculator</Link> to see the impact.
                </p>
              </div>
            </div>
          </motion.section>
              ...
              {showAnswer && (
                <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg">
                  ...
                  <p className="text-sm text-gray-700">
                    ...
                    <Link href="/calculators/sip-calculator" className="text-blue-600 hover:underline ml-1">
                      Try SIP Calculator →
                    </Link>
                  </p>
                </div>
