...
import { Car, IndianRupee, TrendingUp, Shield, AlertCircle, ExternalLink, CheckCircle } from 'lucide-react';
    ...
    >
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">Use <Link href="/calculators/car-loan-calculator" className="text-blue-600 underline">car loan calculator</Link> to check eligibility based on income, age, CIBIL score.</p>
              </div>
            </div>
      ...
      <section className="mb-12">
        ...
        <div className="mt-6 text-center">
          <Link 
            href="/learn/vehicle-loans/eligibility-calculator"
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link
            href="/learn/vehicle-loans/two-wheeler-loan"
          ...
          <Link
            href="/learn/vehicle-loans/interest-rates"
            className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all border border-white/30"
          >
