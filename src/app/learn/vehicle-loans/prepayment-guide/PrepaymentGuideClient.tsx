    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/balance-transfer" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Next: Balance Transfer</div><div className="text-sm text-blue-100">Switch to lower rates</div></Link>
          <Link href="/learn/vehicle-loans/best-banks" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Best Banks 2025</div><div className="text-sm text-blue-100">Compare all lenders</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
