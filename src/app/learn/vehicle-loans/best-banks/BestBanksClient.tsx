    ...
    >
      ...
      <div className="bg-gradient-to-r from-teal-600 to-green-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/dealer-vs-bank" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Next: Dealer vs Bank Loan</div><div className="text-sm text-teal-100">Which is better?</div></Link>
          <Link href="/learn/vehicle-loans/ev-loan-subsidy" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">EV Loan & Subsidy</div><div className="text-sm text-teal-100">Electric vehicle benefits</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
