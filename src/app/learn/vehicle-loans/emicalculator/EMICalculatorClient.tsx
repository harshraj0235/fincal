    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-600 to-pink-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/prepayment-guide" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
            <div className="font-bold mb-1">Next: Prepayment Guide</div>
            <div className="text-sm text-red-100">Save on interest</div>
          </Link>
          <Link href="/learn/vehicle-loans/balance-transfer" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
