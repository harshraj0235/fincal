    ...
    >
      ...
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/ev-loan-subsidy" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Next: EV Loan & Government Subsidy</div><div className="text-sm text-orange-100">Electric vehicle benefits</div></Link>
          <Link href="/learn/vehicle-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Back to Vehicle Loans Hub</div><div className="text-sm text-orange-100">All 15 lessons</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
