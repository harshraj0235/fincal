  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Back to Vehicle Loans Hub</div><div className="text-sm text-green-100">Review all 15 lessons</div></Link>
          <Link href="/learn" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Explore More Courses</div><div className="text-sm text-green-100">Education, Business, Gold Loans...</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
