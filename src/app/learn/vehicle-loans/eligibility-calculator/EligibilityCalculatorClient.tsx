...
import { IndianRupee, TrendingUp, CheckCircle, AlertCircle } from 'lucide-react';
    ...
    >
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white mb-8">
        <div className="flex items-center mb-4">
          <IndianRupee className="h-12 w-12 mr-4" />
          <div>
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/documents-required" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
          ...
          <Link href="/learn/vehicle-loans/interest-rates" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all">
