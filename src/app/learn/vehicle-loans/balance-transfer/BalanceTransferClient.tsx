    ...
    >
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/learn/vehicle-loans/best-banks" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Next: Best Banks 2025</div><div className="text-sm text-purple-100">Compare all lenders</div></Link>
          <Link href="/learn/vehicle-loans/dealer-vs-bank" className="bg-white/10 backdrop-blur-sm p-4 rounded-xl hover:bg-white/20 transition-all"><div className="font-bold mb-1">Dealer vs Bank Loan</div><div className="text-sm text-purple-100">Which is better?</div></Link>
        </div>
      </div>
    </LearnLayout>
  );
