      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 pt-20 px-4">
        <div className="max-w-4xl mx-auto py-12">
          <div className="flex justify-between mb-8">
            <Link href="/learn/taxation-compliance" className="flex items-center gap-2 text-gray-600 hover:text-purple-600"><ArrowLeft className="w-5 h-5" />Back</Link>
          ...
          <div className="mt-12 bg-white rounded-xl p-8 shadow-lg text-center">
            ...
            <Link
              href="/learn/taxation-compliance/tds-tax-deducted-at-source-certificate-claim-refund-india"
