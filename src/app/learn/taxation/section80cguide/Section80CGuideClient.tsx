...
import { 
  ...
  Zap, AlertTriangle, Calculator, PiggyBank, FileText, IndianRupee } from 'lucide-react';
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/taxation-compliance" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/taxation-compliance/capital-gains-tax-ltcg-stcg-indexation-india-complete-guide"
