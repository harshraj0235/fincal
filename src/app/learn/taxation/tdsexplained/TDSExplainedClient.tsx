        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/taxation-compliance" className="flex items-center gap-2 text-gray-600 hover:text-teal-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/taxation-compliance"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/learn/taxation-compliance/itr-filing-complete-guide-online-income-tax-return-india-2025" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/learn/taxation-compliance/section-80c-deductions-save-tax-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link
                href="/learn/taxation-compliance/capital-gains-tax-ltcg-stcg-equity-debt-property-india-2025"
