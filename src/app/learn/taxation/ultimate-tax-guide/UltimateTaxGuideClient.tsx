...
import { BookOpen, Shield, Receipt, FileText, CheckCircle, IndianRupee, Landmark, TrendingDown, ArrowRight, Zap, Globe, Info, HelpCircle, ChevronRight, Calendar, Calculator, Sparkles, Languages } from "lucide-react";
            ...
            <div className="relative group">
              ...
              <div className="bg-indigo-900 p-10 rounded-[2.5rem] h-full text-white">
                ...
                <div className="mt-10 pt-8 border-t border-white/10">
                  <Link href="/calculators/income-tax-calculator" className="inline-flex items-center gap-2 text-emerald-400 font-bold hover:text-white transition-all text-lg group/link">
