      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/taxation-compliance" className="flex items-center gap-2 text-gray-600 hover:text-pink-600 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Link href="/learn/taxation-compliance/tax-planning-strategies-minimize-tax-liability-legally-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          <div className="bg-gradient-to-r from-pink-600 to-rose-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link
              href="/learn/taxation-compliance/advance-tax-payment-due-dates-calculation-penalty-india"
