        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/insurance-retirement" className="flex items-center gap-2 text-gray-600 hover:text-pink-600 transition-colors">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/learn/insurance-retirement/term-insurance-complete-guide-1-crore-cover-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/learn/insurance-retirement/nps-national-pension-system-tier-1-tier-2-tax-benefits-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
