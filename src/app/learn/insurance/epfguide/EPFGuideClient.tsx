...
import { ArrowRight, ArrowLeft, TrendingUp, CheckCircle, Shield, Award, AlertTriangle, DollarSign, Calculator, Target, HelpCircle, Zap, BarChart3, Layers, Lock, Users, Star, Sparkles, Clock, BadgeCheck, PieChart, Percent, Building, Landmark, CreditCard, TrendingDown, Info, Download, Share2, FileText, Calendar, Home, Smartphone, Globe, XCircle, IndianRupee } from "lucide-react";
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/insurance-retirement" className="flex items-center gap-2 text-gray-600 hover:text-teal-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/insurance-retirement"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/learn/insurance-retirement/ppf-public-provident-fund-15-year-lock-in-tax-free-returns-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/learn/insurance-retirement/retirement-planning-india-corpus-calculation-60-years-goal" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/calculators/epf-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link
                href="/learn/insurance-retirement/will-estate-planning-india-succession-nomination-inheritance-tax"
