        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/insurance-retirement" className="flex items-center gap-2 text-gray-600 hover:text-yellow-600 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Link href="/learn/insurance-retirement/epf-employee-provident-fund-withdrawal-interest-rate-pf-balance-india" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
                ...
                <Link href="/calculators/ppf-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          <div className="bg-gradient-to-r from-yellow-600 to-amber-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link
                href="/learn/insurance-retirement/epf-employee-provident-fund-withdrawal-interest-rate-pf-balance-india"
