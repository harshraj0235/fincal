...
import { 
  BookOpen, ArrowRight, ArrowLeft, TrendingUp,
  CheckCircle, XCircle, Target, AlertTriangle, 
  BarChart3, PieChart, Activity, Zap, Smartphone } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
        ...
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/investing-wealth" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/investing-wealth/mutual-funds-complete-guide-sip-nav-expense-ratio-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-4">Start Analyzing Stocks Like a Pro</h3>
                <p className="text-purple-100 mb-6 text-lg max-w-2xl">
                  Use our advanced Stock Market Analyzer to check real-time valuations, 
                  P/E trends, and health scores for your favorite Indian companies.
                </p>
          ...
          <section className="mb-12 bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Essential Trading Tools</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { name: 'Brokerage Calculator', url: '/calculators/brokerage-calculator' },
                { name: 'Nifty 50 Analyzer', url: '/tools/nifty-50-analyzer' },
                { name: 'SIP Calculator', url: '/tools/sip-calculator' },
                { name: 'Dividend Yield Tool', url: '/tools/dividend-calculator' },
                { name: 'Margin Calculator', url: '/tools/margin-calculator' },
                { name: 'Lumpsum Return Tool', url: '/tools/lumpsum-calculator' }
              ].map((tool, idx) => (
                <Link 
                  key={idx}
                  href={tool.url}
