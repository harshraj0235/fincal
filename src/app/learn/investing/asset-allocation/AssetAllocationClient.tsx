...
import { 
  ...
  Calculator, Target, HelpCircle, Layers, TrendingUp, Star, IndianRupee } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
          ...
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/investing-wealth/direct-vs-regular-mutual-funds-save-15-lakh-direct-plans-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-purple-600 to-pink-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform">
                <PieChart className="w-32 h-32" />
              </div>
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-4">Want a detailed portfolio plan?</h3>
                <p className="text-purple-100 mb-6 text-lg max-w-2xl">
                  Try our full standalone Asset Allocation Tool to model complex scenarios, 
                  including international diversification and tactical rebalancing.
                </p>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link href="/learn/investing-wealth/direct-vs-regular-mutual-funds-save-15-lakh-direct-plans-india" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-blue-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
