...
import { 
  ...
  TrendingUp, BarChart3, PieChart, Calendar, Zap, BadgeCheck, IndianRupee } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
          ...
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/investing-wealth/value-vs-growth-investing-warren-buffett-strategy-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Link href="/calculators/mutual-fund-returns-calculator" className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
          ...
          <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link href="/learn/investing-wealth/value-vs-growth-investing-warren-buffett-strategy-india" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-green-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
