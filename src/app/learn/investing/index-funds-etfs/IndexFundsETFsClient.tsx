...
import { 
  ArrowRight, ArrowLeft, TrendingUp, CheckCircle, Award,
  Calculator, Target, HelpCircle, PieChart, LineChart, AlertTriangle, IndianRupee } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/investing-wealth" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/investing-wealth/asset-allocation-equity-debt-gold-diversification-strategy-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-4">Analyze Your Funds Now</h3>
                <p className="text-blue-100 mb-6 text-lg max-w-2xl">
                  Compare active funds against index benchmarks and see if your current 
                  investments are truly worth the higher expense ratios.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/tools/mutual-fund-analyzer"
                    className="inline-flex items-center gap-2 bg-white text-blue-600 px-6 py-3 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-lg"
                  >
                    <Calculator className="w-5 h-5" />
                    Open Mutual Fund Analyzer
                  </Link>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12 bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { name: 'FD Calculator', url: '/calculators/fd-calculator' },
                { name: 'Asset Allocation', url: '/tools/asset-allocation' },
                { name: 'Portfolio Analyzer', url: '/tools/portfolio-analyzer' }
              ].map((tool, idx) => (
                <Link 
                  key={idx}
                  href={tool.url}
                  className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all group border border-transparent hover:border-blue-100"
                >
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link href="/learn/investing-wealth/asset-allocation-equity-debt-gold-diversification-strategy-india" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-purple-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
