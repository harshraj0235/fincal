      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/investing-wealth" className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="/learn/investing-wealth/nism-certifications-investment-advisor-mf-distributor-india"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link href="/learn/investing-wealth/nism-certifications-investment-advisor-mf-distributor-india" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-indigo-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
