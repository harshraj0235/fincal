      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
        <header className="bg-white shadow-md sticky top-0 z-50 border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/learn/fintech-digital-payments" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/learn/fintech-digital-payments" className="flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-2xl text-center">
            ...
            <Link href="/learn/fintech-digital-payments/buy-now-pay-later-bnpl-lazypay-simpl-zestmoney-india-guide-2025" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-purple-600 rounded-xl font-bold text-lg hover:shadow-2xl transition-all">
              Next: BNPL Guide
