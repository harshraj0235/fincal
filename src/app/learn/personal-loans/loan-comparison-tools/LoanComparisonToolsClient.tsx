...
import { ArrowLeft, ArrowRight, IndianRupee, Search, TrendingUp, CheckCircle, Star, Target } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/learn/personal-loans/loan-refinancing" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Loan Refinancing</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-closure-process" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Loan Closure</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-success-tips" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          >
            <Link
              href="/learn/personal-loans/improving-approval-chances"
            ...
            <Link
              href="/learn/personal-loans/loan-myths-debunked"
