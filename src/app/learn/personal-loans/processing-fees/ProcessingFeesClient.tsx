...
import { Clock, ArrowLeft, ArrowRight, IndianRupee, DollarSign, AlertTriangle, CheckCircle, Info, TrendingUp } from 'lucide-react';
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/learn/personal-loans/repayment-strategies" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
