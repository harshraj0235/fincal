...
import { ArrowLeft, ArrowRight, CheckCircle, FileText, IndianRupee, Clock, AlertTriangle, Trophy } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/learn/personal-loans/loan-future-trends" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Future Trends</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-case-studies" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Case Studies</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-expert-insights" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Expert Insights</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-resources" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          >
            <Link
              href="/learn/personal-loans/loan-refinancing"
