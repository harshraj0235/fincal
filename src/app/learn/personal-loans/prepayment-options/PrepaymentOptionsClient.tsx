...
import { ArrowLeft, ArrowRight, IndianRupee, DollarSign, TrendingUp, Clock, CheckCircle, AlertTriangle, Target } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/learn/personal-loans/loan-rejection-reasons" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Rejection Reasons</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/improving-approval-chances" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Improving Approval</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-comparison-tools" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Comparison Tools</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-myths-debunked" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
                    <span className="text-gray-700">Myths Debunked</span>
                    <ArrowRight className="w-4 h-4 text-gray-400" />
                  </Link>
                  
                  <Link href="/learn/personal-loans/loan-fraud-protection" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          >
            <Link
              href="/learn/personal-loans/repayment-strategies"
            ...
            <Link
              href="/learn/personal-loans/loan-rejection-reasons"
