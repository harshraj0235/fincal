...
import { ArrowLeft, ArrowRight, IndianRupee, TrendingUp, Target, Clock, DollarSign, CheckCircle, AlertTriangle } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/learn/personal-loans/prepayment-options" className="flex items-center justify-between py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          >
            <Link
              href="/learn/personal-loans/processing-fees"
            ...
            <Link
              href="/learn/personal-loans/prepayment-options"
