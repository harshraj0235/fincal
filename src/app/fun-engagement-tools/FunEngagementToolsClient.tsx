...
import { PartyPopper, Search, Filter, Gamepad2, Smile, Camera, Palette, Home, ChevronRight, X, Star, TrendingUp, Sparkles, Wand2, Image, MessageCircle, Hash, Trophy, Puzzle, Heart, Gift, Zap, ArrowRight, Users, Paintbrush, Video, Globe, Mic, Book, GraduationCap, Baby, Award, Target, Layers, Flame } from "lucide-react";
...
const FunEngagementTools: React.FC = () => {
  ...
  const funTools: FunTool[] = [
    ...
    },
    {
      ...
      description: 'Get creative ideas for Globe Reels',
      icon: Video,
      category: 'photo-video',
    ...
    },
    {
      ...
      description: 'Create catchy captions for Globe stories',
      icon: Globe,
      category: 'social',
    ...
    },
    {
      ...
      name: 'Globe Post Scheduler (Festivals)',
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border rounded-xl p-4">
                ...
                <p className="text-gray-700 text-sm">Diwali trivia → score table. Holi meme → Globe post. Rangoli design → print and color.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-purple-50 p-6 rounded-2xl">
                  ...
                  <p className="text-sm text-gray-700">Apply Holi filters, create selfie frames, make reels, and generate creative content for Globe and WhatsApp.</p>
                </div>
              </div>
