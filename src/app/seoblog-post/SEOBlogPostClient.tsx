      ...
      <MasterArticleLayout
        ...
        leftSidebar={
          <div className="flex flex-col gap-8">
            <StickyShareBar url={(typeof window !== 'undefined' ? window.location.href : '')} title={post.title} />
        ...
        {relatedPosts.length > 0 && (
          <div className="mt-20 pt-20 border-t border-gray-100">
            <div className="flex items-center justify-between mb-10">
              ...
              <Link href="/blog" className="text-xs font-black text-blue-600 uppercase tracking-widest hover:underline flex items-center gap-1">
