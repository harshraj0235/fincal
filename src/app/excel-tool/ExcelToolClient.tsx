        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-8">
          ...
          {!selectedCategory && searchTerm === '' && (
            <article className="prose lg:prose-xl max-w-none mb-12 bg-white p-8 rounded-lg shadow-sm border">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Best Excel Tools & Templates for Personal Finance in India (2024 Guide)</h2>
              ...
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <a href="/excel-tools" download className="flex items-center gap-2 p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors">
