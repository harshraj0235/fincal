      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-8">
            <Link href="/loan-tools" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
              Loan Tools Hub
            </Link>
            <Link href="/learn" className="px-6 py-3 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700">
              Loans Learn
            </Link>
            <Link href="/calculators/emi-calculator" className="px-6 py-3 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700">
              EMI Calculator
            </Link>
