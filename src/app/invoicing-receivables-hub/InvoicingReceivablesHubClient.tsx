...
import { FileText, Calculator, BarChart3, Calendar, DollarSign, TrendingUp, Clock, Users, CreditCard, Receipt, PieChart, Activity, Target, Zap, Shield, Globe, Smartphone, Search, Filter, Info, IndianRupee } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredTools.map((tool, index) => (
                ...
                >
                  <Link
                    href={`/invoicing-tools/${tool.slug}`}
