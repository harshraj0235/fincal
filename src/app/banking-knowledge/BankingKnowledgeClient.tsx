    ...
    <div className="max-w-4xl mx-auto">
          ...
          <div className="col-span-1">
            <div className="bg-[--primary-50] p-6 rounded-lg border border-[--primary-100]">
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/calculators/bank-ifsc-finder" className="text-[--primary-700] hover:text-[--primary-900] flex items-center">
                    <FileText className="h-4 w-4 mr-2" />
                    Bank IFSC Finder
                  </Link>
                </li>
                <li>
                  <Link href="/calculators/upi-failure-troubleshooter" className="text-[--primary-700] hover:text-[--primary-900] flex items-center">
                    <FileText className="h-4 w-4 mr-2" />
                    UPI Troubleshooter
                  </Link>
                </li>
                <li>
                  <Link href="/calculators/atm-locator" className="text-[--primary-700] hover:text-[--primary-900] flex items-center">
                    <FileText className="h-4 w-4 mr-2" />
                    ATM Locator
                  </Link>
                </li>
                <li>
                  <Link href="/calculators/bank-holiday-calendar" className="text-[--primary-700] hover:text-[--primary-900] flex items-center">
                    <FileText className="h-4 w-4 mr-2" />
                    Bank Holiday Calendar
                  </Link>
                </li>
                <li>
                  <Link href="/calculators/interest-rates-comparison" className="text-[--primary-700] hover:text-[--primary-900] flex items-center">
                    <FileText className="h-4 w-4 mr-2" />
          ...
          <div className="space-y-4">
            ...
            <details className="group">
              ...
              <div className="p-4 text-neutral-600 text-sm">
                ...
                <div className="mt-4">
                  <Link href="/calculators/upi-failure-troubleshooter" className="text-[--primary-600] hover:text-[--primary-800] font-medium">
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link 
            href="/calculators/interest-rates-comparison" 
            className="bg-white border border-neutral-200 rounded-lg p-4 hover:shadow-md transition-shadow text-left"
          >
