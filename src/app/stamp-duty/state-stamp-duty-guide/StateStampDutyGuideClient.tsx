  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/calculators/stamp-duty-calculator" className="px-4 py-2 rounded bg-[--primary-600] hover:bg-[--primary-700] text-white text-sm">
          Open Calculator
        </Link>
      </div>
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <div className="space-y-2 text-sm text-neutral-700">
              <div>
                ...
                <Link className="ml-2 text-[--primary-700] hover:underline" href={`/calculators/stamp-duty-calculator?mode=property&state=${s}&propertyType=residential&documentType=sale&ownership=female&propertyValue=5000000`}>
                  Try this scenario
                </Link>
              </div>
              <div>
                Commercial lease in a major city:
                <Link className="ml-2 text-[--primary-700] hover:underline" href={`/calculators/stamp-duty-calculator?mode=property&state=${s}&propertyType=commercial&documentType=lease&ownership=male&propertyValue=8000000&selectedCity=${encodeURIComponent('City')}&localCess=1`}>
                  Try this scenario
                </Link>
              </div>
              <div>
                Pre-filled state and city cess:
                <Link className="ml-2 text-[--primary-700] hover:underline" href={`/calculators/stamp-duty-calculator?mode=property&state=${s}&selectedCity=${encodeURIComponent('City')}&localCess=1&propertyValue=6000000`}>
                  Try this scenario
                </Link>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <div className="p-6 bg-[--primary-50] rounded-lg border border-[--primary-100]">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link className="text-[--primary-700] hover:underline" href="/calculators/stamp-duty-calculator">Stamp Duty Calculator</Link></li>
              <li><Link className="text-[--primary-700] hover:underline" href={`/calculators/stamp-duty-calculator?mode=property&state=${s}`}>Pre-fill State</Link></li>
              <li><Link className="text-[--primary-700] hover:underline" href="/calculators/property-calculator">Property Calculator</Link></li>
              <li><Link className="text-[--primary-700] hover:underline" href="/calculators/home-loan-emi-calculator">Home Loan EMI</Link></li>
              <li><Link className="text-[--primary-700] hover:underline" href="/calculators/hra-calculator">HRA Calculator</Link></li>
            </ul>
          </div>
        </div>
      </div>
