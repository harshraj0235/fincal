...
import { Palette, Search, Filter, Wand2, Image, Paintbrush, Sparkles, Home, ChevronRight, X, Star, TrendingUp, Camera, FileImage, Type, Layers, Layout, Shapes, Globe, Video, MessageCircle, Gift, Briefcase, ArrowRight, Zap, Music, QrCode, Crop, Download, Hash, Award, Smile, Film, Mic, Package } from "lucide-react";
...
const DesignCreatorTools: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'social', name: 'Social Media', icon: Globe, count: 12 },
  ...
  const designTools: DesignTool[] = [
    ...
    },
    {
      ...
      name: 'Diwali Banner Maker (YouTube/Globe)',
    ...
    // Social Media Tools
    {
      ...
      name: 'Festival Globe Story Template',
      description: 'Ready-to-use Globe story templates',
      icon: Globe,
      category: 'social',
    ...
    },
    {
      ...
      description: 'Engaging captions for Globe Reels',
      icon: MessageCircle,
      category: 'social',
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-cyan-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border rounded-xl p-4">
                ...
                <p className="text-gray-700 text-sm">Navratri poster → share on Globe. Diwali banner → website hero. WhatsApp greeting → send to contacts.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      ...
                      Design Diwali banners for YouTube and Globe
                    </li>
                    <li className="flex items-start">
                      <span className="text-cyan-600 mr-2">✓</span>
                  ...
                  <div className="bg-cyan-50 p-6 rounded-2xl">
                    <ul className="space-y-3 text-gray-700">
                      ...
                      <li className="flex items-center">
                        ...
                        <span className="font-semibold">Globe festival post template</span>
                      </li>
                      <li className="flex items-center">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 text-sm">Globe story templates, Reel captions, scripts, hashtags, video makers, stickers, and GIF creators.</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
