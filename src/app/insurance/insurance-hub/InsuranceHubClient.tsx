              ...
              <div className="mt-16 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[40px] p-8 sm:p-12 text-white relative overflow-hidden">
                 ...
                 <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div className="flex-1">
                       ...
                       <Link href="/insurance-tools" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-700 font-bold rounded-2xl hover:bg-blue-50 transition-all">
              ...
              <div className="bg-white rounded-[32px] p-8 shadow-sm border border-slate-100">
                ...
                <div className="space-y-6">
                  {guides.map((guide, idx) => (
                    <Link key={idx} href={`/insurance/guide/${guide.slug}`} className="block group">
