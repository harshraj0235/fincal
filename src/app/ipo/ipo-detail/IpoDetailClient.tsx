        ...
        return (
            <>
                ...
                <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8FAFC] p-4 text-center">
                    ...
                    <Link href="/ipo" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition">
            ...
            <article className="min-h-screen bg-[#F8FAFC] pb-24" itemScope itemType="https://schema.org/Article">
                ...
                <nav className="bg-white border-b border-slate-200 sticky top-16 z-30" aria-label="Breadcrumb">
                    <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-2 text-sm">
                        ...
                        <Link href="/ipo" className="text-slate-400 hover:text-blue-600 transition-colors">IPO Dashboard</Link>
                        <span className="text-slate-300">/</span>
                ...
                <header className="bg-white border-b border-slate-200 pt-10 pb-8">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-3" itemProp="headline">
                    ...
                    ">
                        ...
                        <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 my-10 not-prose">
                            ...
                            <ul className="space-y-3 list-none pl-0 m-0">
                                <li><Link href="/ipo" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ सभी आगामी आईपीओ देखें (Upcoming IPO Dashboard)</Link></li>
                                <li><Link href="/gold-rate" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ आज का गोल्ड रेट (Today's Gold Prices)</Link></li>
                                <li><Link href="/silver-rate" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ आज का सिल्वर रेट (Today's Silver Prices)</Link></li>
                                <li><Link href="/gold-tools/jewellery-price-estimator" className="text-blue-700 hover:text-blue-900 font-bold hover:underline flex items-center gap-2">→ गोल्ड ज्वेलरी प्राइस कैलकुलेटर (Gold Price Estimator)</Link></li>
                            </ul>
                        </div>
