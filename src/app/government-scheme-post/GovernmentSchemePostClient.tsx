...
const GovernmentSchemePost: React.FC = () => {
  ...
  const [kishorLoanAmount, setKishorLoanAmount] = useState<number>((typeof window !== 'undefined' ? (window as any) : {}).__kishorLoanAmount ?? 200000);
  const [kishorTenure, setKishorTenure] = useState<number>((typeof window !== 'undefined' ? (window as any) : {}).__kishorTenure ?? 48);
  const [kishorRate, setKishorRate] = useState<number>((typeof window !== 'undefined' ? (window as any) : {}).__kishorRate ?? 10);
  ...
  if (!scheme) {
    return (
      <div className="text-center py-20 bg-gray-50 min-h-screen pt-40">
        ...
        <button onClick={() => navigate.push('/government-schemes')} className="bg-emerald-600 text-white px-6 py-2 rounded-lg hover:bg-emerald-700 transition-colors">
          Back to Schemes
        </button>
      </div>
    );
  ...
  const leftSidebar = <StickyShareBar title={scheme.titleHindi} url={(typeof window !== 'undefined' ? window.location.href : '')} />;
  const rightSidebar = (
    <TrendingSidebar 
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sm:p-10 mb-10 overflow-hidden">
          ...
          <nav aria-label="Breadcrumb" className="text-sm text-slate-500 mb-8 pb-6 border-b border-slate-50">
            <ol className="flex flex-wrap items-center gap-2">
              ...
              <li><Link href="/government-schemes" className="hover:text-blue-600">Schemes</Link></li>
              <ChevronRight className="h-3 w-3" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      (typeof window !== 'undefined' ? (window as any) : {}).__kishorLoanAmount = nextValue;
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const nextValue = Number(e.target.value);
                      (typeof window !== 'undefined' ? (window as any) : {}).__kishorTenure = nextValue;
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const nextValue = Number(e.target.value);
                      (typeof window !== 'undefined' ? (window as any) : {}).__kishorRate = nextValue;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {relatedSchemes.map(relatedScheme => (
                <Link
                  ...
                  href={`/government-schemes/${relatedScheme.slug}`}
