...
import { IndianRupee, TrendingUp, DollarSign, Shield, Users, Clock, ArrowRight, Download, Star } from 'lucide-react';
...
const MoneyTool: React.FC = () => {
  ...
  return (
                <div key={category.name} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow cursor-pointer">
                  ...
                  <Link 
                    href={`/calculators/${category.name.toLowerCase().replace(/\s+/g, '-')}`}
