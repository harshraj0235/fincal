      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-8">
            <Link href="/finance-tools" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
              Finance Tools Hub
            </Link>
            <Link href="/learn/investing-wealth" className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700">
              Investing Learn
            </Link>
            <Link href="/calculators/sip-calculator" className="px-6 py-3 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700">
              SIP Calculator
            </Link>
            <Link href="/emi-simplifier" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
              EMI Simplifier
            </Link>
            <Link href="/tax-simplifier" className="px-6 py-3 bg-amber-600 text-white rounded-xl font-semibold hover:bg-amber-700">
              Tax Simplifier
            </Link>
          </div>
        </div>
