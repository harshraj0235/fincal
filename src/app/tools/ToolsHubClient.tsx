...
const ToolsHub: React.FC = () => {
  ...
  const tools: Tool[] = [
    ...
    {
      id: 'bank-tools',
      name: 'Bank & Saving Tools',
      description: 'Bank locker finder, IFSC, savings planner, FD, RD, and more',
      icon: <Building2 className="h-6 w-6" />,
      category: 'Banking',
      path: '/bank-tools',
    ...
    {
      id: 'gold-tools',
      name: 'Gold Investment Tools',
      description: 'Live gold rates, purity calculators, GST, making charges',
    ...
    },
    {
      ...
      name: 'Invoicing & Business Tools',
      description: 'GST invoice generator, proforma, estimates, billing software',
      icon: <FileText className="h-6 w-6" />,
      category: 'Business Tools',
      path: '/invoice-generator-business',
      color: 'from-indigo-500 to-violet-600'
    },
    {
      id: 'festival-tools',
      name: 'Festival & Muhurat Tools',
      description: 'Panchang, auspicious days, festival budgets, holiday calendar',
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li><span className="font-medium">Loans:</span> <Link href="/calculators/emi-calculator" className="text-blue-600 hover:underline">EMI Calculator</Link> → <Link href="/calculators/loan-prepayment-calculator" className="text-blue-600 hover:underline">Prepayment</Link> → <Link href="/calculators/loan-refinance-calculator" className="text-blue-600 hover:underline">Refinancing</Link></li>
                  <li><span className="font-medium">Investments:</span> <Link href="/calculators/sip-calculator" className="text-blue-600 hover:underline">SIP Calculator</Link> → <Link href="/calculators/xirr-calculator" className="text-blue-600 hover:underline">XIRR</Link> → <Link href="/finance-tools/portfolio-diversification-visualizer" className="text-blue-600 hover:underline">Diversification</Link></li>
                  <li><span className="font-medium">Taxes:</span> <Link href="/calculators/income-tax-calculator" className="text-blue-600 hover:underline">Income Tax</Link> → <Link href="/calculators/income-tax-regime-comparison-calculator" className="text-blue-600 hover:underline">Regime Comparison</Link> → <Link href="/calculators/section-80c-calculator" className="text-blue-600 hover:underline">80C Visualizer</Link></li>
                </ul>
              </div>
              <div>
