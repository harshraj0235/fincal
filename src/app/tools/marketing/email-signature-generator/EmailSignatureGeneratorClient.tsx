...
import { User, Mail, Phone, Globe, MapPin, Download, Copy, CheckCircle, Layout, Palette, Eye, Briefcase, ExternalLink, Smartphone, Sparkles, Camera } from "lucide-react";
                                    ...
                                    <div className="flex gap-4">
                                        <div className="shrink-0">
                                            <label className="relative block h-16 w-16 bg-slate-100 rounded-2xl overflow-hidden cursor-pointer hover:bg-slate-200 transition-all border-2 border-dashed border-slate-300">
                                                {data.photo ? <img src={data.photo} className="h-full w-full object-cover"  alt="MoneyCal Graphic" /> : <Camera className="w-6 h-6 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-slate-400" />}
                                        ...
                                        <div className="flex gap-8 items-center min-w-[450px]">
                                            {data.photo && (
                                                <div className="h-24 w-24 rounded-full overflow-hidden border-2" style={{ borderColor: accentColor }}>
                                                    <img src={data.photo} className="h-full w-full object-cover"  alt="MoneyCal Graphic" />
                                                </div>
                                            )}
                                        ...
                                        <div className="max-w-sm">
                                            <div className="flex items-start gap-4 mb-4">
                                                <div className="h-16 w-16 bg-slate-900 flex items-center justify-center text-white font-black text-xl rounded-2xl" style={{ backgroundColor: accentColor }}>
                                                    {data.photo ? <img src={data.photo} className="h-full w-full object-cover rounded-2xl"  alt="MoneyCal Graphic" /> : data.name.charAt(0)}
                                                </div>
                                                <div className="pt-1">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <Globe className="w-4 h-4 text-white p-1 rounded-md" style={{ backgroundColor: accentColor }} />
