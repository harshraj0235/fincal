...
import { Download, Image as ImageIcon, Type, Palette, Layout, Save, Share2, Sparkles, TrendingUp, Shield, Landmark, Calculator, ArrowRight, CheckCircle, Zap, RefreshCcw, Camera, IndianRupee } from "lucide-react";
...
const ASPECT_RATIOS = [
    { id: 'sq', name: 'Globe (1:1)', w: 1080, h: 1080, class: 'aspect-square' },
    { id: 'fb', name: 'Globe/Globe (1.91:1)', w: 1200, h: 630, class: 'aspect-[1.91/1]' },
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <label className="flex-1 flex items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 cursor-pointer hover:border-violet-400 hover:bg-violet-50 transition-all">
                                                <ImageIcon className="w-4 h-4 text-gray-400"  alt="MoneyCal Graphic" />
                            ...
                            <div className="mt-8 grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="p-6 bg-emerald-50/50 rounded-3xl border border-emerald-100">
                                    <h3 className="flex items-center gap-2 font-black text-emerald-900 text-sm mb-2">
                                        <ImageIcon className="w-4 h-4 text-emerald-500"  alt="MoneyCal Graphic" />
                                        Background Quality
                                    </h3>
                ...
                <div className="max-w-4xl mx-auto px-4 mt-20 text-center">
                    ...
                    <div className="grid sm:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 font-medium">Precise aspect ratios for Globe, Globe, and Globe marketing campaigns.</p>
                        </div>
                    </div>
                </div>
