      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-purple-50 to-indigo-50 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Get My Horoscope</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Explore Tips</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Generate Numbers</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance/muhurat" className="astro-finance-btn">Calculate Muhurat</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Calculate Savings</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Find Gemstone</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Calculate Nakshatra</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Analyze Planets</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Read Daily Horoscope</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Check Compatibility</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Get 2025 Forecast</Link>
          </div>
            <div className="cosmic-card p-6 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm border border-white/20">
            ...
            <Link href="/astro-finance" className="astro-finance-btn">Find Crystals</Link>
          </div>
          </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {currentPosts.map((post, index) => (
                  <Link
                    key={post.id}
                    href={`/astro-finance/blog/${post.slug}`}
                    className="block"
                  >
                    <motion.article
                      initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className={`p-6 flex-1 ${
                      ...
                      <h2 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-purple-600 transition-colors">
                        <Link href={`/astro-finance/blog/${post.slug}`}>
                          {post.title}
                        </Link>
                      </h2>
          ...
          >
            <h2 className="text-2xl font-bold mb-4 text-center">What we are building next</h2>
