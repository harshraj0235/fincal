    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 pt-20 pb-16">
      <div className="max-w-lg mx-auto px-4">
        <div className="text-center mb-6">
          <Link href="/games" className="inline-flex items-center gap-1 text-sm text-violet-600 hover:text-violet-800 mb-3 font-medium">← Back to Games</Link>
        ...
        {gameOver && (
          <div className="flex gap-3 mb-6 justify-center">
            ...
            <Link href="/games" className="flex items-center gap-2 px-6 py-3 bg-slate-200 text-slate-800 font-bold rounded-2xl hover:bg-slate-300">
