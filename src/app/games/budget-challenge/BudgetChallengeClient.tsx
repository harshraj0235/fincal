    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 pt-20 pb-16">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <Link href="/games" className="inline-flex items-center gap-1 text-sm text-emerald-600 hover:text-emerald-800 mb-4 font-medium">
            ← Back to Games
          </Link>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="flex gap-3">
                ...
                <Link href="/games" className="flex-1 flex items-center justify-center gap-2 bg-slate-200 text-slate-800 font-bold py-3 px-6 rounded-2xl hover:bg-slate-300 transition-colors">
