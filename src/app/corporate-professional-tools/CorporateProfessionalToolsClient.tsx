...
import { Briefcase, Search, Filter, Users, Mail, Gift, Calendar, DollarSign, Home, ChevronRight, X, Star, TrendingUp, FileText, Award, Building, MessageCircle, Clock, Target, Heart, PieChart, BarChart3, Sparkles, ArrowRight, Bell, Clipboard, CheckCircle, Video, Image, Hash, Globe, Smartphone, Mic, Lightbulb } from "lucide-react";
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              <Link href="/" className="hover:text-slate-600 transition-colors flex items-center">
                <Home className="w-4 h-4 mr-1" />
                Home
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-tools" className="hover:text-slate-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
