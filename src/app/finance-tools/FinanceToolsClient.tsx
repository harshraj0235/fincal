...
const FinanceTools: React.FC = () => {
  ...
  const financeTools: FinanceTool[] = [
    // SIP Tools
    {
      ...
      category: 'SIP Tools',
      path: '/finance-tools/sipdelay-loss-calculator',
      isPopular: true,
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/sipstep-up-planner',
      isPopular: true,
    ...
    },
    {
      ...
      category: 'SIP Tools',
      path: '/finance-tools/lumpsum-vs-sipanalyzer',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/sipinflation-adjusted-calculator',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/sipmissed-payment-loss-estimator',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/sipwithdrawal-planner',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/sipvs-swptool',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/flexi-sipplanner',
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-6 w-6" />,
      category: 'SIP Tools',
      path: '/finance-tools/siptracker-with-goal-thermometer',
    ...
    },
    {
      ...
      category: 'SIP Tools',
      path: '/finance-tools/sipreturn-deviation-chart',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Mutual Fund Tools',
      path: '/finance-tools/mutual-fund-historical-navvisualizer',
      color: 'from-purple-500 to-purple-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Mutual Fund Tools',
      path: '/finance-tools/etfvs-mutual-fund-comparison',
      color: 'from-indigo-500 to-indigo-600',
    ...
    },
    {
      ...
      icon: <IndianRupee className="h-6 w-6" />,
      category: 'Investment Analysis',
      path: '/finance-tools/fdvs-mutual-fund-return-tool',
      color: 'from-green-500 to-green-600',
    ...
    },
    {
      ...
      icon: <IndianRupee className="h-6 w-6" />,
      category: 'Investment Analysis',
      path: '/finance-tools/stock-cagrcalculator',
      color: 'from-purple-500 to-purple-600',
    ...
    // Advanced Investment
    {
      ...
      path: '/finance-tools/xirrcalculator',
      isPopular: true,
      color: 'from-indigo-500 to-indigo-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/elssvs-ppfreturn-visualizer',
      color: 'from-purple-500 to-purple-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/reits-vs-fdroivisualizer',
      color: 'from-blue-500 to-blue-600',
    ...
    },
    {
      ...
      icon: <IndianRupee className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/stock-split-adjusted-roicalculator',
      color: 'from-purple-500 to-purple-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/npsvs-ppfcomparison',
      color: 'from-teal-500 to-teal-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/real-estate-vs-stock-roitool',
      color: 'from-cyan-500 to-cyan-600',
    ...
    },
    {
      ...
      icon: <IndianRupee className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/amcfee-analyzer-tool',
      color: 'from-red-500 to-red-600',
    ...
    },
    {
      ...
      icon: <IndianRupee className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/ulipvs-term-insurance-return-calculator',
      color: 'from-green-500 to-green-600',
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6" />,
      category: 'Advanced Investment',
      path: '/finance-tools/gold-sipvs-gold-etfreturn-visualizer',
      color: 'from-yellow-500 to-yellow-600',
