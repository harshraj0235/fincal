...
import { TrendingUp, BarChart3, Calculator, DollarSign, PieChart, LineChart, Activity, Info, AlertCircle, CheckCircle, Clock, Target, Zap, Shield, Globe, Smartphone, IndianRupee } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              >
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <IndianRupee className="h-6 w-6 mr-3 text-yellow-600" />
