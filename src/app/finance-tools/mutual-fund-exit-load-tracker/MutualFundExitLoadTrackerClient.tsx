...
import { 
  ...
  Zap,
  Clock,
  TrendingDown, IndianRupee } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <div className="flex items-center justify-center mb-4">
                <Link href="/finance-tools" className="text-white hover:text-red-200 transition-colors text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              >
                <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <IndianRupee className="h-5 w-5 md:h-6 md:w-6 mr-3 text-red-600" />
                  Add Fund
                </h2>
        ...
        <section className="py-8 md:py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <Link
                href="/finance-tools/mutual-fund-expense-ratio-estimator"
              ...
              <Link
                href="/finance-tools/asset-allocation-tool"
                className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all border border-gray-100 hover:border-red-200 transform hover:-translate-y-1 duration-300 block"
              >
              ...
              <Link
                href="/finance-tools/equity-vs-debt-split-recommender"
                className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all border border-gray-100 hover:border-red-200 transform hover:-translate-y-1 duration-300 block"
              >
