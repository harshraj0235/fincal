        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-purple-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-dates" className="hover:text-purple-600 transition-colors">
                Festival Dates
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/janmashtami-fasting" className="group bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-blue-200 hover:shadow-xl transition-all">
              ...
              <Link href="/religious-tools" className="group bg-gradient-to-br from-indigo-50 to-blue-50 p-6 rounded-2xl border-2 border-indigo-200 hover:shadow-xl transition-all">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-8 rounded-2xl mb-8">
              ...
              <div className="mt-6 bg-gradient-to-r from-purple-100 to-indigo-100 p-6 rounded-xl">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <Link href="/festival-shopping" className="text-purple-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
                    Festival Budget Planner
                  </Link>
                  <Link href="/religious-tools" className="text-purple-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
                    Puja Vidhi Guide
                  </Link>
                </div>
