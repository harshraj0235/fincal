    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/festival-tools" className="text-rose-700 underline">Back to Festival Tools</Link>
        </div>
      </div>
    );
  }
    ...
    <>
          ...
          __html: JSON.stringify(
            [
              buildSoftwareAppJsonLd(
                ...
                `https://moneycal.in/festival-tools/${festival.slug}/${tool.slug}`,
                tool.description
              ),
              buildFaqJsonLd([
      ...
      <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 via-white to-rose-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-6">
            <Link href={`/festival-tools/${festival.slug}`} className="flex items-center text-neutral-600 hover:text-neutral-900">
          ...
          <div ref={resultsRef} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <Link href="/festival-tools" className="text-blue-600 hover:text-blue-800 underline">All Festival Tools</Link>
