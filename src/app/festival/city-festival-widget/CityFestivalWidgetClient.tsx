...
import { Calendar, MapPin, Home, ChevronRight, Share2, Download, Copy, Check, ExternalLink, Search, Sparkles, Clock, Star, Bell, Globe, Sun, Moon, Code, Eye, Settings, Zap, TrendingUp, Target, Award, BookOpen, Info, AlertCircle, CheckCircle, ArrowRight, RefreshCw, ChevronDown, ChevronUp, Users, Gift, Heart, DollarSign, Maximize2, Minimize2, Palette, Layout, Smartphone, Monitor, Tablet, Filter, SlidersHorizontal, Play } from "lucide-react";
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                },
                {
                  ...
                  a: 'Yes! You can customize: Widget size (Small/Medium/Large), Theme (Light/Dark/Colorful), Number of festivals displayed (3-15), Show/hide muhurat timings, Show/hide festival descriptions. More customization options are on the roadmap.'
                },
                {
