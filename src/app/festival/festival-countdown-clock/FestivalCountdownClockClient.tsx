...
import { Clock, Calendar, MapPin, Home, ChevronRight, Share2, Download, Copy, Check, ExternalLink, Search, Sparkles, Star, Bell, Globe, Sun, Moon, Zap, Target, Award, BookOpen, TrendingUp, Heart, Gift, ChevronDown, ChevronUp, RefreshCw, ArrowRight, Timer, Play, Pause, RotateCcw, Settings, Info, AlertCircle, CheckCircle } from "lucide-react";
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                },
                {
                  ...
                  a: 'Yes! Use the Share button to share the live countdown via WhatsApp, Globe, Globe, or email. You can also copy the direct link to send to anyone. The shared link will show the same live countdown for the selected festival, year, and city.'
                },
                {
