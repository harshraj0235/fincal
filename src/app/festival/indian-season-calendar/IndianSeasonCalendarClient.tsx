...
import { Calendar, MapPin, Home, ChevronRight, Share2, Download, Copy, Check, ExternalLink, Search, Sparkles, Clock, Star, Bell, Globe, Sun, Moon, CloudRain, Snowflake, Flower, Wind, Droplets, Thermometer, Zap, TrendingUp, Target, Award, BookOpen, Info, AlertCircle, CheckCircle, ArrowRight, RefreshCw, ChevronDown, ChevronUp, Settings, Users, Calendar as CalendarIcon, Gift, Heart, DollarSign, Leaf, Trees } from "lucide-react";
        ...
        <div className="bg-white/80 backdrop-blur-sm border-b border-green-100">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm">
              ...
              <Link href="/festival-date-calendar" className="text-green-600 hover:text-green-800">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 text-gray-400" />
