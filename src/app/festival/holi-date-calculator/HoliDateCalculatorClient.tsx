...
import { Calendar, MapPin, Clock, Sun, Moon, Droplets, Heart, Home, ChevronRight, Share2, Download, Bell, ArrowRight, Info, Sparkles, Gift, Check, Copy, X, TrendingUp, ShoppingBag, Music, Palette, Users, ExternalLink } from "lucide-react";
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-pink-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-dates" className="hover:text-pink-600 transition-colors">
                Festival Dates
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/diwali-date-finder" className="group bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-2xl border-2 border-orange-200 hover:shadow-xl transition-all">
              ...
              <Link href="/festival-dates" className="group bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border-2 border-purple-200 hover:shadow-xl transition-all">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <div className="mt-6 bg-gradient-to-r from-pink-100 to-purple-100 p-6 rounded-xl border-2 border-pink-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <Link href="/festival-shopping" className="flex items-center space-x-2 text-pink-600 hover:underline font-semibold">
                    ...
                    <Link href="/festival-finance" className="flex items-center space-x-2 text-pink-600 hover:underline font-semibold">
                      <ArrowRight className="w-4 h-4" />
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-teal-500 pl-6">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      <strong>Essential Holi shopping list:</strong> Organic gulal/colors (₹100-500 for pack), water guns/pichkaris (₹50-300), white/old clothes, coconut oil for skin protection, sunscreen, herbal face wash, sweets (gujiya ₹200-500/kg), thandai ingredients, bhang (from authorized shops only), decorations. <strong>Best deals:</strong> <a href="https://www.amazon.in/s?k=holi" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline">Amazon Holi Store</a>, <a href="https://www.flipkart.com/holi-store" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline">Flipkart Holi Sale</a>, local markets (better prices). Use our <Link href="/festival-shopping" className="text-teal-600 hover:underline">Festival Shopping Planner</Link> to track budget.
                    </p>
                  </div>
                </div>
              </div>
