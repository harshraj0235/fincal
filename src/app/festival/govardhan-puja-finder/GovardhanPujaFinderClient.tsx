...
const GovardhanPujaFinder: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/govardhan-puja-finder?year=${selectedYear}`;
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-green-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-dates" className="hover:text-green-600 transition-colors">
                Festival Dates
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
          ...
          <div className="max-w-4xl mx-auto px-4 prose prose-lg">
            ...
            <div className="mt-6 bg-green-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <Link href="/festival-dates" className="text-green-600 hover:underline flex items-center">
                  <ArrowRight className="w-4 h-4 mr-1" />
                  All Festival Dates
                </Link>
                <Link href="/religious-tools" className="text-green-600 hover:underline flex items-center">
                  <ArrowRight className="w-4 h-4 mr-1" />
                  Puja Vidhi & Mantras
                </Link>
              </div>
