...
const NavratriDatesFinder: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/navratri-dates?year=${selectedYear}&type=${navratriType}&city=${selectedCity.name}`;
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <div className="mt-6 bg-gradient-to-r from-pink-100 to-purple-100 p-6 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <Link href="/design-tools" className="text-orange-600 hover:underline flex items-center">
                      <ArrowRight className="w-4 h-4 mr-1" />
