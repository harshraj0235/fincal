...
import { AlertTriangle, Calendar, CheckCircle, XCircle, Download, Filter, MapPin, Home, ChevronRight, Copy, Check, ExternalLink, Search, Info, Sparkles, Clock, Star, Bell, Globe, Share2, AlertCircleIcon, Calendar as CalendarIcon, TrendingUp, Target, Award, Zap, RefreshCw, Plus, Minus, ChevronDown, ChevronUp, BookOpen, FileText, Users, ArrowRight } from "lucide-react";
...
const FestivalClashChecker: React.FC = () => {
  ...
  const handleShare = (platform: string) => {
    const shareUrl = `/festival-tools/festival-clash-checker`;
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText('/festival-tools/festival-clash-checker');
    setCopied(true);
        ...
        <div className="bg-white/80 backdrop-blur-sm border-b border-orange-100">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm">
              <Link href="/" className="text-orange-600 hover:text-orange-800 flex items-center gap-1">
                <Home className="w-4 h-4" />
                Home
              </Link>
              <ChevronRight className="w-4 h-4 text-gray-400" />
              <Link href="/festival-date-calendar" className="text-orange-600 hover:text-orange-800">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 text-gray-400" />
