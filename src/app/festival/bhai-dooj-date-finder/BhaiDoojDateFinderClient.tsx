          ...
          <div className="max-w-7xl mx-auto px-4">
                ...
                {bhaiDoojInfo && (
                  <div className="p-8">
                    ...
                    <div className="bg-gradient-to-br from-pink-50 to-red-50 p-6 rounded-2xl border-2 border-pink-200">
                      ...
                      <div className="mt-4">
                        <Link href="/festival-shopping" className="text-pink-600 hover:underline font-semibold flex items-center">
            ...
            <div className="mt-12 max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link href="/festival-tools/dhanteras-date-finder" className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all border-2 border-yellow-200">
          ...
          <div className="max-w-4xl mx-auto px-4 prose prose-lg">
            ...
            <div className="mt-6 bg-pink-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <Link href="/festival-dates" className="text-pink-600 hover:underline flex items-center">
                  <ArrowRight className="w-4 h-4 mr-1" />
                  All Festival Dates
                </Link>
                <Link href="/festival-shopping" className="text-pink-600 hover:underline flex items-center">
                  <ArrowRight className="w-4 h-4 mr-1" />
                  Gift Ideas & Shopping
                </Link>
              </div>
