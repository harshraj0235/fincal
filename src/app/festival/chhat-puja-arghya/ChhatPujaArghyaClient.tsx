...
const ChhatPujaArghya: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/chhath-puja-arghya?year=${selectedYear}&city=${selectedCity.name}`;
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/diwali-date-finder" className="group bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-2xl border-2 border-yellow-200 hover:shadow-xl transition-all">
              ...
              <Link href="/religious-tools" className="group bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-blue-200 hover:shadow-xl transition-all">
