...
const KarwaChouthMoonrise: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/karwa-chauth-moonrise?year=${selectedYear}&city=${selectedCity.name}`;
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/religious-tools" className="group bg-gradient-to-br from-red-50 to-pink-50 p-6 rounded-2xl border-2 border-red-200 hover:shadow-xl transition-all">
