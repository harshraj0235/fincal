...
import { Bell, Calendar, Clock, Star, Sun, Moon, Download, Share2, Plus, Trash2, MapPin, Home, ChevronRight, Copy, Check, ExternalLink, AlertCircle, Sparkles, Info, Settings, Globe, Search, Filter, TrendingUp, Zap } from "lucide-react";
...
const ShubhMuhuratReminder: React.FC = () => {
  ...
  useEffect(() => {
    const saved = (typeof window !== 'undefined' ? window.localStorage : { getItem: () => null, setItem: () => {}, removeItem: () => {} }).getItem('shubh-muhurat-reminders');
    if (saved) {
      try {
  ...
  useEffect(() => {
    if (customReminders.length > 0) {
      (typeof window !== 'undefined' ? window.localStorage : { getItem: () => null, setItem: () => {}, removeItem: () => {} }).setItem('shubh-muhurat-reminders', JSON.stringify(customReminders));
    }
  }, [customReminders]);
  ...
  const shareUrl = `/festival-tools/shubh-muhurat-reminder`;
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link href="/festival-tools/nakshatra-festival" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                  ...
                  <Link href="/festival-tools/festival-countdown-clock" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/festival-tools/diwali-date-finder" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
