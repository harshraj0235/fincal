        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-indigo-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link href="/festival-tools/diwali-date-finder" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
                  ...
                  <Link href="/festival-tools/nakshatra-festival" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/festival-tools/shubh-muhurat-reminder" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
                    <div className="flex items-center space-x-3 mb-2">
