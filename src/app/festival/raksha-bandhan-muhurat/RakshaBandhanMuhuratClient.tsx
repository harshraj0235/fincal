...
import { Calendar, MapPin, Clock, Sun, Moon, Heart, Home, ChevronRight, Share2, Download, Bell, ArrowRight, Info, Sparkles, Gift, Check, Copy, X, Star, AlertCircle, Users, ShoppingBag, ExternalLink, Zap, Award } from "lucide-react";
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/festival-tools/karwa-chauth-moonrise" className="group bg-gradient-to-br from-pink-50 to-rose-50 p-6 rounded-2xl border-2 border-pink-200 hover:shadow-xl transition-all">
              ...
              <Link href="/festival-dates" className="group bg-gradient-to-br from-purple-50 to-indigo-50 p-6 rounded-2xl border-2 border-purple-200 hover:shadow-xl transition-all">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <div className="mt-6 bg-gradient-to-r from-orange-100 to-pink-100 p-6 rounded-xl border-2 border-orange-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <Link href="/festival-shopping" className="flex items-center space-x-2 text-orange-600 hover:underline font-semibold">
              ...
              <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link href="/festival-dates" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
                  ...
                  <Link href="/religious-tools" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
                  ...
                  <Link href="/festival-shopping" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all">
