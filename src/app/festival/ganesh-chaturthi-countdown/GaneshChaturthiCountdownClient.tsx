...
const GaneshChaturthiCountdown: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/ganesh-chaturthi-countdown?year=${selectedYear}&city=${selectedCity.name}`;
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/navratri-dates" className="group bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-2xl border-2 border-orange-200 hover:shadow-xl transition-all">
              ...
              <Link href="/festival-tools/diwali-date-finder" className="group bg-gradient-to-br from-amber-50 to-yellow-50 p-6 rounded-2xl border-2 border-amber-200 hover:shadow-xl transition-all">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <div className="mt-6 bg-gradient-to-r from-orange-100 to-yellow-100 p-6 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <Link href="/festival-shopping" className="text-orange-600 hover:underline flex items-center">
                      <ArrowRight className="w-4 h-4 mr-1" />
                      Festival Budget Planner
                    </Link>
                    <Link href="/religious-tools" className="text-orange-600 hover:underline flex items-center">
                      <ArrowRight className="w-4 h-4 mr-1" />
                      Puja Vidhi Guide
                    </Link>
                  </div>
              ...
              <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-white p-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link href="/festival-dates" className="bg-white/10 hover:bg-white/20 p-4 rounded-xl">
                    <Calendar className="w-8 h-8 mb-2" />
                    <h4 className="font-bold text-lg">Festival Calendar {selectedYear}</h4>
                  </Link>
                  <Link href="/religious-tools" className="bg-white/10 hover:bg-white/20 p-4 rounded-xl">
                    <Star className="w-8 h-8 mb-2" />
                    <h4 className="font-bold text-lg">Puja Vidhi & Mantras</h4>
                  </Link>
                  <Link href="/festival-shopping" className="bg-white/10 hover:bg-white/20 p-4 rounded-xl">
