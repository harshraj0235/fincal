...
const DhanterasDateFinder: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/dhanteras-date-finder?year=${selectedYear}`;
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-yellow-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-dates" className="hover:text-yellow-600 transition-colors">
                Festival Dates
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
          ...
          <div className="max-w-7xl mx-auto px-4">
                  ...
                  <div className="p-8">
                    ...
                    <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-2xl border-2 border-yellow-200">
                      ...
                      <div className="mt-4 flex gap-3">
                        <Link href="/gold-tools" className="text-yellow-600 hover:underline font-semibold flex items-center">
            ...
            <div className="mt-12 max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link href="/festival-tools/diwali-date-finder" className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all border-2 border-orange-200">
                ...
                <Link href="/festival-tools/govardhan-puja-finder" className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all border-2 border-green-200">
                ...
                <Link href="/festival-tools/bhai-dooj-date-finder" className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all border-2 border-pink-200">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              ...
              <div className="mt-8 bg-yellow-50 p-6 rounded-xl border-2 border-yellow-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Link href="/festival-dates" className="text-yellow-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
                    All Festival Dates {selectedYear}
                  </Link>
                  <Link href="/festival-finance" className="text-yellow-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
                    Festival Budget Calculator
                  </Link>
                  <Link href="/gold-tools" className="text-yellow-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
                    Gold Investment Tools
                  </Link>
                  <Link href="/festival-shopping" className="text-yellow-600 hover:underline flex items-center">
                    <ArrowRight className="w-4 h-4 mr-1" />
