...
import { Calendar, MapPin, Clock, Sun, Moon, Star, Share2, Download, Bell, Home, ChevronRight, Info, Sparkles, Heart, Gift, ArrowRight, ExternalLink, Copy, Check, AlertCircle, TrendingUp, DollarSign, ShoppingBag, Zap, Globe } from "lucide-react";
...
const DiwaliDateFinder: React.FC = () => {
  ...
  const shareUrl = `/festival-tools/diwali-date-finder?year=${selectedYear}`;
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <Link href="/festival-tools" className="hover:text-orange-600 transition-colors">
                Festival Tools
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
              <Link href="/festival-dates" className="hover:text-orange-600 transition-colors">
                Festival Dates
              </Link>
              <ChevronRight className="w-4 h-4 mx-2" />
                          ...
                          {showShareMenu && (
                            ...
                            >
                              ...
                              >
                                ...
                                <span className="font-semibold text-gray-900">Globe</span>
                              </button>
                              <button
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/festival-tools/dhanteras-date-finder" className="group bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-2xl border-2 border-yellow-200 hover:shadow-xl transition-all">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="w-12 h-12 bg-yellow-500 rounded-xl flex items-center justify-center">
                    <Sun className="w-6 h-6 text-white" />
                  </div>
              ...
              <Link href="/festival-tools/govardhan-puja-finder" className="group bg-gradient-to-br from-red-50 to-pink-50 p-6 rounded-2xl border-2 border-red-200 hover:shadow-xl transition-all">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="w-12 h-12 bg-red-500 rounded-xl flex items-center justify-center">
              ...
              <Link href="/festival-tools/bhai-dooj-date-finder" className="group bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border-2 border-purple-200 hover:shadow-xl transition-all">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="w-12 h-12 bg-purple-500 rounded-xl flex items-center justify-center">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                ...
                <p className="text-gray-700 mb-3">
                  Use our <Link href="/festival-shopping" className="text-orange-600 hover:underline font-semibold">Festival Budget Planner</Link> to manage your Diwali expenses across:
                </p>
                ...
                <ul className="space-y-2 text-gray-700 mb-4">
                  <li className="flex items-start">
                    ...
                    <span><strong>ELSS Mutual Funds:</strong> Invest before Dec 31 to save up to ₹46,800 tax (₹1.5L limit) - Use our <Link href="/tax-tools/section-80c-tally-analyzer" className="text-blue-600 hover:underline">80C Calculator</Link></span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2">📊</span>
                ...
                <div className="mt-6 bg-gradient-to-r from-orange-100 to-red-100 p-6 rounded-xl border-2 border-orange-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <Link href="/festival-finance" className="flex items-center space-x-2 text-orange-600 hover:underline font-semibold">
                      <ArrowRight className="w-4 h-4" />
                      <span>Festival Budget Calculator</span>
                    </Link>
                    <Link href="/finance-tools/sip-delay-loss-calculator" className="flex items-center space-x-2 text-orange-600 hover:underline font-semibold">
                      <ArrowRight className="w-4 h-4" />
                      <span>Investment Planning Tools</span>
                    </Link>
                    <Link href="/tax-tools" className="flex items-center space-x-2 text-orange-600 hover:underline font-semibold">
                      <ArrowRight className="w-4 h-4" />
                      <span>Tax Saving Calculators</span>
                    </Link>
                    <Link href="/gold-tools" className="flex items-center space-x-2 text-orange-600 hover:underline font-semibold">
                      <ArrowRight className="w-4 h-4" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2">☐</span>
                        <span>Plan shopping list & budget using our <Link href="/festival-shopping" className="text-orange-600 hover:underline">Shopping Planner</Link></span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2">☐</span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-orange-600 pl-6">
                    ...
                    <p className="mt-3 text-gray-700">
                      Use our <Link href="/tax-tools/section-80c-tally-analyzer" className="text-orange-600 hover:underline">80C Tax Calculator</Link> and <Link href="/finance-tools" className="text-orange-600 hover:underline">Investment Planning Tools</Link> for personalized recommendations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link href="/festival-dates" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                  ...
                  <Link href="/festival-shopping" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/festival-finance" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/religious-tools" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/design-tools" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
                  ...
                  <Link href="/gold-tools" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-4 rounded-xl transition-all group">
                    <div className="flex items-center space-x-3 mb-2">
