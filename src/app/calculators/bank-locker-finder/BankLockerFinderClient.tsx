          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow flex flex-col gap-3">
              ...
              <ul className="list-disc ml-6 text-blue-700 space-y-1">
                <li><Link href="/calculators/bank-charges-analyzer" className="hover:underline">Bank Charges Analyzer</Link></li>
                <li><Link href="/missed-call-banking-directory" className="hover:underline">Missed Call Banking Directory</Link></li>
                <li><Link href="/calculators/cheque-bounce-charges-calculator" className="hover:underline">Cheque Bounce Charges Calculator</Link></li>
                <li><Link href="/bank-tools" className="hover:underline">All Bank Tools</Link></li>
