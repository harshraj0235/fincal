...
export const CorporateFinance: React.FC = () => {
  const corporateTools = [
    ...
    },
    {
      ...
      name: 'Corporate Loan Amortization',
      description: 'Generate detailed loan repayment schedules',
      icon: DollarSign,
      color: 'from-green-500 to-green-600',
      features: ['Amortization Table', 'Excel Export', 'Multiple Frequencies', 'Interest Analysis'],
      keywords: 'corporate loan calculator, loan amortization schedule, business EMI tool',
