...
import { Shield, IndianRupee, TrendingUp, Target, AlertCircle, PieChart } from 'lucide-react';
...
const TaxSavingCalculator: React.FC = () => {
  ...
  const calculateTaxSavings = useCallback(() => {
    const { annualIncome, taxRegime } = userData;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-100">
      <SEOHelmet
        ...
        canonicalUrl="/tools/tax-saving-calculator"
      />
