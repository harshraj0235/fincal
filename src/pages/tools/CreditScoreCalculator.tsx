...
import { CreditCard, TrendingUp, AlertCircle, CheckCircle, Zap, Info, Star, IndianRupee, BarChart3, Target, DollarSign } from 'lucide-react';
...
const CreditScoreCalculator: React.FC = () => {
  ...
  const contentData = {
    title: "Credit Score Calculator India (CIBIL)",
    description: "Analyze your CIBIL credit score, understand the 5 factors that determine it, check loan eligibility at different score levels, and get a personalized improvement plan. Covers payment history, credit utilization, credit age, credit mix, and recent inquiries.",
    benefits: [
      "Understand exactly how your credit score is calculated by CIBIL",
      "Check loan eligibility — personal loan, home loan, car loan, credit card",
      "See estimated interest rates you qualify for at your score level",
      "Get a personalized credit improvement plan with timeline",
      "Analyze all 5 credit score factors with actionable recommendations"
    ],
    howToSteps: [
      { step: "Enter Your Credit Score", details: "If you don't know your score, check free on CIBIL website, Paisabazaar, or your bank's app. Enter the 300-900 number." },
      { step: "Fill Credit Profile", details: "Enter your payment history quality, credit utilization %, credit age in years, credit mix type, and recent inquiries count." },
      { step: "Analyze Results", details: "See your score rating (Excellent/Good/Fair/Poor), factor-by-factor analysis, loan eligibility, and estimated interest rates." },
      { step: "Follow Improvement Plan", details: "Get a 6-12 month plan with specific actions to boost your score by 50+ points." }
    ],
    examples: [
      {
        scenario: "Score 720 — Good Score, Wants Home Loan",
        inputs: [
          { label: "Current Score", value: "720" },
          { label: "Payment History", value: "Good (1-2 late payments)" },
          { label: "Credit Utilization", value: "35%" },
          { label: "Credit Age", value: "6 years" }
        ],
        result: "Eligible for home loan at 9.0% | Can improve to 770+ in 6 months",
        explanation: "Meera (720 score) is eligible for a home loan but not at the best rate. Her 35% utilization is slightly high. By reducing it to under 30% and maintaining zero late payments for 6 months, she can reach 770+ and qualify for 8.5% rate — saving ₹4.2L interest on a ₹50L, 20-year home loan."
      }
    ],
    tips: [
      "Always keep credit card utilization below 30%. If your limit is ₹1L, never let the balance exceed ₹30K at billing time.",
      "Set up autopay for at least the minimum due on all credit cards — even one missed payment can drop your score 50-100 points.",
      "Don't close old credit cards even if unused — they increase your average credit age and available credit limit.",
      "Space out loan applications by at least 3 months. Each hard inquiry temporarily reduces your score by 5-10 points."
    ],
    mistakes: [
      "Checking credit score on sites that do 'hard inquiry' instead of 'soft inquiry' — hard inquiries reduce your score.",
      "Closing old credit cards to 'simplify finances' — this reduces credit age and available limit, hurting your score.",
      "Maxing out credit cards even if you pay full balance — utilization is calculated at billing date, not payment date.",
      "Applying for multiple loans/cards simultaneously — each application triggers a hard inquiry, signaling desperation to lenders."
    ],
    faqs: [
      { question: "What is a good CIBIL score in India?", answer: "750+ is considered excellent and gets you the best loan terms. 700-749 is good with favorable rates. 650-699 is fair with moderate terms. Below 650 is poor with limited options. Most banks require minimum 650 for personal loans and 700+ for home loans. If your score is below 650, focus on improvement for 6-12 months before applying for any major loan." },
      { question: "How is CIBIL score calculated?", answer: "Your CIBIL score is calculated based on 5 factors: Payment History (35% weight) — whether you pay EMIs and credit card bills on time. Credit Utilization (30%) — how much of your credit limit you use. Credit Age (15%) — how long you've had credit accounts. Credit Mix (10%) — variety of credit types (cards, loans). Recent Inquiries (10%) — how many new credit applications you've made recently." },
      { question: "How can I improve my credit score quickly?", answer: "The fastest improvements: 1) Pay all bills on time for 3-6 months (+30-50 points). 2) Reduce credit card utilization below 30% (+20-30 points). 3) Don't apply for new credit for 6 months (+10-15 points). 4) Get added as an authorized user on a family member's old, well-maintained card (+15-20 points). Total possible improvement in 6 months: 50-100 points." },
      { question: "How does credit score affect loan interest rates?", answer: "For a ₹50L home loan over 20 years: Score 750+: ~8.5% rate, EMI ₹43,391, total interest ₹54.1L. Score 700-749: ~9.0% rate, EMI ₹44,986, total interest ₹57.97L. Score 650-699: ~9.5% rate, EMI ₹46,607, total interest ₹61.86L. The difference between 750+ and 650-699 is ₹7.76L in extra interest over the loan term!" },
      { question: "How often should I check my credit score?", answer: "Check quarterly (every 3 months) if you're maintaining good credit. Check monthly if you're actively improving your score or planning to apply for a loan in the next 6 months. Use soft inquiry services like CIBIL's free annual report, Paisabazaar, or your bank's app — these don't affect your score. Avoid checking through services that do hard inquiries." }
    ],
    relatedCalculators: [
      { name: "Personal Loan Calculator", url: "/tools/personal-loan-calculator", description: "See how your credit score affects personal loan rates." },
      { name: "Home Loan Calculator", url: "/tools/home-loan-calculator", description: "Check home loan eligibility and EMI." },
      { name: "Debt Payoff Calculator", url: "/tools/debt-payoff-calculator", description: "Plan debt repayment to improve your score." },
      { name: "Net Worth Calculator", url: "/calculators/net-worth-calculator", description: "Track your overall financial health." }
    ],
  ...
  return (
    <>
      <SEOHelmet
        title="Free Credit Score Calculator - Check & Improve CIBIL Score | MoneyCal India"
        description="Analyze your CIBIL credit score, check loan eligibility, see estimated interest rates, and get a personalized improvement plan. Understand all 5 factors that affect your score."
        keywords="credit score Calculator, CIBIL score, credit score improvement, credit score analysis, loan eligibility, credit score factors, credit monitoring"
        canonicalUrl="/tools/credit-score-calculator"
        faqData={contentData.faqs}
      />
      <CalculatorSchema
        name="Credit Score Calculator"
        description="Analyze CIBIL credit score, check loan eligibility, and get a personalized improvement plan for India."
        url="/tools/credit-score-calculator"
        features={[
          "CIBIL score analysis (300-900)",
          "5-factor breakdown with recommendations",
          "Loan eligibility check with interest rates",
          "Credit improvement plan with timeline",
