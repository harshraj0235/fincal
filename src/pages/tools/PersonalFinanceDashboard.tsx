...
import { BarChart3, TrendingUp, TrendingDown, DollarSign, PieChart, Calendar, Target, Download, Upload } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100">
      <SEOHelmet
        ...
        canonicalUrl="/tools/personal-finance-dashboard"
      />
