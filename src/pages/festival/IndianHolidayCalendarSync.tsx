...
const IndianHolidayCalendarSync: React.FC = () => {
  ...
  const generateICalFile = () => {
    ...
    filteredFestivals.forEach(festival => {
      ...
      description += `\\n\\nLearn more: https://moneycal.in/festival-tools/indian-holiday-calendar-sync`;
  ...
  const handleShare = (platform: string) => {
    const shareUrl = `https://moneycal.in/festival-tools/indian-holiday-calendar-sync`;
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText('https://moneycal.in/festival-tools/indian-holiday-calendar-sync');
    setCopied(true);
