...
const FestivalCountdownClock: React.FC = () => {
  ...
  const handleShare = (platform: string) => {
    const shareUrl = `https://moneycal.in/festival-tools/festival-countdown-clock?festival=${selectedFestival}&year=${selectedYear}&city=${selectedCity}`;
  ...
  const handleCopyLink = () => {
    const url = `https://moneycal.in/festival-tools/festival-countdown-clock?festival=${selectedFestival}&year=${selectedYear}`;
