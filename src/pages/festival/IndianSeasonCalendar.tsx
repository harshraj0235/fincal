...
const IndianSeasonCalendar: React.FC = () => {
  ...
  const handleShare = (platform: string) => {
    const shareUrl = `https://moneycal.in/festival-tools/indian-season-calendar?ritu=${selectedRitu}&city=${selectedCity}`;
  ...
  const handleCopyLink = () => {
    const url = `https://moneycal.in/festival-tools/indian-season-calendar?ritu=${selectedRitu}`;
  ...
  const exportToPDF = () => {
    alert('PDF export feature coming soon! Use browser print for now.');
  };
