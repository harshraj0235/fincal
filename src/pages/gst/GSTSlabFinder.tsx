...
const GSTSlabFinder: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="GST Slab Finder India 2026 | Product and Service GST Rate Lookup | MoneyCal"
        description="Get indicative GST slab for products and services with CGST/SGST or IGST split and downloadable rate summary."
        keywords="gst slab finder india, product gst rate finder tool, service gst rate checker india, cgst sgst igst slab lookup, gst tax slab search tool"
        url="/tools/gst-slab-finder"
        type="website"
          ...
          <div ref={resultsRef} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                <RouterLink to="/tools/gst-hsn-sac-finder" className="text-blue-600 hover:text-blue-800 underline">HSN/SAC Code Finder</RouterLink>
