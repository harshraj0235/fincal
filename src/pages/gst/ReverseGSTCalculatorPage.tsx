  ...
  return (
    <>
      <SEOHelmet
        ...
        url="https://moneycal.in/gst-tools/reverse-gst-calculator"
        image="https://moneycal.in/images/reverse-gst-calculator-og.jpg"
        type="website"
        structuredData={{
        ...
        breadcrumbs={[
          ...
          { name: 'Reverse GST Calculator', url: 'https://moneycal.in/gst-tools/reverse-gst-calculator' }
        ]}
      />
