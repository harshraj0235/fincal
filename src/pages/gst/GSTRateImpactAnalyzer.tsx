...
const GSTRateImpactAnalyzer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="GST Rate Impact Analyzer India 2026 | Price and Margin Effect | MoneyCal"
        description="Analyze GST rate change impact on selling price, customer pass-through, and business margin. Useful for pricing and negotiation planning."
        keywords="gst rate impact analyzer india, gst price increase impact calculator, gst margin impact tool, gst pass through calculator india, tax rate change impact on selling price"
        url="/tools/gst-rate-impact-analyzer"
        type="website"
