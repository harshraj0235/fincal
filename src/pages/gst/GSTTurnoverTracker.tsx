...
const GSTTurnoverTracker: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="GST Annual Turnover Tracker India | Registration Threshold Planner | MoneyCal"
        description="Track monthly sales, estimate annual turnover, and check GST registration threshold with growth projection support."
        keywords="gst annual turnover tracker india, gst registration threshold calculator, gst turnover limit goods services india, gst eligibility turnover checker, business turnover gst planner"
        url="/tools/gst-turnover-tracker"
        type="website"
