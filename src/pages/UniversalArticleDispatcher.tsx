...
const UniversalArticleDispatcher: React.FC = () => {
  ...
  if (import.meta.env.PROD && (category === 'finance-blog' || category === 'blog' || (typeof window !== 'undefined' && window.location.pathname.startsWith('/blog/')))) {
    if (typeof window !== 'undefined' && location.key !== 'default') {
