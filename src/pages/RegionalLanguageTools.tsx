...
import {
  ...
  Award, Users, Camera, Hash, ArrowRight, Clock, Utensils,
  Landmark, DollarSign, Palette, Navigation, TrendingDown
} from 'lucide-react';
    ...
    <>
      <SEOHelmet
        ...
        breadcrumbs={[
          ...
          { name: 'Regional & Language', url: '/regional-tools' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Regional & Language Festival Tools",
          description: "Multilingual tools and calendars for authentic regional celebrations across India.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: regionalTools.length
          }
        }}
      />
