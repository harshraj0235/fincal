...
import { Calculator, FileText, TrendingUp, Target, Shield, PiggyBank, CreditCard, Home, Car, GraduationCap, Heart, Globe, Star, Building, Users, BookOpen, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/personal-finance-management"
      />
