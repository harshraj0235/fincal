...
import {
  ...
  Home, ChevronRight, X, TrendingUp, Star, Zap, DollarSign,
  CreditCard, Calculator, Palette, Percent, ShoppingCart,
  Package, Heart, Users, Camera, MessageCircle, Mail, Smartphone,
  MapPin, TrendingDown, Clock, Target, Lightbulb, ArrowRight
} from 'lucide-react';
...
const FestivalPlanningShopping: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'budget', name: 'Budget & Planning', icon: Calculator, count: 8 },
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-pink-50 to-purple-50 p-6 rounded-2xl">
                  <Calculator className="w-10 h-10 text-pink-600 mb-3" />
