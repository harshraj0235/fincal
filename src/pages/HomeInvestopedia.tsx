      ...
      <div className={`min-h-screen transition-colors duration-500 ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex justify-between items-center">
              ...
              <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all shadow-lg">
                  <span className="text-white font-black text-xl sm:text-2xl">💰</span>
                </div>
                <span className="text-xl sm:text-2xl md:text-3xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                  MoneyCal.in
                </span>
              </Link>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <button
                  ...
                  className={`p-2 sm:p-2.5 rounded-xl transition-all active:scale-90 shadow-lg ${
                    theme === 'dark' 
                      ? 'bg-gradient-to-br from-yellow-500 to-orange-500 text-white hover:shadow-xl' 
                      : 'bg-gradient-to-br from-slate-700 to-blue-900 text-white hover:shadow-xl'
                  }`}
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl transition-all text-xs sm:text-sm font-bold active:scale-90 shadow-lg hover:shadow-xl ${
                    theme === 'dark'
        ...
        <section className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              <h1 className={`text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent leading-tight ${
                theme === 'dark' ? '' : 'drop-shadow-md'
              }`}>
                {language === 'en' ? 'Money Made Easy 💰' : 'पैसा आसान 💰'}
              </h1>
              <p className={`text-base sm:text-lg md:text-2xl mb-8 sm:mb-10 font-medium ${
            ...
            {/* Global Search - Below Hero */}
            <div className="max-w-4xl mx-auto mb-10 sm:mb-12">
              <div className="relative">
                <div className="relative group">
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl blur opacity-30 group-hover:opacity-60 transition duration-1000"></div>
                  <div className="relative">
                    <Search className={`absolute left-5 sm:left-6 top-1/2 transform -translate-y-1/2 w-6 h-6 sm:w-7 sm:h-7 ${
                    ...
                    <input
                      ...
                      className={`w-full pl-14 sm:pl-16 pr-14 sm:pr-16 py-4 sm:py-5 md:py-6 text-base sm:text-lg md:text-xl backdrop-blur-xl border-2 rounded-3xl focus:ring-4 transition-all outline-none font-medium shadow-xl ${
                        theme === 'dark'
                    ...
                    {searchQuery && (
                      <button
                        ...
                        className={`absolute right-5 sm:right-6 top-1/2 transform -translate-y-1/2 p-2 rounded-full transition-all active:scale-90 ${
                ...
                {!searchQuery && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 sm:mt-5 flex flex-wrap justify-center gap-2 sm:gap-2.5"
                  >
