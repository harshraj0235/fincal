      ...
      <div className={`min-h-screen transition-colors duration-500 ${
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                <h1 className="text-6xl md:text-8xl font-black mb-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent leading-tight" style={{ backgroundSize: '200% 200%' }}>
                  {language === 'en' ? 'Money Made Easy 💰' : 'पैसा आसान बनाया 💰'}
                </h1>
              </motion.div>
              <p className="text-xl md:text-3xl text-gray-300 mb-8 max-w-4xl mx-auto font-medium">
                {language === 'en' 
                  ? '🚀 100+ Free Calculators • 40 Learn Lessons • 11 Festival Tools • Live Market Data'
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    to="/tools"
                    className="group relative inline-flex items-center gap-3 px-8 py-5 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-2xl font-bold text-lg shadow-2xl overflow-hidden"
                  >
                    ...
                    <span className="relative z-10">{language === 'en' ? 'Explore 100+ Tools' : '100+ टूल्स देखें'}</span>
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    to="/learn"
                    className="inline-flex items-center gap-3 px-8 py-5 bg-slate-800/50 backdrop-blur-xl border-2 border-white/20 text-white rounded-2xl font-bold text-lg shadow-2xl hover:bg-slate-700/50 transition-all"
                  >
        ...
        <section className={`relative py-8 border-y ${
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex overflow-x-auto gap-3 pb-2 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-slate-800">
              {categories.map((cat) => (
                <motion.button
                  key={cat.id}
                  whileHover={{ scale: 1.05, y: -2 }}
            ...
            {filteredTools.length > 20 && (
              <div className="text-center mt-12">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-2xl font-bold shadow-2xl"
                >
                  {language === 'en' ? `View All ${filteredTools.length} Tools` : `सभी ${filteredTools.length} टूल्स देखें`}
                  <ChevronDown className="w-5 h-5 inline ml-2" />
                </motion.button>
              </div>
            )}
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
                {language === 'en' ? '🚀 Ready to Master Your Finances?' : '🚀 अपने वित्त में महारत हासिल करने के लिए तैयार?'}
              </h2>
              <p className="text-xl text-white/90 mb-8">
                {language === 'en' 
                  ? 'Join 1 Million+ Indians making smarter financial decisions every day'
                  : '1 मिलियन+ भारतीयों के साथ हर दिन स्मार्ट वित्तीय निर्णय लें'}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    to="/tools"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-white text-purple-600 rounded-2xl font-bold text-lg shadow-2xl"
                  >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    to="/learn"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-transparent border-2 border-white text-white rounded-2xl font-bold text-lg"
                  >
                    <BookOpen className="w-6 h-6" />
                    {language === 'en' ? 'Explore 40 Lessons' : '40 पाठ देखें'}
                  </Link>
                </motion.div>
              </div>
            </motion.div>
