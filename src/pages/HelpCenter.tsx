...
import { 
  ...
  FileText, DollarSign, BarChart3, Users, Zap, IndianRupee } from 'lucide-react';
...
const HelpCenter: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'calculators', name: 'Calculators', icon: IndianRupee, color: 'from-green-500 to-emerald-600' },
