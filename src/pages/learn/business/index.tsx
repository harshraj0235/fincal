    ...
    <>
      <SEOHelmet 
        ...
        breadcrumbs={[
          ...
          { name: 'Business Finance', url: '/learn/business-finance-entrepreneurship' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Business Finance & Entrepreneurship",
          description: "Business finance education hub with lessons on funding, loans, cash flow, GST, registration, and scaling.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: businessFinanceLessons.length
          }
        }}
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto mb-10">
          <div className="border rounded-xl p-4 bg-white">
            ...
            <p className="text-gray-700 text-sm">Start with funding basics, check MSME/MUDRA loan options, set up GST compliance, and track cash flow.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
            <p className="text-gray-700 text-sm">Incorporation → funding strategy → loan eligibility → GST/ITR compliance → scaling plan.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
            <p className="text-gray-700 text-sm">Choose LLP vs Pvt Ltd. Apply MUDRA loan. Build 13-week cash flow. Register GST with returns calendar.</p>
          </div>
        </div>
        {/* All Lessons Grid */}
