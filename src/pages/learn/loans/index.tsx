    ...
    <>
      <SEOHelmet
        ...
        structuredData={{
          ...
          description: "Loans education hub with 20 lessons and calculators.",
          mainEntity: {
            "@type": "ItemList",
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto mb-10">
          <div className="border rounded-xl p-4 bg-white">
            ...
            <p className="text-gray-700 text-sm">Start from basics, use EMI/eligibility calculators during lessons, and track progress. Compare fixed vs floating carefully.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
            <p className="text-gray-700 text-sm">Eligibility → documents → interest type → tenure → EMI planning → prepayment/refinance decisions.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
            <p className="text-gray-700 text-sm">Compare offers from two banks. Optimize EMI with tenure. Plan tax benefits where applicable.</p>
          </div>
        </div>
