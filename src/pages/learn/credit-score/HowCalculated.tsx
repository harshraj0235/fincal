...
import { IndianRupee, PieChart, TrendingUp, Clock, CreditCard, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/credit-score/how-calculated"
        structuredData={{
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-8">
          <div className="flex items-start">
            <IndianRupee className="h-6 w-6 text-blue-600 mr-3 flex-shrink-0 mt-1" />
            <div>
              ...
              <div className="bg-white border-2 border-red-400 rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-yellow-100 p-3 rounded border border-yellow-400">
                    <p className="font-bold text-yellow-900 mb-1">?? Moderate:</p>
