      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Credit Score Scale: 300-900 (स्कोर स्केल)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            What Each Range Means (हर रेंज का मतलब)
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-100 border-2 border-yellow-400 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg border-2 border-yellow-300">
                  <p className="font-bold text-gray-900 mb-3">⚠️ What You Get:</p>
                  <ul className="space-y-2 text-sm text-gray-700">
                    <li className="flex items-start">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-100 border-2 border-orange-400 rounded-xl p-6">
              ...
              <div className="bg-orange-100 p-3 rounded border border-orange-400 mt-4">
                <p className="font-bold text-gray-900 mb-2">🛠️ Recovery Strategy:</p>
                <ul className="text-sm text-gray-700 space-y-1">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Loan Eligibility by Credit Score (स्कोर के अनुसार लोन)
          </h2>
            ...
            <table className="w-full border-2 border-gray-300 text-sm">
              ...
              <tbody>
                ...
                <tr className="bg-yellow-100">
                  ...
                  <td className="border border-gray-300 p-3 text-center text-yellow-700 font-bold">⚠️ Fair</td>
                  <td className="border border-gray-300 p-3 text-center text-yellow-700 font-bold">⚠️ Fair</td>
                  <td className="border border-gray-300 p-3 text-center text-yellow-700 font-bold">⚠️ Fair</td>
                  <td className="border border-gray-300 p-3 text-center text-yellow-700 font-bold">⚠️ Basic</td>
                </tr>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Interest Rate Impact by Score (ब्याज दर का प्रभाव)
          </h2>
