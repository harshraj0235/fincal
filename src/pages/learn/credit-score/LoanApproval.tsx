...
import { TrendingUp, CheckCircle, XCircle, AlertCircle, IndianRupee, Home, Car } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/credit-score/loan-approval"
        structuredData={{
      ...
      >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-green-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Home Loan</h4>
                </div>
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-blue-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Personal Loan</h4>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="bg-green-50 p-3 rounded">
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-purple-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Car Loan</h4>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="bg-green-50 p-3 rounded">
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-orange-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">Credit Card</h4>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="bg-green-50 p-3 rounded">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Loan Approval Chances by Score
          </h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <IndianRupee className="h-8 w-8 text-blue-600 mb-2" />
