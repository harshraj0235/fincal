...
import { 
  ...
  Globe, Users, ArrowRight, Star, Zap, IndianRupee } from 'lucide-react';
...
const educationLoansLessons = [
  ...
  { id: 9, title: 'Education Loan EMI Calculator', titleHindi: 'EMI कैलकुलेटर', slug: 'emi-calculator', icon: IndianRupee, color: 'from-green-500 to-teal-500', difficulty: 'Beginner', duration: '8 min', badge: 'Tool' },
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/education-loans"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Learn', url: '/learn' },
          { name: 'Education Loans', url: '/learn/education-loans' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Education Loans Complete Guide India 2025",
          description: "Education loans hub covering study in India/abroad, eligibility, rates, tax benefits, moratorium, collateral vs non-collateral.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: educationLoansLessons.length
          }
        }}
      />
