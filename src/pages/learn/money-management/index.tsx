...
import { BookOpen, IndianRupee, ArrowRight, Award, Clock, Target } from 'lucide-react';
    ...
    <>
      <SEOHelmet
        ...
        breadcrumbs={[
          ...
          { name: 'Money Management', url: '/learn/money-management' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Money Management Mastery",
          description: "Budgeting, emergency fund, tracking expenses, net worth and cash flow with calculators and Hindi explanations.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: moneyManagementLessons.length
          }
        }}
      />
        ...
        <section className="py-16 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto mb-10">
            <div className="border rounded-xl p-4 bg-white">
              ...
              <p className="text-gray-700 text-sm">Start with budgeting, set auto-saving, build emergency fund, track expenses weekly, review net worth monthly.</p>
            </div>
            <div className="border rounded-xl p-4 bg-white">
              <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
              <p className="text-gray-700 text-sm">Define goals → 50/30/20 budget → emergency fund 6 months → automate savings → monitor cash flow.</p>
            </div>
            <div className="border rounded-xl p-4 bg-white">
              <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
              <p className="text-gray-700 text-sm">Build ₹2L emergency fund in 12 months. Cut expenses 10%. Use calculators to track progress.</p>
            </div>
          </div>
        </section>
