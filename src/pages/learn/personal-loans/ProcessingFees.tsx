...
import { ArrowLeft, ArrowRight, IndianRupee, DollarSign, AlertTriangle, CheckCircle, Info, TrendingUp } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/personal-loans/processing-fees"
        structuredData={{
