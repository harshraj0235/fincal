...
import { RefreshCw, CreditCard, IndianRupee, TrendingDown, CheckCircle, AlertCircle, DollarSign } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/personal-loans/debt-consolidation"
      />
