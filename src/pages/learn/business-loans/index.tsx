...
import { 
  ...
  Target, Users, Building, Factory, ArrowRight, Star, Zap, Globe
} from 'lucide-react';
...
const businessLoansLessons = [
  ...
  { id: 12, title: 'Business Loan EMI Calculator', titleHindi: 'EMI कैलकुलेटर', slug: 'emi-calculator', icon: Calculator, color: 'from-blue-500 to-indigo-500', difficulty: 'Beginner', duration: '8 min', badge: 'Tool' },
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/learn/business-loans"
        structuredData={{
          '@context': 'https://schema.org',
          '@type': 'Course',
          name: 'Business Loans Complete Guide India 2025',
          description: 'Complete 15-lesson course on business loans covering MSME, startup, working capital, Mudra scheme, government schemes. हिंदी + English',
          provider: {
            '@type': 'Organization',
            name: 'MoneyCal',
          ...
          numberOfCredits: 15,
          courseCode: 'BUSINESS-LOANS-2025',
          inLanguage: ['en', 'hi'],
          hasCourseInstance: {
            '@type': 'CourseInstance',
            courseMode: 'online',
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link to="/learn/loans" className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl hover:shadow-lg transition-all border-2 border-blue-200">
