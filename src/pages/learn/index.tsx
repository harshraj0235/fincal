          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link to="/learn/loans" className="text-gray-400 hover:text-white">Loan Basics</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link to="/blog" className="text-gray-400 hover:text-white">Blog & Guides</Link></li>
                  <li><Link to="/news" className="text-gray-400 hover:text-white">Financial News</Link></li>
