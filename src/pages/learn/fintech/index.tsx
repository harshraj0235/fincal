    ...
    <>
      <SEOHelmet 
        ...
        breadcrumbs={[
          ...
          { name: 'FinTech & Digital Payments', url: '/learn/fintech-digital-payments' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "FinTech & Digital Payments",
          description: "FinTech education hub with lessons on UPI, wallets, online banking, payment security, and apps.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: fintechLessons.length
          }
        }}
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto mb-10">
          <div className="border rounded-xl p-4 bg-white">
            ...
            <p className="text-gray-700 text-sm">Begin with UPI, set wallet KYC limits, enable banking security, and follow payment safety tips.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
            <p className="text-gray-700 text-sm">Choose payment method → set limits → enable 2FA → monitor statements → avoid phishing.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
            <p className="text-gray-700 text-sm">Configure UPI limits. Compare wallets. Secure online banking with app locks and alerts.</p>
          </div>
        </div>
        {/* All Lessons Grid */}
