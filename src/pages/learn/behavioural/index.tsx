    ...
    <>
      <SEOHelmet 
        ...
        breadcrumbs={[
          ...
          { name: 'Behavioural Finance', url: '/learn/behavioural-finance-money-psychology' }
        ]}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Behavioural Finance & Money Psychology",
          description: "Behavioural finance education hub with lessons on mindset, biases, emotions, habits, and FIRE.",
          mainEntity: {
            "@type": "ItemList",
            numberOfItems: behaviouralFinanceLessons.length
          }
        }}
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto mb-10">
          <div className="border rounded-xl p-4 bg-white">
            ...
            <p className="text-gray-700 text-sm">Start with money mindset, identify biases, apply emotional control, and build daily wealth habits.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
            <p className="text-gray-700 text-sm">Beliefs audit → bias awareness → emotion rules → habit systems → FIRE plan.</p>
          </div>
          <div className="border rounded-xl p-4 bg-white">
            <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
            <p className="text-gray-700 text-sm">Stop FOMO trades. Automate SIPs. Use 10-10-10 rule. Track net worth monthly.</p>
          </div>
        </div>
        {/* All Lessons Grid */}
