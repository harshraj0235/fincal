      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Should You Close Your Credit Card? (क्या बंद करना चाहिए?)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Impact on Credit Score (CIBIL पर प्रभाव)
          </h2>

          <div className="bg-gradient-to-br from-red-50 to-orange-100 border-2 border-red-400 rounded-xl p-6">
            <h3 className="text-xl font-bold text-red-900 mb-4">⚠️ Closing Can Drop Score by 20-100 Points!</h3>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="bg-red-50 p-3 rounded">
                    ...
                    <div className="bg-white p-2 rounded text-xs">
                      ...
                      <p className="text-gray-700">After closing ₹1L card: ₹30K of ₹2L = 15% ⚠️ (worse!)</p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-blue-100 to-cyan-100 p-4 rounded-lg border-2 border-blue-400">
                ...
                <div className="space-y-1 text-sm text-gray-700">
                  ...
                  <p className="text-red-700 font-bold mt-2">⚠️ NEVER close your oldest credit card!</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Proper Credit Card Closure Process (सही प्रक्रिया)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Alternatives to Closing (विकल्प)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Common Closure Mistakes (गलतियां)
          </h2>
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-8 text-white">
          <h2 className="text-2xl font-bold mb-4">Think Carefully Before Closing! ⚠️</h2>
