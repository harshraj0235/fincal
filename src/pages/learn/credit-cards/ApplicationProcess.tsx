      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Pre-Application Checklist (आवेदन से पहले)
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-100 border-2 border-purple-400 rounded-xl p-6">
              ...
              <div className="mt-4 p-3 bg-yellow-100 rounded border border-yellow-400">
                <p className="font-bold text-yellow-900 text-sm mb-1">⚠️ Considerations:</p>
                <ul className="text-xs text-gray-700 space-y-1">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Detailed Online Application Process (विस्तृत प्रक्रिया)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Tips to Increase Approval Chances (अनुमोदन की संभावना बढ़ाने के टिप्स)
          </h2>
