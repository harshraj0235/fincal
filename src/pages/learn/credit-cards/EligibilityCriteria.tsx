  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/credit-cards/eligibility-criteria"
        structuredData={{
            ...
            <div className="space-y-4">
              <div className="bg-white p-5 rounded-lg border-2 border-green-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">1. Age Requirement (???)</h4>
                </div>
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-blue-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">2. Income Requirement (??)</h4>
                </div>
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-purple-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">3. Credit Score (??????? ?????)</h4>
                </div>
                <div className="grid md:grid-cols-3 gap-3">
                  ...
                  <div className="bg-yellow-50 p-3 rounded border-2 border-yellow-400">
                    ...
                    <p className="text-xs text-yellow-700">?? Entry-level cards</p>
                  </div>
                </div>
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-orange-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">4. Employment Status (?????? ??????)</h4>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-3 rounded">
              ...
              <div className="bg-white p-5 rounded-lg border-2 border-red-300">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">5. Residency Status (?????)</h4>
                </div>
