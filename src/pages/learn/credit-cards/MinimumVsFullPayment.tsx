...
import { AlertTriangle, DollarSign, CheckCircle, XCircle, TrendingUp, Calculator } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/learn/credit-cards/minimum-vs-full-payment"
        structuredData={{
      ...
      >
        ...
        <div className="bg-gradient-to-r from-red-500 to-orange-600 border-l-4 border-red-700 p-6 rounded-r-lg mb-8 text-white">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-bold text-xl mb-2">⚠️ CRITICAL LESSON - This Can Save You ₹10+ Lakhs!</h3>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            The ₹10 Lakh Trap: Minimum Payment Danger (न्यूनतम भुगतान का खतरा)
          </h2>
        ...
        <section className="mb-12">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 rounded-xl p-6">
            <div className="flex items-center mb-3">
              <Calculator className="h-7 w-7 text-yellow-600 mr-3" />
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Why Banks LOVE When You Pay Minimum (बैंक क्यों खुश होते हैं)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            When is Minimum Payment Acceptable? (कब ठीक है?)
          </h2>
          ...
          <div className="space-y-4">
            <div className="bg-green-50 border-2 border-green-400 rounded-xl p-6">
              ...
              <div className="mt-4 p-4 bg-yellow-100 rounded-lg border-2 border-yellow-400">
                <p className="font-bold text-gray-900 mb-2">⚠️ Important Rules:</p>
