      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Essential Documents Overview (आवश्यक दस्तावेज)
          </h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Complete Document Checklist (पूर्ण सूची)
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border-2 border-blue-400 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Identity Documents (पहचान पत्र)</h3>
              </div>
            ...
            <div className="bg-white border-2 border-green-400 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Income Proof Documents (आय प्रमाण)</h3>
              </div>
            ...
            <div className="bg-white border-2 border-orange-400 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Address Proof Documents (पता प्रमाण)</h3>
              </div>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Additional Documents (अतिरिक्त दस्तावेज)
          </h2>
            ...
            <div className="space-y-4">
              <div className="bg-purple-50 p-4 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="bg-white p-3 rounded">
                    <p className="font-semibold text-gray-900 mb-1">✍️ Signature</p>
