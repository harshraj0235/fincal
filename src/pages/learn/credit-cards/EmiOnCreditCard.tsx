...
import { IndianRupee, CheckCircle, AlertCircle, TrendingDown, DollarSign, CreditCard } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/credit-cards/emi-on-credit-card"
        structuredData={{
      ...
      >
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-500 p-6 rounded-r-lg mb-8">
          <div className="flex items-start">
            <IndianRupee className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
            <div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-green-400 to-emerald-500 p-5 rounded-lg text-white">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3 className="text-xl font-bold">1. No Cost EMI (???? ????????)</h3>
