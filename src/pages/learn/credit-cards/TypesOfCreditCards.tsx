  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="https://moneycal.in/learn/credit-cards/types-of-credit-cards"
        structuredData={{
      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Credit Card Types in India (क्रेडिट कार्ड के प्रकार)
          </h2>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-300 rounded-xl p-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-4 rounded-lg">
                <p className="font-semibold text-gray-900">3. Travel Cards ✈️</p>
              ...
              <div className="bg-white p-4 rounded-lg">
                <p className="font-semibold text-gray-900">5. Shopping Cards 🛍️</p>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-xl p-6 text-white mb-6">
            <div className="flex items-center mb-2">
              ...
              <h2 className="text-3xl font-bold">3. Travel Credit Cards ✈️</h2>
            </div>
          ...
          <div className="bg-white border-2 border-blue-300 rounded-xl p-6">
            ...
            <div className="mt-6 p-4 bg-blue-50 border-2 border-blue-300 rounded-lg">
              <p className="font-bold text-gray-900 mb-2">✈️ Travel Cards Perfect For:</p>
              <ul className="space-y-1 text-gray-700 text-sm">
