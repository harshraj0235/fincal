...
const CreditCardsHub: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Credit Cards - Complete Guide to Credit Cards in India 2024 | MoneyCal Learn</title>
        <meta name="description" content="Master credit cards with 20 comprehensive lessons. Learn types, rewards, interest rates, CIBIL impact, fraud protection, and smart usage strategies." />
        <meta name="keywords" content="credit card, credit card India, best credit cards, credit card rewards, credit card eligibility, CIBIL score credit card" />
        <link rel="canonical" href="https://moneycal.in/learn/credit-cards" />
      </Helmet>
