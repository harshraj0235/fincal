...
import { IndianRupee, TrendingUp, Home, AlertCircle, CheckCircle, DollarSign, Calculator } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl="/learn/home-loans/home-loan-eligibility"
        structuredData={{
      ...
      >
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 p-6 rounded-r-lg mb-8">
          <div className="flex items-start">
            <IndianRupee className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-1" />
            <div>
        ...
        <section className="mb-12">
          <div className="bg-white border-2 border-dashed border-blue-300 rounded-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Want More Detailed Analysis?</h2>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Our standalone Home Loan Eligibility Calculator offers more advanced features, including tax-saving insights and detailed bank-wise eligibility comparisons.
            </p>
            <Link
              to="/calculators/loan-eligibility-calculator"
            ...
            >
              Try Full Eligibility Calculator 🚀
            </Link>
          </div>
        </section>
