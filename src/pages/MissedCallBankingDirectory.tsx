...
import { Search, PhoneCall, Home, ExternalLink, Calculator, CreditCard, Shield, MapPin, Building2, Smartphone, Menu } from 'lucide-react';
...
const internalTools = [
  { name: 'Bank Charges Analyzer', path: '/calculators/bank-charges-analyzer', icon: Calculator, color: 'blue' },
