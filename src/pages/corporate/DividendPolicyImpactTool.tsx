...
import { ArrowLeft, TrendingUp, DollarSign, Download, Link, PieChart, BarChart3, Target, Calculator, Percent } from 'lucide-react';
...
export const DividendPolicyImpactTool: React.FC = () => {
  ...
  const calculateDividendImpact = () => {
    ...
    scenarios.conservative.dividendPerShare > currentDividendPerShare && impactAnalysis.push({
    ...
    scenarios.moderate.dividendPerShare > currentDividendPerShare && impactAnalysis.push({
      scenario: 'Moderate',
      impact: 'Balanced',
    ...
    scenarios.aggressive.dividendPerShare > currentDividendPerShare && impactAnalysis.push({
      scenario: 'Aggressive',
      impact: 'High Yield',
