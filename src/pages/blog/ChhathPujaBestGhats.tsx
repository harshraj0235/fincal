  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl={`/blog/chhath-puja-best-ghats-${currentYear}`}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="bg-gray-50 rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link to="/blog/chhath-puja-travel-guide" reloadDocument className="group">
