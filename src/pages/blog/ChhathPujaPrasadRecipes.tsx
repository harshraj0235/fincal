  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl={`https://moneycal.in/blog/chhath-puja-prasad-recipes-${currentYear}`}
      />
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Link to="/blog/chhath-puja-preparation-guide" className="flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-lg transition-all group">
