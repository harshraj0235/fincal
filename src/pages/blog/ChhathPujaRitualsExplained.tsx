  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl={`/blog/chhath-puja-rituals-explained-${currentYear}`}
      />
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Link to="/blog/chhath-puja-prasad-recipes" reloadDocument className="flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-lg transition-all group">
