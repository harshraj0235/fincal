...
import { BookOpen, Sun, Moon, Home, ChevronRight, ExternalLink, Star, CheckCircle, AlertCircle, Share2, Sparkles, Info, Users, Heart, Clock, IndianRupee, Download, Award, TrendingUp, MessageCircle, ThumbsUp, Eye, Timer, Zap, Target, Shield, Scroll, Crown, Flame, Mountain, Flower, TreePine, Bird, Fish, Droplets } from 'lucide-react';
  ...
  return (
    <>
      <SEOHelmet
        ...
        canonicalUrl={`/blog/chhath-puja-mythology-${currentYear}`}
      />
