...
const AMCFeeAnalyzerTool: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="AMCFeeAnalyzerTool - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our AMCFeeAnalyzerTool"
...
export default AMCFeeAnalyzerTool;