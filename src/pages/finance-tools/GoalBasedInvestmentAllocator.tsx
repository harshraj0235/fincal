...
const GoalBasedInvestmentAllocator: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="GoalBasedInvestmentAllocator - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our GoalBasedInvestmentAllocator"
...
export default GoalBasedInvestmentAllocator;
