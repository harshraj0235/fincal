...
const ExpenseRatioImpactVisualTool: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="ExpenseRatioImpactVisualTool - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our ExpenseRatioImpactVisualTool"
...
export default ExpenseRatioImpactVisualTool;
