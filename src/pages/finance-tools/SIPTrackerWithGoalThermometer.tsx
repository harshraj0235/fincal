...
const SIPTrackerWithGoalThermometer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="SIPTrackerWithGoalThermometer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our SIPTrackerWithGoalThermometer"
