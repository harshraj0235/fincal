...
const InvestmentTimelineVisualizer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="InvestmentTimelineVisualizer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our InvestmentTimelineVisualizer"
