...
const EquityVsDebtSplitRecommender: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="EquityVsDebtSplitRecommender - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our EquityVsDebtSplitRecommender"
