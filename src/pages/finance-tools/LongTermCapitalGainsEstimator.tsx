...
const LongTermCapitalGainsEstimator: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="LongTermCapitalGainsEstimator - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our LongTermCapitalGainsEstimator"
...
export default LongTermCapitalGainsEstimator;