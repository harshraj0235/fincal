...
const IndexFundReturnComparison: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="IndexFundReturnComparison - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our IndexFundReturnComparison"
