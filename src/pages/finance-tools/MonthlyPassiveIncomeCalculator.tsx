...
const MonthlyPassiveIncomeCalculator: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="MonthlyPassiveIncomeCalculator - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our MonthlyPassiveIncomeCalculator"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                MonthlyPassiveIncomeCalculator
              </h1>
...
export default MonthlyPassiveIncomeCalculator;
