...
const FiveYCAGRVsVolatilityAnalyzer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="FiveYCAGRVsVolatilityAnalyzer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our FiveYCAGRVsVolatilityAnalyzer"
...
export default FiveYCAGRVsVolatilityAnalyzer;
