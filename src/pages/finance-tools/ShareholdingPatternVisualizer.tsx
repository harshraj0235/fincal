...
const ShareholdingPatternVisualizer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="ShareholdingPatternVisualizer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our ShareholdingPatternVisualizer"
...
export default ShareholdingPatternVisualizer;
