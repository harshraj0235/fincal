...
const InvestmentGoalCountdownWidget: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="InvestmentGoalCountdownWidget - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our InvestmentGoalCountdownWidget"
...
export default InvestmentGoalCountdownWidget;
