...
const RealEstateVsStockROITool: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="RealEstateVsStockROITool - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our RealEstateVsStockROITool"
