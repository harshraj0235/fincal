...
const FlexiSIPPlanner: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="FlexiSIPPlanner - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our FlexiSIPPlanner"
...
export default FlexiSIPPlanner;
