...
const RealVsNominalReturnCalculator: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="RealVsNominalReturnCalculator - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our RealVsNominalReturnCalculator"
