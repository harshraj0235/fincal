...
const TopSectorAllocationAnalyzer: React.FC = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="TopSectorAllocationAnalyzer - Financial Calculator | MoneyCal"
        description="Calculate and analyze your financial data with our TopSectorAllocationAnalyzer"
...
export default TopSectorAllocationAnalyzer;