...
import { 
  Calculator, Calendar, FileSpreadsheet, Search, AlertTriangle, ShieldCheck, Repeat, 
  QrCode, GitCompare, Layers, FileText, Route, Scale, BarChart3, TrendingUp,
  Filter, Grid, List, ArrowRight, Star, Clock, Users, CheckCircle, Zap
} from 'lucide-react';
...
const gstTools = [
  ...
  { name: 'GST Amount Calculator', slug: 'gst-amount-calculator', icon: Calculator, desc: 'Calculate GST based on price and rate', category: 'GST Calculation', featured: true },
  { name: 'Reverse GST Calculator', slug: 'reverse-gst-calculator', icon: Calculator, desc: 'Determine pre-tax price from GST-inclusive amount', category: 'GST Calculation', featured: true },
  { name: 'GST Slab Calculator', slug: 'gst-slab-calculator', icon: Calculator, desc: 'Identify applicable GST slab for products/services', category: 'GST Calculation', featured: true },
  { name: 'GST Inclusive Price Calculator', slug: 'gst-inclusive-price-calculator', icon: Calculator, desc: 'Calculate total price including GST', category: 'GST Calculation', featured: false },
  { name: 'GST Exclusive Price Calculator', slug: 'gst-exclusive-price-calculator', icon: Calculator, desc: 'Determine price before GST is added', category: 'GST Calculation', featured: false },
  { name: 'GST on Discounted Price Calculator', slug: 'gst-discounted-price-calculator', icon: Calculator, desc: 'Calculate GST on discounted items', category: 'GST Calculation', featured: false },
  { name: 'GST on Advance Payment Calculator', slug: 'gst-advance-payment-calculator', icon: Calculator, desc: 'Compute GST on advance received', category: 'GST Calculation', featured: false },
  { name: 'GST on Refundable Deposit Calculator', slug: 'gst-refundable-deposit-calculator', icon: Calculator, desc: 'Calculate GST on refundable deposits', category: 'GST Calculation', featured: false },
  { name: 'GST on Reimbursement Calculator', slug: 'gst-reimbursement-calculator', icon: Calculator, desc: 'Determine GST on reimbursements', category: 'GST Calculation', featured: false },
  { name: 'GST on Export Sales Calculator', slug: 'gst-export-sales-calculator', icon: Calculator, desc: 'Calculate GST on export transactions', category: 'GST Calculation', featured: false },
  ...
  { name: 'ITC on Capital Goods Calculator', slug: 'itc-capital-goods-calculator', icon: Calculator, desc: 'Calculate ITC on capital goods', category: 'Input Tax Credit', featured: false },
  { name: 'ITC on Input Services Calculator', slug: 'itc-input-services-calculator', icon: Calculator, desc: 'Compute ITC on input services', category: 'Input Tax Credit', featured: false },
  { name: 'ITC on Goods Calculator', slug: 'itc-goods-calculator', icon: Calculator, desc: 'Determine ITC on goods purchased', category: 'Input Tax Credit', featured: false },
  ...
  { name: 'ITC on Mixed Supplies Calculator', slug: 'itc-mixed-supplies-calculator', icon: Calculator, desc: 'Calculate ITC on mixed supplies', category: 'Input Tax Credit', featured: false },
  { name: 'ITC on Zero-Rated Supplies Calculator', slug: 'itc-zero-rated-supplies-calculator', icon: Calculator, desc: 'Determine ITC on zero-rated supplies', category: 'Input Tax Credit', featured: false },
  ...
  { name: 'GST Late Fee Reduction Calculator', slug: 'gst-late-fee-reduction-calculator', icon: Calculator, desc: 'Calculate reduced late fees under certain conditions', category: 'Penalty & Interest', featured: false },
  ...
  { name: 'GST Penalty Reduction Calculator', slug: 'gst-penalty-reduction-calculator', icon: Calculator, desc: 'Compute reduced penalties under specific circumstances', category: 'Penalty & Interest', featured: false },
  ...
  { name: 'GST Refund Amount Estimator', slug: 'gst-refund-amount-estimator', icon: Calculator, desc: 'Estimate the amount eligible for GST refund', category: 'GST Refund', featured: false },
  ...
  { name: 'GST Refund Interest Calculator', slug: 'gst-refund-interest-calculator', icon: Calculator, desc: 'Compute interest on delayed GST refunds', category: 'GST Refund', featured: false },
  { name: 'GST Refund Adjustment Calculator', slug: 'gst-refund-adjustment-calculator', icon: Calculator, desc: 'Determine adjustments in GST refunds', category: 'GST Refund', featured: false },
  ...
  { name: 'RCM Tax Calculation Tool', slug: 'rcm-tax-calculation-tool', icon: Calculator, desc: 'Calculate tax under RCM', category: 'Reverse Charge', featured: true },
  ...
  { name: 'RCM Adjustment Calculator', slug: 'rcm-adjustment-calculator', icon: Calculator, desc: 'Adjustments related to RCM transactions', category: 'Reverse Charge', featured: false },
  ...
  { name: 'Composition Scheme Tax Calculator', slug: 'composition-scheme-tax-calculator', icon: Calculator, desc: 'Calculate tax under the composition scheme', category: 'Composition Scheme', featured: true },
  ...
  { name: 'Composition Scheme Benefits Calculator', slug: 'composition-scheme-benefits-calculator', icon: Calculator, desc: 'Calculate benefits of opting for the scheme', category: 'Composition Scheme', featured: false },
...
const GSTTools: React.FC = () => {
  ...
  const filteredTools = gstTools.filter(tool => {
  ...
  const featuredTools = gstTools.filter(tool => tool.featured);
  const categoryCounts = categories.reduce((acc, category) => {
    if (category === 'All Categories') {
      acc[category] = gstTools.length;
    } else {
      acc[category] = gstTools.filter(tool => tool.category === category).length;
    }
    return acc;
  ...
  return (
    <>
      <SEOHelmet
        title="GST Tools Hub - 100+ Free GST Calculators and Filing Helpers | MoneyCal.in"
        description="Explore 100+ free GST tools: calculator, due date tracker, GSTR-3B, HSN finder, penalty, RCM, e-invoice validator, ITC reconciliation, invoice generator and more. Complete GST compliance toolkit."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              <Calculator className="h-16 w-16 text-green-600 mr-4" />
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800">GST Tools Hub</h1>
            </div>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Complete GST compliance toolkit with 100+ free calculators, trackers, and filing helpers. 
              From basic GST calculations to advanced compliance monitoring - everything you need for seamless GST management.
            </p>
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-gray-600">
              Showing {filteredTools.length} of {gstTools.length} tools
            </p>
          ...
          <div className="mt-16 bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {categories.slice(1).map(category => {
                ...
                const categoryTools = gstTools.filter(tool => tool.category === category);
