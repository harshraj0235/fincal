...
const ExcelToolsPage: React.FC = () => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": "100 Free Excel Tools & Templates - MoneyCal India",
    "description": "Download 100+ free Excel tools and templates for personal finance, business, investment, tax, and more.",
    "url": "/excel-tools",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (
    <>
      <SEOHelmet
        title="100 Free Excel Tools & Templates - Download Financial Calculators | MoneyCal"
        description="Download 100+ free Excel tools and templates for personal finance, business accounting, investment tracking, tax calculation, and more."
        keywords="free excel tools, excel templates download, financial Calculator excel, business excel templates, investment tracker excel, tax Calculator excel, loan Calculator excel, budget template excel, moneycal"
        url="/excel-tools"
        structuredData={structuredData}
        tags={["excel tools", "financial templates", "business calculators", "investment trackers", "tax calculators"]}
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Excel Tools', url: '/excel-tools' }
        ]}
      />
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="relative">
          ...
          <section className="py-10 bg-white border-y border-blue-100">
            <div className="max-w-7xl mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="border rounded-xl p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">How to use</h3>
                  <p className="text-gray-700 text-sm">Choose a category, open a tool, download Excel, and customize for your case.</p>
                </div>
                <div className="border rounded-xl p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Decision pathways</h3>
                  <p className="text-gray-700 text-sm">Personal finance → budget and goals. Business → invoices and accounting. Tax → calculators and sheets.</p>
                </div>
                <div className="border rounded-xl p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Examples</h3>
                  <p className="text-gray-700 text-sm">Freelancer invoice → send PDF. Investment tracker → update monthly. Tax sheet → compute liability.</p>
                </div>
              </div>
            </div>
          </section>
