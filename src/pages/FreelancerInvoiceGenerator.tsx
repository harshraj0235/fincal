...
const FreelancerInvoiceGenerator: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    XLSX.writeFile(wb, 'freelancer-invoice.xlsx');
  };

  return (
    <div className="max-w-2xl mx-auto p-4 bg-white rounded-xl shadow-lg mt-6 mb-8">
      <h1 className="text-2xl font-bold mb-4 text-blue-700">Freelancer Invoice Generator (with GST/Tax)</h1>
...
export default FreelancerInvoiceGenerator; 