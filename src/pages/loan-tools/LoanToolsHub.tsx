...
import { 
  ...
  ArrowRight,
  Star,
  Zap, IndianRupee } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Decision pathways</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Buying a home</h3>
                <p className="text-gray-700 text-sm">Estimate EMI → Check affordability → Plan prepayments → Compare refinance offers.</p>
              </div>
              <div className="border rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Consolidating debt</h3>
                <p className="text-gray-700 text-sm">Assess current EMIs → Run consolidation comparison → Choose payoff strategy.</p>
              </div>
              <div className="border rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-2">Lowering interest cost</h3>
                <p className="text-gray-700 text-sm">Simulate extra payments → Evaluate refinance break‑even → Execute with discipline.</p>
              </div>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Common mistakes</h3>
            <ul className="list-disc ml-5 text-gray-700 space-y-1">
              <li>Comparing flat rate with reducing balance without normalization</li>
              <li>Ignoring fees and processing charges in refinance calculations</li>
              <li>Overestimating affordability by excluding variable expenses</li>
            </ul>
          </div>
        </div>
      </div>
