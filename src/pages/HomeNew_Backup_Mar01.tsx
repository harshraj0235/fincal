...
export const HomeNew: React.FC = () => {
  ...
  // Add loading effect and data fetching
  useEffect(() => {
    let isMounted = true;
    const loadData = async () => {
      try {
        const mod = await import('../data/allBlogData');
        if (isMounted) setAllBlogPosts(mod.allBlogPosts || []);
      } catch (e) {
    ...
    const timer = setTimeout(() => {
      setIsLoading(false);
      if (import.meta.env.DEV) console.log('HomeNew component loaded successfully');
    }, 100);
    return () => {
      clearTimeout(timer);
      isMounted = false;
    ...
    <>
          ...
          >
            ...
            >
              ...
              <nav className="space-y-4">
                ...
                <Link to="/blog" reloadDocument className="block w-full text-left p-3 rounded-lg hover:bg-gray-100 text-gray-900">View All Blog Posts</Link>
                ...
                <Link to="/video-content" className="block w-full text-left p-3 rounded-lg hover:bg-gray-100 text-gray-900">🎥 Video Content</Link>
                ...
                <Link to="/government-schemes" reloadDocument className="block w-full text-left p-3 rounded-lg hover:bg-gray-100 text-gray-900">Government Schemes</Link>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-40 bg-white/95 backdrop-blur-md rounded-full shadow-lg border border-gray-200 px-6 py-3 hidden lg:flex items-center space-x-2 max-w-4xl overflow-x-auto transition-all duration-300 ${activeSection !== 'hero' ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
          ...
          <Link to="/video-content" className="px-3 py-2 rounded-full text-sm font-medium text-purple-700 hover:text-purple-800 transition-all whitespace-nowrap">🎥 Videos</Link>
          ...
          <Link to="/government-schemes" reloadDocument className="px-3 py-2 rounded-full text-sm font-medium text-gray-700 hover:text-gray-900 transition-all whitespace-nowrap">🏛️ Schemes</Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="text-center lg:text-left">
                ...
                >
                  <div className="text-center lg:text-left">
                    <div className="text-2xl font-bold text-gray-900 line-clamp-1">500+</div>
                    <div className="text-gray-600 text-sm">Financial Tools</div>
                  </div>
                  <div className="text-center lg:text-left">
                    <div className="text-2xl font-bold text-gray-900 line-clamp-1">100%</div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                    ...
                    <Link
                      to="/government-schemes" reloadDocument
                  ...
                  {showSearchResults && searchResults.length > 0 && (
                    ...
                    >
                      {searchResults.map((result) => (
                        ...
                        >
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${result.type === 'calculator' ? 'bg-blue-100' : 'bg-green-100'
                            }`}>
        ...
        <section id="blog" className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              className="text-center mt-12"
            >
              <Link to="/blog" reloadDocument className="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-2xl font-semibold hover:bg-blue-700 shadow-lg hover:shadow-xl transition-all">
                View All Blog Posts
                <ArrowRight className="h-5 w-5 ml-2" />
              </Link>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  <Link to="/news" reloadDocument className="block">
                    <div className="relative overflow-hidden">
                      <img
                        src={news.image}
                        alt={news.title}
            ...
            <motion.div
              ...
              className="text-center mt-12"
            >
              <Link to="/news" reloadDocument className="inline-flex items-center px-8 py-4 bg-green-600 text-white rounded-2xl font-semibold hover:bg-green-700 shadow-lg hover:shadow-xl transition-all">
