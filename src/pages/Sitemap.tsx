      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/loan-tools/amortization-schedule-viewer" className="text-neutral-700 hover:text-[--primary-600] transition-colors">
                Amortization Schedule Viewer
              </Link>
            </li>
            <li>
              <Link to="/loan-tools/debt-consolidation-calculator" className="text-neutral-700 hover:text-[--primary-600] transition-colors">
