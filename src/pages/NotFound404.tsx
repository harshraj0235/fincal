...
import { Home, Search, ArrowLeft, FileQuestion, IndianRupee, BookOpen } from 'lucide-react';
...
const NotFound404: React.FC = () => {
  ...
  const popularLinks = [
    { title: 'Financial Calculators', path: '/calculators', icon: IndianRupee, description: 'Access 100+ free financial calculators' },
    { title: 'Finance Blog', path: '/blog', icon: BookOpen, description: 'Read expert financial advice and guides' },
    { title: 'GST Tools', path: '/gst-tools', icon: IndianRupee, description: 'GST calculators and compliance tools' },
    { title: 'Investment Tools', path: '/investing-tools', icon: IndianRupee, description: 'Plan your investments smartly' }
  ];
