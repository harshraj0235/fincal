      ...
      <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
        <div className="max-w-6xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-neutral-600 mb-4 overflow-x-auto" aria-label="Breadcrumb">
            <Link href="/" className="flex items-center gap-1 hover:text-blue-600 transition-colors whitespace-nowrap"><Home className="h-4 w-4" /><span>Home</span></Link>
            <ChevronRight className="h-4 w-4 flex-shrink-0 text-neutral-400" />
            <Link href="/calculators" className="hover:text-blue-600 transition-colors whitespace-nowrap">Calculators</Link>
            <ChevronRight className="h-4 w-4 flex-shrink-0 text-neutral-400" />
