...
import { Calculator, RefreshCw, Info, BookOpen, Target, Zap, Lightbulb, Award } from 'lucide-react';
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setCalculationMethod(e.target.value as 'prime' | 'euclidean' | 'division')}
