    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          ...
          combine gold allocation with diversified assets using the <Link href="/calculators/asset-allocation-calculator" className="underline">Asset Allocation Calculator</Link>{' '}
          and <Link href="/calculators/compound-interest-calculator" className="underline">Compound Interest Calculator</Link>.
        </p>
        <p className="text-neutral-700">
