...
import { IndianRupee, PieChart, TrendingUp, AlertTriangle, Info, HelpCircle } from 'lucide-react';
...
export const AssetAllocationPlanner: React.FC = () => {
  ...
  }, [customAllocation, age, timeHorizon, investmentAmount]);
  ...
  return (
    <>
    <SEOHelmet
      title="Asset Allocation Planner India 2026 - Risk Based Portfolio Split | MoneyCal"
      description="Create a risk-based asset allocation plan across equity, debt, gold, and alternatives aligned with your goals and time horizon."
      keywords="asset allocation planner india, portfolio split calculator, equity debt gold allocation, risk based portfolio allocation"
      url="/calculators/asset-allocation-planner"
    />
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        <h2 className="text-2xl font-bold text-neutral-900">Building resilient portfolios with allocation discipline</h2>
        <p className="text-neutral-700">Asset allocation influences long-term outcomes more than one-time product selection. Use allocation to control volatility and sequence risk.</p>
        <p className="text-neutral-700">Pair this with <Link href="/calculators/risk-appetite-assessment" className="underline">Risk Appetite Assessment</Link> and <Link href="/calculators/mutual-fund-overlap-checker" className="underline">Mutual Fund Overlap Checker</Link> for better portfolio structure.</p>
        <p className="text-neutral-700">For investor education standards and framework guidance, review <a href="https://investor.sebi.gov.in/" target="_blank" rel="noopener noreferrer" className="underline">SEBI Investor Education</a>.</p>
      </div>
    </section>
    </>
  );
