  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">Pair this with <Link to="/calculators/risk-appetite-assessment" className="underline">Risk Appetite Assessment</Link> and <Link to="/calculators/mutual-fund-overlap-checker" className="underline">Mutual Fund Overlap Checker</Link> for better portfolio structure.</p>
