  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">Next, convert your profile into implementation using <Link href="/calculators/asset-allocation-planner" className="underline">Asset Allocation Planner</Link> and review concentration via <Link href="/calculators/mutual-fund-overlap-checker" className="underline">Mutual Fund Overlap Checker</Link>.</p>
