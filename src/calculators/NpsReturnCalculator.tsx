      ...
      <article className="max-w-2xl mx-auto p-4">
        ...
        <section className="mb-8" aria-label="NPS Planning Guide">
          <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
            ...
            <p className="text-neutral-700">
              ...
              <Link href="/calculators/pension-calculator" className="underline">Pension Calculator</Link>,{' '}
              <Link href="/calculators/epf-calculator" className="underline">EPF Calculator</Link>, and{' '}
              <Link href="/calculators/retirement-calculator" className="underline">Retirement Calculator</Link>. For official references, review{' '}
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/calculators/retirement-calculator" className="block p-4 bg-white rounded border hover:shadow">
              <strong>Retirement Calculator</strong>
              <p className="text-sm text-neutral-600">Estimate your retirement corpus in India.</p>
            </Link>
            <Link href="/calculators/pension-calculator" className="block p-4 bg-white rounded border hover:shadow">
              <strong>Pension Calculator</strong>
              <p className="text-sm text-neutral-600">Calculate expected pension after retirement.</p>
            </Link>
            <Link href="/calculators/ppf-calculator" className="block p-4 bg-white rounded border hover:shadow">
