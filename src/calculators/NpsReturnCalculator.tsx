...
const FAQS = [
  {
    ...
    answer: 'NPS maturity is calculated using the future value of a recurring investment formula, considering monthly contributions, expected annual return, and investment duration.',
  },
  {
    question: 'What is the minimum contribution for NPS?',
    answer: 'For Tier I, the minimum annual contribution is ₹1,000. For Tier II, there is no minimum annual contribution.',
  },
  {
    question: 'Are NPS returns guaranteed?',
    answer: 'No, NPS returns are market-linked and depend on the performance of the chosen pension funds. Past performance does not guarantee future returns.',
  },
  {
    question: 'What are the tax benefits of NPS?',
    answer: 'Tier I NPS contributions are eligible for tax deductions under Section 80CCD(1), 80CCD(1B), and 80CCD(2) of the Income Tax Act.',
  }
];
...
const SCHEMA_ORG = {
  ...
  "description": "Free online NPS Return Calculator for India. Calculate your NPS maturity, total investment, and expected returns for Tier I and II accounts. Mobile-friendly and accurate.",
          ...
          <div className="bg-[--primary-50] border border-[--primary-200] rounded-lg p-6 flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="text-[--primary-800] space-y-2">
                ...
                <p className="mb-2">For more details, read our guide on <a href="/blog/nps-benefits-india" className="text-blue-600 underline">NPS benefits and rules in India</a>.</p>
              </div>
            </div>
          </div>
        </section>
