  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          Pair this with <Link to="/calculators/income-tax-regime-comparison-calculator" className="underline">Income Tax Regime Comparison Calculator</Link> and{' '}
          <Link to="/calculators/gold-etf-vs-physical-calculator" className="underline">Gold ETF vs Physical Gold Calculator</Link> for complete planning across salary
