...
export const CapitalGainsTaxAdvancedCalculator: React.FC = () => {
  ...
  return (
    <>
    <SEOHelmet
      title="Capital Gains Tax Advanced Calculator India 2026 - LTCG/STCG with Indexation | MoneyCal"
      description="Calculate capital gains tax in India for equity, debt, property, gold, and crypto with holding period rules, indexation, and effective tax rate."
      keywords="capital gains tax calculator india, ltcg stcg calculator with indexation, property capital gains tax calculator, gold capital gains tax calculator"
      url="/calculators/capital-gains-tax-advanced-calculator"
    />
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        <h2 className="text-2xl font-bold text-neutral-900">Capital gains tax planning: what changes your final post-tax return</h2>
        <p className="text-neutral-700">
          Pre-tax returns can be misleading when asset classes follow different holding period and tax treatment rules. This calculator covers major Indian asset
          categories and helps users evaluate <strong>capital gains tax calculator India with indexation</strong> scenarios before they sell.
        </p>
        <p className="text-neutral-700">
          The most common mistake is deciding based on gross gain instead of after-tax gain. For debt-like assets and eligible long-term cases, indexation can change
          tax outgo significantly. For equity-like assets, threshold-based rules and holding period classification matter. Use the date inputs to test multiple sell
          dates and identify tax-efficient exit windows.
        </p>
        <p className="text-neutral-700">
          Pair this with <Link href="/calculators/income-tax-regime-comparison-calculator" className="underline">Income Tax Regime Comparison Calculator</Link> and{' '}
          <Link href="/calculators/gold-etf-vs-physical-calculator" className="underline">Gold ETF vs Physical Gold Calculator</Link> for complete planning across salary
          and investment decisions.
        </p>
        <p className="text-neutral-700">
          For legal interpretation and return filing requirements, always refer to{' '}
          <a href="https://www.incometax.gov.in/" target="_blank" rel="noopener noreferrer" className="underline">Income Tax Department</a>. This tool is educational and
          should be used with current law, broker statements, and advisor input for final reporting.
        </p>
      </div>
    </section>
    </>
