      ...
      <div className="clc min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <nav className="max-w-6xl mx-auto px-4 pt-6 pb-3" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm">
            <li><Link href="/" className="text-slate-400 hover:text-blue-700">Home</Link></li>
            <li className="text-slate-300">/</li>
            <li><Link href="/calculators" className="text-slate-400 hover:text-blue-700">Calculators</Link></li>
            <li className="text-slate-300">/</li>
          ...
          <div className="mt-12 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {contentData.relatedCalculators.map((c, i) => (
                <Link key={i} href={c.url} className="clc-glass p-5 hover:shadow-lg hover:border-blue-200 transition-all group">
