...
import { IndianRupee, PieChart, TrendingUp, ArrowRight, AlertTriangle, Info, Check, ChevronDown, ChevronUp } from 'lucide-react';
...
export const DigitalWealthRoboAdvisor: React.FC = () => {
  ...
  return (
    <>
    <SEOHelmet
      title="Digital Wealth Robo-Advisor India 2026 - Personalized Portfolio Recommendations | MoneyCal"
      description="Get robo-advisor style portfolio recommendations based on age, income, goals, and risk profile for long-term wealth planning."
      keywords="robo advisor india, digital wealth advisor, personalized portfolio recommendation, automated investment planning"
      url="/calculators/digital-wealth-robo-advisor"
    />
