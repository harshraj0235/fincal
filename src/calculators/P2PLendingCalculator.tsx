  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          Use this with <Link to="/calculators/savings-account-calculator" className="underline">Savings Account Calculator</Link> and{' '}
          <Link to="/calculators/fd-calculator" className="underline">FD Calculator</Link> to compare risk-adjusted returns across safer alternatives.
        </p>
        <p className="text-neutral-700">
