...
export const P2PLendingCalculator: React.FC = () => {
  ...
  return (
    <>
    <SEOHelmet
      title="Peer-to-Peer Lending Calculator India 2026 - Return vs Default Risk | MoneyCal"
      description="Calculate expected P2P lending returns after platform fees, default risk, and taxes. Compare net yield for smarter lending decisions."
      keywords="p2p lending calculator india, peer to peer lending return calculator, p2p default risk calculator, net return after fees p2p"
      url="/calculators/p2p-lending-calculator"
    />
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        <h2 className="text-2xl font-bold text-neutral-900">P2P lending returns: focus on net yield, not headline interest</h2>
        <p className="text-neutral-700">
          P2P platforms often advertise attractive returns, but realized investor outcomes depend on defaults, platform fees, and tax treatment. This calculator helps
          users evaluate <strong>peer to peer lending return after default risk</strong> instead of relying on gross rate claims.
        </p>
        <p className="text-neutral-700">
          A practical framework is to diversify across many borrowers, monitor delinquency data, and cap exposure per borrower. Test conservative default assumptions to
          understand downside. If your strategy breaks with small default increases, reduce allocation or increase diversification.
        </p>
        <p className="text-neutral-700">
          Use this with <Link href="/calculators/savings-account-calculator" className="underline">Savings Account Calculator</Link> and{' '}
          <Link href="/calculators/fd-calculator" className="underline">FD Calculator</Link> to compare risk-adjusted returns across safer alternatives.
        </p>
        <p className="text-neutral-700">
          For regulatory context and platform rules, review official RBI communications at{' '}
          <a href="https://www.rbi.org.in/" target="_blank" rel="noopener noreferrer" className="underline">RBI</a>. This page is an estimation tool and should be
          combined with platform-level disclosures and your own risk tolerance before investing.
        </p>
      </div>
    </section>
    </>
