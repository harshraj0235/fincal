...
export const RetirementCalculator: React.FC = () => {
  ...
  const quickPresets = [
    { label: 'Early Starter (30)', age: 30, retire: 60, expenses: 50000, savings: 1000000, monthly: 20000, return: 11, inflation: 7 },
    { label: 'Mid-Career (40)', age: 40, retire: 60, expenses: 80000, savings: 3000000, monthly: 30000, return: 10, inflation: 7 },
    { label: 'Late Starter (45)', age: 45, retire: 60, expenses: 100000, savings: 5000000, monthly: 50000, return: 9.5, inflation: 6.5 },
    { label: 'FIRE Seeker (28)', age: 28, retire: 45, expenses: 120000, savings: 4000000, monthly: 100000, return: 12, inflation: 7 },
    { label: 'Senior Planning (50)', age: 50, retire: 60, expenses: 60000, savings: 10000000, monthly: 40000, return: 8, inflation: 6 },
  ];

  const applyPreset = (preset: typeof quickPresets[0]) => {
    setCurrentAge(preset.age);
    setRetirementAge(preset.retire);
    setMonthlyExpenses(preset.expenses);
    setExistingSavings(preset.savings);
