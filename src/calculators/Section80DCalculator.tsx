...
export const Section80DCalculator: React.FC = () => {
  ...
  const contentData = {
    title: "Section 80D Calculator - Health Insurance Tax Deduction Calculator India 2025-2027",
    description: "Free Section 80D Calculator for India. Calculate health insurance tax deduction for self, family, and parents for 2025, 2026, 2027. Understand ₹25K/₹50K limits, senior citizen benefits. Plan health insurance tax savings. Updated with Budget 2024-25 provisions.",
    benefits: [
      ...
      "100% free Section 80D calculator updated with 2025-2027 tax rules"
    ],
    howToSteps: [
      {
    ...
    faqs: [
      {
        ...
        answer: "Section 80D is Income Tax Act provision allowing deduction for health insurance premium and medical expenses. Qualifying expenses: 1) Health Insurance Premium: For self, spouse, dependent children (₹25K limit), For parents (₹25K if <60, ₹50K if 60+), Must be from registered insurer, Premium must be paid through non-cash mode. 2) Preventive Health Checkup: Up to ₹5,000 included in above limits, For self, spouse, children, parents, Can be separate or part of insurance policy. 3) Medical Expenses (for senior citizens): If no health insurance, medical expenses qualify (₹50K limit for 60+), But health insurance is better (same limit + coverage). Maximum deduction: ₹25K (self/family) + ₹50K (parents 60+) = ₹75K total. Tax benefit: Saves 5-30% tax depending on income bracket. Use this calculator to plan health insurance for maximum tax benefit!"
      },
      {
  ...
  return (
    <>
      <CalculatorSchema 
        name="Section 80D Calculator - Health Insurance Tax Deduction Calculator India 2025-2027" 
