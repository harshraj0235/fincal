...
import { DollarSign, ArrowDown, ArrowUp, FileText, Copy, Check } from 'lucide-react';
...
export const GstSellerCalculator: React.FC = () => {
  ...
  return (
    <>
    <SEOHelmet
      title="GST Calculator for Sellers India 2026 - Invoice Ready GST Tool | MoneyCal"
      description="Calculate GST for sellers in India with CGST/SGST/IGST split, inclusive/exclusive pricing, and invoice-ready output for business transactions."
      keywords="gst calculator for sellers india, gst invoice calculator, cgst sgst igst calculator, add remove gst calculator for business"
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        <h2 className="text-2xl font-bold text-neutral-900">GST for sellers: invoice accuracy, tax split, and compliance discipline</h2>
        <p className="text-neutral-700">
          Sellers frequently need instant answers for <strong>GST calculator inclusive vs exclusive</strong> and <strong>CGST SGST IGST split</strong>. This calculator
          is designed for practical invoicing workflows by showing base value, tax amount, and state-wise split for the same transaction.
        </p>
        <p className="text-neutral-700">
          For better compliance, sellers should ensure correct HSN/SAC classification, place of supply, and invoice structure. Wrong classification may lead to mismatch
          notices or payment differences. Use this page as a quick computation layer and validate rates/classifications with your tax process and accountant.
        </p>
        <p className="text-neutral-700">
          If you also evaluate business profitability and payment cycles, connect this with <Link href="/calculators/income-tax-regime-comparison-calculator" className="underline">Income Tax Regime Comparison Calculator</Link>{' '}
          and <Link href="/calculators/savings-account-calculator" className="underline">Savings Account Calculator</Link> to track both tax and cash efficiency.
        </p>
        <p className="text-neutral-700">
          Always refer to official resources for filing and legal updates such as{' '}
          <a href="https://www.gst.gov.in/" target="_blank" rel="noopener noreferrer" className="underline">GST Portal</a>. This tool is educational and operational,
          not a substitute for legal advice in complex multi-state or industry-specific scenarios.
        </p>
      </div>
    </section>
    </>
