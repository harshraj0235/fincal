...
import { Calendar, Clock, AlertTriangle, CheckCircle, ExternalLink, Info, FileText, IndianRupee, TrendingUp, Bell, Download } from 'lucide-react';
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <IndianRupee className="w-6 h-6 mr-3 text-indigo-600" />
                Filing Details
              </h2>
