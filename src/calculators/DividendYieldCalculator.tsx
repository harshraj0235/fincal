  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">Use this tool with <Link href="/calculators/compound-interest-calculator" className="underline">Compound Interest Calculator</Link> and <Link href="/calculators/capital-gains-tax-advanced-calculator" className="underline">Capital Gains Tax Advanced Calculator</Link> for post-tax return planning.</p>
