  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">Combine this checker with <Link href="/calculators/asset-allocation-planner" className="underline">Asset Allocation Planner</Link> and <Link href="/calculators/risk-appetite-assessment" className="underline">Risk Appetite Assessment</Link> for better portfolio structure.</p>
