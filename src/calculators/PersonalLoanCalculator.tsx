      ...
      <div className="plc min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <nav className="max-w-6xl mx-auto px-4 pt-6 pb-3" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm">
            <li><Link href="/" className="text-slate-400 hover:text-violet-700">Home</Link></li>
            <li className="text-slate-300">/</li>
            <li><Link href="/calculators" className="text-slate-400 hover:text-violet-700">Calculators</Link></li>
            <li className="text-slate-300">/</li>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {contentData.relatedCalculators.map((c, i) => (
                <Link key={i} href={c.url} className="plc-glass p-5 hover:shadow-lg hover:border-violet-200 transition-all group">
