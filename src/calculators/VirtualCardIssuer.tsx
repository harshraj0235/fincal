  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          Combine this with your spending and cashflow tools like <Link to="/calculators/credit-card-finder" className="underline">Credit Card Finder</Link> and{' '}
          <Link to="/calculators/bnpl-calculator" className="underline">BNPL Calculator</Link> to avoid overextension while keeping security tight.
        </p>
        <p className="text-neutral-700">
