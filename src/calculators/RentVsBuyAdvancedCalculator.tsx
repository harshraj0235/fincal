    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          ...
          affordability. For complete salary-level planning, combine this page with the <Link to="/calculators/income-tax-regime-comparison-calculator" className="underline">Income Tax Regime Comparison Calculator</Link>{' '}
          and <Link to="/calculators/salary-calculator" className="underline">Salary Calculator</Link>. For loan-side sensitivity, use the{' '}
          <Link to="/calculators/home-loan-calculator" className="underline">Home Loan Calculator</Link>.
        </p>
        <p className="text-neutral-700">
