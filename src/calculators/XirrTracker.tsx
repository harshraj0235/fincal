...
export const XirrTracker: React.FC = () => {
  ...
  const faqs = [
  {
    "question": "What is Xirr Tracker and how does it work?",
    "answer": "Xirr Tracker is a financial calculation tool that helps you determine various financial metrics. It uses standard mathematical formulas to provide accurate results for your financial planning needs."
  },
  {
    "question": "How accurate is this xirr tracker calculator?",
    "answer": "Our xirr tracker calculator uses standard mathematical formulas and provides accurate projections. However, actual results may vary due to market fluctuations and other factors. Use this as a planning tool."
  },
  {
    "question": "Is this calculator free to use?",
    "answer": "Yes, our xirr tracker calculator is completely free to use. No registration or payment is required. You can use it as many times as you need for your financial planning."
  },
  {
    "question": "Can I use this calculator on mobile devices?",
    "answer": "Yes, our xirr tracker calculator is fully optimized for all devices including mobile phones, tablets, and desktop computers. The interface adapts to your screen size."
  }
];
  ...
  return (
    <EnhancedCalculator
      id="xirrtracker"
      name="Xirr Tracker"
      description="Calculate your xirr tracker with our free online calculator. Get accurate calculations and results instantly."
      category="Investment Calculators"
      seoTitle="Xirr Tracker 2025 - Calculate Xirr Tracker Online | Free Calculator India"
      seoDescription="Calculate your xirr tracker instantly with our free xirr tracker calculator. Get accurate calculations and results. No registration required. Updated for 2025."
      focusKeyword="xirr tracker calculator"
      relatedKeywords={["xirr tracker calculator","xirr tracker calculation","xirr tracker calculator India","xirr tracker calculator online","free xirr tracker calculator","xirr tracker calculator 2025"]}
      inputs={inputs}
