    ...
    <section className="mt-10 space-y-6">
      <div className="bg-white border border-neutral-200 rounded-lg p-6">
        ...
        <p className="text-neutral-700">
          ...
          <Link to="/calculators/nps-return-calculator" className="underline">NPS Return Calculator</Link>,{' '}
          <Link to="/calculators/epf-calculator" className="underline">EPF Calculator</Link>, and{' '}
          <Link to="/calculators/retirement-calculator" className="underline">Retirement Calculator</Link> for full retirement strategy design.
