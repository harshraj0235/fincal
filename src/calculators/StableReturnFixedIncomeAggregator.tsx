...
import { IndianRupee, Search, Filter, TrendingUp, Calendar, ArrowRight, Info, ExternalLink, Check } from 'lucide-react';
...
export const StableReturnFixedIncomeAggregator: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Apply sorting
    result.sort((a, b) => {
      const valueA = a[sortBy as keyof FixedIncomeProduct];
      const valueB = b[sortBy as keyof FixedIncomeProduct];
