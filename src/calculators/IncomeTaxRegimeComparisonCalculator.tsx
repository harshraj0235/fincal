  ...
  return (
    ...
    <section className="mt-10">
      <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-700">
          For connected planning, use <Link to="/calculators/salary-calculator" className="underline">Salary Calculator</Link>,{' '}
          <Link to="/calculators/hra-exemption-calculator" className="underline">HRA Exemption Calculator</Link>, and{' '}
          <Link to="/calculators/retirement-calculator" className="underline">Retirement Calculator</Link> to align tax decisions with long-term wealth goals.
        </p>
        <p className="text-neutral-700">
