          ...
          <div className="space-y-4">
            <div className="p-4 bg-white rounded-lg">
              ...
              <p className="text-sm text-neutral-600">
                Inflation erodes the purchasing power of your money over time. ₹1 lakh today won't buy the same amount of goods and services 20 years later. This calculator accounts for inflation to give you a more realistic retirement corpus requirement.
              </p>
            </div>
