    ...
    <section className="mt-10 space-y-6">
      <div className="bg-white border border-neutral-200 rounded-lg p-6">
        ...
        <p className="text-neutral-700">
          ...
          <Link href="/calculators/sip-calculator" className="underline">SIP Calculator</Link>,{' '}
          <Link href="/calculators/retirement-calculator" className="underline">Retirement Calculator</Link>, and{' '}
          <Link href="/calculators/pension-calculator" className="underline">Pension Calculator</Link>. You can also benchmark inflation assumptions from official
          releases on{' '}
