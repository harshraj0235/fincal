    ...
    <>
      ...
      <div className="lpc-premium min-h-screen text-slate-200">
        ...
        <div className="pt-6 px-6 md:px-12 max-w-7xl mx-auto flex items-center justify-between relative z-50">
            <Link href="/calculators" className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-indigo-400 transition-colors">
