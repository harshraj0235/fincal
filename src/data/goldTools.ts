...
export const goldTools: GoldToolConfig[] = [
  ...
  { slug: 'gram-to-tola', name: 'Gram to Tola', type: 'gramToTola', description: 'Convert grams to tola units used in Indian markets.', seo: { title: 'Gram to Tola Converter (Instant, Mobile-Friendly) | MoneyCal', description: 'Fast gram to tola converter with reverse tola to gram, ounce, mg, kg. Accurate 1 tola = 11.6638038 grams. Built for India buyers, jewellers, and students.', keywords: ['gram to tola converter', 'convert grams to tola', '1 tola in grams', 'tola to gram calculator', 'gold weight converter india', 'grams to tola online', 'troy ounce to gram', 'mg to gram to tola'] } },
