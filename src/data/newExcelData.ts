...
export const newExcelToolBlogPosts: ExcelToolBlogPost[] = [
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        content: 'Subtract your total expenses from your total income. If you have a surplus, you can allocate it to savings or investments. If you have a deficit, it is time to review your spending and make cuts.'
      },
      {
        type: 'quote',
