...
export interface Calculator {
  ...
  isPopular?: boolean;
  // --- New SEO Checklist Fields ---
  primaryKeyword?: string;
  hinglishTitle?: string;
  searchIntent?: 'informational' | 'transactional' | 'tool';
  introduction?: string;
  ...
  // Loan Calculators
  {
    ...
    calculators: [
      { id: 'loan-calculator', name: 'Advanced Loan Calculator 2024', description: 'India\'s most intelligent loan Calculator with EMI calculation, prepayment planning, loan comparison & AI insights. Export to PDF/Excel', keywords: ['loan Calculator india', 'emi calculator', 'loan prepayment calculator', 'loan comparison tool', 'best loan Calculator 2024', 'loan emi Calculator with prepayment', 'amortization schedule', 'home loan calculator', 'personal loan calculator'], category: 'Loan Calculators', relatedCalculators: ['emi-calculator', 'home-loan-calculator', 'personal-loan-calculator', 'loan-prepayment-calculator'] },
      {
        ...
        hinglishTitle: 'Loan EMI Calculator - EMI Kaise Calculate Kare',
        searchIntent: 'tool',
        introduction: 'Planning to take a loan? The EMI (Equated Monthly Installment) calculator helps you understand exactly how much you need to pay every month. Whether it is a home loan, car loan, or personal loan, our tool instantly calculates your monthly outflow, total interest, and provides a month-by-month amortization schedule. Enter your loan amount (principal), interest rate, and tenure below to get started.',
        authorName: 'Harsh Raj',
        lastUpdated: 'August 2026',
        methodology: 'Calculated using the standard reducing balance method: P x R x (1+R)^N / [(1+R)^N-1].',
        faqs: [
      ...
      { id: 'loan-affordability-calculator',
        url: '/loan-tools/loan-affordability-calculator', name: 'Loan Affordability Calculator', description: 'Calculate how much loan you can afford based on your income', keywords: ['loan affordability', 'borrowing capacity', 'loan eligibility'], category: 'Loan Calculators', relatedCalculators: ['emi-calculator', 'home-loan-calculator'] },
      ...
      { id: 'loan-prepayment-calculator', name: 'Loan Prepayment Calculator', description: 'Calculate how much you can save by prepaying your loan. See interest saved, tenure reduction, and optimal prepayment strategy for home, personal, and car loans in India.', keywords: ['loan prepayment calculator india', 'home loan prepayment calculator', 'part payment calculator', 'loan foreclosure calculator', 'prepayment savings calculator', 'emi prepayment benefit'], category: 'Loan Calculators', relatedCalculators: ['emi-calculator', 'home-loan-calculator', 'loan-comparison-calculator', 'loan-refinance-calculator'] },
      { id: 'education-loan-calculator', name: 'Education Loan EMI Calculator', description: 'Calculate education loan EMI, total interest, and repayment schedule for studying in India or abroad. Compare bank rates, moratorium period impact, and tax benefits under Section 80E.', keywords: ['education loan calculator india', 'student loan emi calculator', 'education loan interest calculator', 'study abroad loan calculator', 'section 80e tax benefit calculator'], category: 'Loan Calculators', relatedCalculators: ['emi-calculator', 'personal-loan-calculator', 'income-tax-calculator'] },
      { id: 'salary-calculator', name: 'Salary Calculator India', description: 'Calculate your in-hand salary from CTC. Includes PF, HRA, professional tax, income tax deductions, and take-home pay calculation for FY 2025-26.', keywords: ['salary calculator india', 'ctc to in hand salary calculator', 'take home salary calculator', 'salary after tax calculator india', 'net salary calculator', 'gross to net salary'], category: 'Tax & Income', relatedCalculators: ['income-tax-calculator', 'hra-exemption-calculator', 'ctc-calculator'] }
    ]
  },
    ...
    calculators: [
      {
        ...
        hinglishTitle: 'SIP Calculator - Mutual Fund Returns Kaise Check Kare',
        searchIntent: 'tool',
        introduction: 'Start your wealth creation journey with our SIP Calculator. Systematic Investment Plan (SIP) allows you to invest a fixed amount regularly in Mutual Funds. Use this free calculator to estimate your future wealth based on your monthly investment, expected return rate, and time period. See the magic of compounding turn small monthly savings of ₹5,000 into Crores over time.',
        authorName: 'Harsh Raj',
        lastUpdated: 'August 2026',
        methodology: 'Calculated using the future value of an annuity formula for monthly compounding: M = P x ({[1 + i]^n - 1} / i) x (1 + i).',
        faqs: [
      ...
      },
      {
        ...
        info: [
          'A Step-Down SIP is a strategic tool for investors approaching retirement or those anticipating a future drop in disposable income.',
          'It allows you to maintain the discipline of systematic investing while gradually reducing your monthly cash outflow.',
          'This is particularly useful when shifting investments to lower-risk, lower-return debt instruments as you near your financial goal.'
        ]
      },
      {
        id: 'rd-calculator',
        name: 'Recurring Deposit Calculator',
        description: 'Calculate RD maturity amount and interest earned with our easy-to-use Recurring Deposit calculator.',
        keywords: ['rd calculator', 'recurring deposit calculator', 'rd interest calculator', 'rd maturity calculator', 'rd returns'],
        category: 'Investment Calculators',
        relatedCalculators: ['fd-calculator', 'sip-calculator', 'compound-interest-calculator'],
        primaryKeyword: 'rd calculator',
        hinglishTitle: 'RD Calculator - Recurring Deposit Returns Check Kare',
        searchIntent: 'tool'
      },
      {
  ...
  // Business Calculators
  {
    ...
    calculators: [
      { id: 'break-even-calculator',
        url: '/corporate-finance/break-even-calculator', name: 'Break-Even Calculator', description: 'Calculate your business break-even point', keywords: ['break-even', 'business', 'profit', 'loss', 'fixed costs', 'variable costs'], category: 'Business Calculators', relatedCalculators: ['profit-margin-calculator', 'inventory-turnover-calculator'] },
      {
  ...
  // Personal Finance
  {
    ...
    calculators: [
      ...
      { id: 'net-worth-calculator',
        url: '/tools/net-worth-calculator', name: 'Net Worth Calculator', description: 'Calculate personal net worth by listing assets and liabilities to monitor wealth growth, debt pressure, and financial health.', keywords: ['net worth calculator india', 'assets liabilities calculator', 'personal balance sheet calculator', 'wealth tracking tool india', 'financial health calculator'], category: 'Personal Finance', relatedCalculators: ['budget-calculator', 'debt-equity-calculator', 'financial-goal-calculator'] },
      ...
      { id: 'schemes-finder',
        url: '/schemes-finder', name: 'Govt Scheme Eligibility Checker', description: 'Find matching government schemes based on simple questions like age, income, and gender. Get eligibility details and apply links.', keywords: ['govt scheme eligibility checker', 'government schemes india', 'pm kisan eligibility check', 'sukanya samriddhi eligibility', 'scheme finder india'], category: 'Personal Finance', relatedCalculators: ['budget-calculator', 'emergency-fund-calculator'] }
    ]
  },
  ...
  // Advisor & Marketing Tools
  {
    ...
    calculators: [
      ...
      },
      {
        ...
        url: '/tools/marketing/sipdelay-visualizer',
      ...
      },
      {
        ...
        url: '/tools/marketing/roicomparison-designer',
