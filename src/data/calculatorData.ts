...
export const calculatorCategories: CalculatorCategory[] = [
  // Loan Calculators
  {
    ...
    calculators: [
      ...
      { id: 'emi-calculator', name: 'EMI Calculator', description: 'Calculate your loan EMI, total interest, and payment schedule', keywords: ['emi', 'loan', 'interest', 'payment', 'monthly installment'], category: 'Loan Calculators', relatedCalculators: ['loan-calculator', 'loan-comparison-calculator', 'home-loan-calculator', 'personal-loan-calculator'] },
  ...
  // Investment Calculators
  {
    ...
    calculators: [
      ...
      { id: 'rd-calculator', name: 'RD Calculator', description: 'Calculate Recurring Deposit (RD) maturity amount and monthly investment returns with compound interest for Indian banks.', keywords: ['rd calculator india', 'recurring deposit calculator', 'monthly deposit calculator', 'rd maturity calculator', 'bank rd calculator'], category: 'Investment Calculators', relatedCalculators: ['fd-calculator', 'ppf-calculator', 'sip-calculator'] }
    ]
  },
  // Tax Calculators
  {
  ...
  // Retirement Calculators
  {
    ...
    calculators: [
      ...
      { id: 'epf-calculator', name: 'EPF Calculator', description: 'Calculate Employee Provident Fund (EPF) maturity amount, interest, and withdrawal benefits for Indian employees.', keywords: ['epf calculator india', 'provident fund calculator', 'pf calculator', 'employee provident fund', 'epf maturity calculator', 'pf withdrawal calculator'], category: 'Retirement Calculators', relatedCalculators: ['retirement-calculator', 'pension-calculator', 'nps-calculator'] }
    ]
  },
  ...
  // Property Calculators
  {
    ...
    calculators: [
      ...
      { id: 'property-registration-charges-calculator', name: 'Property Registration Charges Calculator', description: 'Calculate all costs and charges involved in property registration including stamp duty and legal fees', keywords: ['property registration charges', 'registration fees', 'stamp duty', 'legal fees', 'property transfer cost'], category: 'Property Calculators', relatedCalculators: ['stamp-duty-calculator', 'home-loan-calculator'] }
    ]
  },
  ...
  // Math & Education Calculators
  {
    ...
    calculators: [
      { id: 'lcm-hcf-calculator', name: 'LCM and HCF Calculator', description: 'Calculate Least Common Multiple (LCM) and Highest Common Factor (HCF) of multiple numbers with step-by-step solutions. Supports prime factorization, Euclidean algorithm, and division methods.', keywords: ['lcm calculator', 'hcf calculator', 'least common multiple calculator', 'highest common factor calculator', 'gcd calculator', 'lcm hcf finder', 'prime factorization calculator', 'euclidean algorithm calculator', 'math calculator', 'number theory calculator', 'lcm of multiple numbers', 'hcf of multiple numbers', 'lcm hcf relationship', 'step by step lcm calculation', 'step by step hcf calculation', 'lcm hcf online calculator', 'free lcm hcf calculator', 'lcm hcf calculator with steps', 'lcm hcf calculator for students', 'lcm hcf calculator for teachers', 'lcm hcf calculator for competitive exams', 'lcm hcf calculator for bank exams', 'lcm hcf calculator for ssc', 'lcm hcf calculator for cat', 'lcm hcf calculator for gate', 'lcm hcf calculator for engineering', 'lcm hcf calculator for mathematics', 'lcm hcf calculator for number theory', 'lcm hcf calculator for algebra', 'lcm hcf calculator for arithmetic', 'lcm hcf calculator for fractions', 'lcm hcf calculator for ratios', 'lcm hcf calculator for proportions', 'lcm hcf calculator for word problems', 'lcm hcf calculator for real life applications', 'lcm hcf calculator for scheduling', 'lcm hcf calculator for time management', 'lcm hcf calculator for project planning', 'lcm hcf calculator for resource allocation', 'lcm hcf calculator for optimization problems', 'lcm hcf calculator for algorithm design', 'lcm hcf calculator for computer science', 'lcm hcf calculator for cryptography', 'lcm hcf calculator for modular arithmetic', 'lcm hcf calculator for discrete mathematics', 'lcm hcf calculator for abstract algebra', 'lcm hcf calculator for ring theory', 'lcm hcf calculator for field theory', 'lcm hcf calculator for group theory', 'lcm hcf calculator for linear algebra', 'lcm hcf calculator for matrix operations', 'lcm hcf calculator for polynomial arithmetic', 'lcm hcf calculator for rational numbers', 'lcm hcf calculator for integers', 'lcm hcf calculator for natural numbers', 'lcm hcf calculator for whole numbers', 'lcm hcf calculator for real numbers', 'lcm hcf calculator for complex numbers', 'lcm hcf calculator for prime numbers', 'lcm hcf calculator for composite numbers', 'lcm hcf calculator for coprime numbers', 'lcm hcf calculator for relatively prime numbers', 'lcm hcf calculator for perfect numbers', 'lcm hcf calculator for abundant numbers', 'lcm hcf calculator for deficient numbers', 'lcm hcf calculator for amicable numbers', 'lcm hcf calculator for twin primes', 'lcm hcf calculator for mersenne primes', 'lcm hcf calculator for fermat primes', 'lcm hcf calculator for sophie germain primes', 'lcm hcf calculator for safe primes', 'lcm hcf calculator for strong primes', 'lcm hcf calculator for palindromic primes', 'lcm hcf calculator for emirp numbers', 'lcm hcf calculator for circular primes', 'lcm hcf calculator for permutable primes', 'lcm hcf calculator for truncatable primes', 'lcm hcf calculator for additive primes', 'lcm hcf calculator for multiplicative primes', 'lcm hcf calculator for factorial primes', 'lcm hcf calculator for primorial primes', 'lcm hcf calculator for fibonacci primes', 'lcm hcf calculator for lucas primes', 'lcm hcf calculator for pell primes', 'lcm hcf calculator for repunit primes', 'lcm hcf calculator for wagstaff primes', 'lcm hcf calculator for woodall primes', 'lcm hcf calculator for cullen primes', 'lcm hcf calculator for carol primes', 'lcm hcf calculator for kynea primes', 'lcm hcf calculator for leyland primes', 'lcm hcf calculator for thabit primes', 'lcm hcf calculator for pierpont primes', 'lcm hcf calculator for solinas primes', 'lcm hcf calculator for atkin primes', 'lcm hcf calculator for siegel primes', 'lcm hcf calculator for ramanujan primes', 'lcm hcf calculator for euler primes', 'lcm hcf calculator for bernoulli primes', 'lcm hcf calculator for fermat numbers', 'lcm hcf calculator for mersenne numbers', 'lcm hcf calculator for perfect numbers', 'lcm hcf calculator for amicable numbers', 'lcm hcf calculator for sociable numbers', 'lcm hcf calculator for betrothed numbers', 'lcm hcf calculator for quasiperfect numbers', 'lcm hcf calculator for multiply perfect numbers', 'lcm hcf calculator for superperfect numbers', 'lcm hcf calculator for unitary perfect numbers', 'lcm hcf calculator for infinitary perfect numbers', 'lcm hcf calculator for harmonic numbers', 'lcm hcf calculator for harmonic divisor numbers', 'lcm hcf calculator for refactorable numbers', 'lcm hcf calculator for tau numbers', 'lcm hcf calculator for sphenic numbers', 'lcm hcf calculator for squarefree numbers', 'lcm hcf calculator for powerful numbers', 'lcm hcf calculator for achilles numbers', 'lcm hcf calculator for frugal numbers', 'lcm hcf calculator for equidigital numbers', 'lcm hcf calculator for extravagant numbers', 'lcm hcf calculator for economical numbers', 'lcm hcf calculator for wasteful numbers', 'lcm hcf calculator for frugal numbers', 'lcm hcf calculator for equidigital numbers', 'lcm hcf calculator for extravagant numbers', 'lcm hcf calculator for economical numbers', 'lcm hcf calculator for wasteful numbers'], category: 'Math & Education Calculators', relatedCalculators: ['compound-interest-calculator', 'simple-interest-calculator', 'percentage-calculator'] }
    ]
  }
];
