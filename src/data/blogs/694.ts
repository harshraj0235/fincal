...
export const blog694: BlogPost = {
  id: 694,
  slug: 'kochi-jobs-trends-2025-guide-694',
  title: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (694)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (694)' },
  openGraph: { title: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (694)', description: 'Kochi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/kochi-jobs-trends-2025-guide-694', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog694.categories.includes(c))).slice(0, 3);
