...
export const blog727: BlogPost = {
  id: 727,
  slug: 'kolkata-finance-trends-2025-guide-727',
  title: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (727)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (727)' },
  openGraph: { title: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (727)', description: 'Kolkata practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg', url: '/blog/kolkata-finance-trends-2025-guide-727', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog727.categories.includes(c))).slice(0, 3);
