...
export const blog698: BlogPost = {
  id: 698,
  slug: 'guwahati-jobs-trends-2025-guide-698',
  title: 'Guwahati 2025: Jobs, Reskilling & Salaries — A Practical Guide (698)',
  author: 'Harsh Raj',
  ...
  metaDescription: 'Guwahati practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  excerpt: 'Guwahati practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  categories: ['Guides','Guwahati','JOBS'],
  keywords: ["guwahati","jobs 2025","jobs 2025","salary bands","reskilling","careers India"],
  date: '2025-08-09',
  coverImage: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg',
  content: [
  {
    "type": "heading",
    "content": "Guwahati 2025: Jobs, Reskilling & Salaries"
  },
  {
    "type": "paragraph",
    "content": "Guwahati is seeing steady momentum in Jobs, Reskilling & Salaries through 2025 as teams formalize measured, metrics-driven execution across product and operations."
  },
  {
    "type": "subheading",
  ...
  {
    "type": "paragraph",
    "content": "Local networks in Guwahati—meetups, demo days, and peer reviews—accelerate feedback loops and help practitioners benchmark their work against industry standards."
  },
  {
    "type": "paragraph",
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Guwahati 2025: Jobs, Reskilling & Salaries — A Practical Guide (698)' },
  openGraph: { title: 'Guwahati 2025: Jobs, Reskilling & Salaries — A Practical Guide (698)', description: 'Guwahati practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/guwahati-jobs-trends-2025-guide-698', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog698.categories.includes(c))).slice(0, 3);
