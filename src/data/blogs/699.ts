...
export const blog699: BlogPost = {
  id: 699,
  slug: 'nagpur-finance-trends-2025-guide-699',
  title: 'Nagpur 2025: Personal Finance & Tax — A Practical Guide (699)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Nagpur 2025: Personal Finance & Tax — A Practical Guide (699)' },
  openGraph: { title: 'Nagpur 2025: Personal Finance & Tax — A Practical Guide (699)', description: 'Nagpur practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg', url: '/blog/nagpur-finance-trends-2025-guide-699', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog699.categories.includes(c))).slice(0, 3);
