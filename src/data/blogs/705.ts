...
export const blog705: BlogPost = {
  id: 705,
  slug: 'hyderabad-stocks-trends-2025-guide-705',
  title: 'Hyderabad 2025: Stock Market & SIP Discipline — A Practical Guide (705)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Hyderabad 2025: Stock Market & SIP Discipline — A Practical Guide (705)' },
  openGraph: { title: 'Hyderabad 2025: Stock Market & SIP Discipline — A Practical Guide (705)', description: 'Hyderabad practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6802042/pexels-photo-6802042.jpeg', url: '/blog/hyderabad-stocks-trends-2025-guide-705', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog705.categories.includes(c))).slice(0, 3);
