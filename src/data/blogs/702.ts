...
export const blog702: BlogPost = {
  id: 702,
  slug: 'delhi-jobs-trends-2025-guide-702',
  title: 'Delhi 2025: Jobs, Reskilling & Salaries — A Practical Guide (702)',
  author: 'Harsh Raj',
  ...
  metaDescription: 'Delhi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  excerpt: 'Delhi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  categories: ['Guides','Delhi','JOBS'],
  keywords: ["delhi","jobs 2025","jobs 2025","salary bands","reskilling","careers India"],
  date: '2025-08-09',
  coverImage: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg',
  content: [
  {
    "type": "heading",
    "content": "Delhi 2025: Jobs, Reskilling & Salaries"
  },
  {
    "type": "paragraph",
    "content": "Delhi is seeing steady momentum in Jobs, Reskilling & Salaries through 2025 as teams formalize measured, metrics-driven execution across product and operations."
  },
  {
    "type": "subheading",
  ...
  {
    "type": "paragraph",
    "content": "Local networks in Delhi—meetups, demo days, and peer reviews—accelerate feedback loops and help practitioners benchmark their work against industry standards."
  },
  {
    "type": "paragraph",
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Delhi 2025: Jobs, Reskilling & Salaries — A Practical Guide (702)' },
  openGraph: { title: 'Delhi 2025: Jobs, Reskilling & Salaries — A Practical Guide (702)', description: 'Delhi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/delhi-jobs-trends-2025-guide-702', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog702.categories.includes(c))).slice(0, 3);
