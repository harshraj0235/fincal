...
export const blog686: BlogPost = {
  id: 686,
  slug: 'chennai-jobs-trends-2025-guide-686',
  title: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (686)',
  author: 'Harsh Raj',
  ...
  metaDescription: 'Chennai practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  excerpt: 'Chennai practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  categories: ['Guides','Chennai','JOBS'],
  keywords: ["chennai","jobs 2025","jobs 2025","salary bands","reskilling","careers India"],
  date: '2025-08-09',
  coverImage: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg',
  content: [
  {
    "type": "heading",
    "content": "Chennai 2025: Jobs, Reskilling & Salaries"
  },
  {
    "type": "paragraph",
    "content": "Chennai is seeing steady momentum in Jobs, Reskilling & Salaries through 2025 as teams formalize measured, metrics-driven execution across product and operations."
  },
  {
    "type": "subheading",
  ...
  {
    "type": "paragraph",
    "content": "Local networks in Chennai—meetups, demo days, and peer reviews—accelerate feedback loops and help practitioners benchmark their work against industry standards."
  },
  {
    "type": "paragraph",
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (686)' },
  openGraph: { title: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (686)', description: 'Chennai practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/chennai-jobs-trends-2025-guide-686', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog686.categories.includes(c))).slice(0, 3);
