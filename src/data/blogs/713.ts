...
export const blog713: BlogPost = {
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Surat 2025: Stock Market & SIP Discipline — A Practical Guide (713)' },
  openGraph: { title: 'Surat 2025: Stock Market & SIP Discipline — A Practical Guide (713)', description: 'Surat practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6802042/pexels-photo-6802042.jpeg', url: '/blog/surat-stocks-trends-2025-guide-713', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog713.categories.includes(c))).slice(0, 3);
