...
export const blog695: BlogPost = {
  id: 695,
  slug: 'coimbatore-finance-trends-2025-guide-695',
  title: 'Coimbatore 2025: Personal Finance & Tax — A Practical Guide (695)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Coimbatore 2025: Personal Finance & Tax — A Practical Guide (695)' },
  openGraph: { title: 'Coimbatore 2025: Personal Finance & Tax — A Practical Guide (695)', description: 'Coimbatore practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg', url: '/blog/coimbatore-finance-trends-2025-guide-695', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog695.categories.includes(c))).slice(0, 3);
