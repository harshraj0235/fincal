...
export const candlesSoapsBusiness: BlogPost = {
  id: 684,
  title: 'घर पर बनी मोमबत्तियाँ और साबुन कैसे बेचें? - ₹5000 से शुरू करें, ₹40,000/महीना कमाएं',
  slug: 'handmade-candles-soaps-selling-business-guide-hindi',
  date: getCurrentDate(),
  author: 'स्नेहा पटेल',
  authorTitle: 'Organic Product Manufacturing Expert',
  authorImage: 'https://images.pexels.com/photos/3756678/pexels-photo-3756678.jpeg?auto=compress&cs=tinysrgb&w=150',
  authorBio: '6+ साल का अनुभव organic candles और soaps manufacturing में। 500+ home businesses को setup किया है।',
  coverImage: 'https://images.pexels.com/photos/4202325/pexels-photo-4202325.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
  excerpt: 'घर पर मोमबत्तियाँ और साबुन बनाकर महीने में ₹30,000-50,000 तक कमाएं। Complete guide with recipes, material list, legal requirements, branding tips, और selling strategies। Eco-friendly business की complete guide!',
  categories: ['Small Business', 'DIY', 'Manufacturing', 'Organic Products'],
  content: [
    {
      type: 'paragraph',
      content: 'Handmade candles और organic soaps का business आज के समय में बेहद profitable है। लोग अब chemical-free, eco-friendly products prefer कर रहे हैं। इस article में मैं आपको step-by-step बताऊंगी कि कैसे आप घर पर ही high-quality candles और soaps बना सकते हैं और उन्हें profitable तरीके से बेच सकते हैं।'
    },
    {
      type: 'heading',
      content: '🕯️ मोमबत्तियाँ बनाने का Business (Candle Making)'
    },
    {
      type: 'subheading',
    ...
    {
      type: 'subheading',
      content: 'Types of Candles (सबसे ज्यादा बिकने वाली):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Basic Candle Making Process:'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'heading',
      content: '🧼 साबुन बनाने का Business (Soap Making)'
    },
    {
      type: 'subheading',
      content: 'Material Required (₹3500):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Popular Soap Variants (High Demand):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Soap Making Process (Melt & Pour Method):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'heading',
      content: '📦 Branding & Packaging (बहुत Important!)'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'heading',
      content: '🛒 कहाँ और कैसे बेचें? (Complete Selling Strategy)'
    },
    {
      type: 'subheading',
      content: '1. Online Selling (सबसे Profitable):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: '3. Bulk Orders (High Profit):'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'heading',
      content: '💰 Investment & Earning Breakdown'
    },
    {
      type: 'subheading',
    ...
    {
      type: 'heading',
      content: '📜 Legal Requirements (Important)'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'quote',
      content: 'मैं प्रिया हूं, Jaipur से। 2022 में lockdown में candle making hobby के तौर पर शुरू की थी। पहले महीने में 20 candles बनाए, friends को gift दिए। उन्होंने Instagram पर post किया, orders आने लगे! धीरे-धीरे soaps भी शुरू किए। अब मेरा "GlowNature" brand है, 2000+ Instagram followers हैं। Monthly ₹45,000-55,000 कमा रही हूं। Best part - पूरा natural और eco-friendly business है, satisfaction मिलती है!',
      author: 'प्रिया मेहता, Jaipur'
    },
    {
      type: 'heading',
      content: '🎯 Marketing Strategies (Sales 3x कैसे करें?)'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'heading',
      content: '🔥 30-Day Launch Plan'
    },
    {
      type: 'subheading',
      content: 'Week 1: Learning & Planning'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Week 2: Materials & Practice'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Week 3: Product Development'
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'subheading',
      content: 'Q1: Shelf life कितनी होती है?'
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'subheading',
      content: 'Q2: क्या chemical-free possible है?'
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'subheading',
      content: 'Q3: FSSAI license जरूरी है?'
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'subheading',
      content: 'Q4: Competition कैसे handle करें?'
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'subheading',
      content: 'Q5: Bulk orders कहाँ मिलेंगे?'
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      content: 'Candles और soaps बनाने का business एक बेहद rewarding और profitable venture है। लोग chemical-free, handmade products के लिए premium price pay करने को तैयार हैं। Market में scope बहुत है - home users से लेकर hotels, spas तक।'
    },
    {
      type: 'paragraph',
...
export default candlesSoapsBusiness;
