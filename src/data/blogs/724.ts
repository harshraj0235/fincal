...
export const blog724: BlogPost = {
  id: 724,
  slug: 'pune-tech-trends-2025-guide-724',
  title: 'Pune 2025: Tech Hiring & AI Adoption — A Practical Guide (724)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Pune 2025: Tech Hiring & AI Adoption — A Practical Guide (724)' },
  openGraph: { title: 'Pune 2025: Tech Hiring & AI Adoption — A Practical Guide (724)', description: 'Pune practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6693661/pexels-photo-6693661.jpeg', url: '/blog/pune-tech-trends-2025-guide-724', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog724.categories.includes(c))).slice(0, 3);
