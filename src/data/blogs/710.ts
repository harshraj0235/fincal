...
export const blog710: BlogPost = {
  id: 710,
  slug: 'lucknow-jobs-trends-2025-guide-710',
  title: 'Lucknow 2025: Jobs, Reskilling & Salaries — A Practical Guide (710)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Lucknow 2025: Jobs, Reskilling & Salaries — A Practical Guide (710)' },
  openGraph: { title: 'Lucknow 2025: Jobs, Reskilling & Salaries — A Practical Guide (710)', description: 'Lucknow practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/lucknow-jobs-trends-2025-guide-710', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog710.categories.includes(c))).slice(0, 3);
