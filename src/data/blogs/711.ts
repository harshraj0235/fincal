...
const blog711 = {
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Chandigarh 2025: Personal Finance & Tax — A Practical Guide (711)' },
  openGraph: { title: 'Chandigarh 2025: Personal Finance & Tax — A Practical Guide (711)', description: 'Chandigarh practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg', url: '/blog/chandigarh-finance-trends-2025-guide-711', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog711.categories.includes(c))).slice(0, 3);
