...
export const blog712: BlogPost = {
  id: 712,
  slug: 'indore-tech-trends-2025-guide-712',
  title: 'Indore 2025: Tech Hiring & AI Adoption — A Practical Guide (712)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Indore 2025: Tech Hiring & AI Adoption — A Practical Guide (712)' },
  openGraph: { title: 'Indore 2025: Tech Hiring & AI Adoption — A Practical Guide (712)', description: 'Indore practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6693661/pexels-photo-6693661.jpeg', url: '/blog/indore-tech-trends-2025-guide-712', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog712.categories.includes(c))).slice(0, 3);
