...
export const blog687: BlogPost = {
  id: 687,
  slug: 'kolkata-finance-trends-2025-guide-687',
  title: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (687)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (687)' },
  openGraph: { title: 'Kolkata 2025: Personal Finance & Tax — A Practical Guide (687)', description: 'Kolkata practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7876708/pexels-photo-7876708.jpeg', url: '/blog/kolkata-finance-trends-2025-guide-687', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog687.categories.includes(c))).slice(0, 3);
