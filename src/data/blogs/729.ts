...
export const blog729: BlogPost = {
  id: 729,
  slug: 'jaipur-stocks-trends-2025-guide-729',
  title: 'Jaipur 2025: Stock Market & SIP Discipline — A Practical Guide (729)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Jaipur 2025: Stock Market & SIP Discipline — A Practical Guide (729)' },
  openGraph: { title: 'Jaipur 2025: Stock Market & SIP Discipline — A Practical Guide (729)', description: 'Jaipur practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6802042/pexels-photo-6802042.jpeg', url: '/blog/jaipur-stocks-trends-2025-guide-729', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog729.categories.includes(c))).slice(0, 3);
