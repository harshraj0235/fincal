...
export const bonusInCtcVsActualReceiptTax: BlogPost = {
  ...
  content: [
    ...
    { type: 'paragraph', content: 'इनकम टैक्स कानून में राहत दी गई है – Section 89(1)। अगर पिछले साल का बोनस इस साल मिलने की वजह से ज्यादा टैक्स देना पड़ रहा है तो आप Form 10E भर सकते हैं। इससे टैक्स विभाग देखता है कि अगर यह बोनस उसी साल मिला होता तो कितना टैक्स बनता; इस तरह आप कुछ टैक्स बचा सकते हैं। बोनस हमेशा अगले साल मिलने की संभावना मानकर सेविंग्स प्लान करें। [टैक्स प्लानिंग](/blog/tax-saving-investment-options) और [पर्सनल फाइनेंस गाइड](/blog/personal-finance) पर और पढ़ें।' },
