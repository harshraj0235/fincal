...
export const blog716: BlogPost = {
  id: 716,
  slug: 'bhubaneswar-tech-trends-2025-guide-716',
  title: 'Bhubaneswar 2025: Tech Hiring & AI Adoption — A Practical Guide (716)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Bhubaneswar 2025: Tech Hiring & AI Adoption — A Practical Guide (716)' },
  openGraph: { title: 'Bhubaneswar 2025: Tech Hiring & AI Adoption — A Practical Guide (716)', description: 'Bhubaneswar practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6693661/pexels-photo-6693661.jpeg', url: '/blog/bhubaneswar-tech-trends-2025-guide-716', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog716.categories.includes(c))).slice(0, 3);
