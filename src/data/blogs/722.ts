...
export const blog722: BlogPost = {
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Delhi 2025: Jobs, Reskilling & Salaries — A Practical Guide (722)' },
  openGraph: { title: 'Delhi 2025: Jobs, Reskilling & Salaries — A Practical Guide (722)', description: 'Delhi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/delhi-jobs-trends-2025-guide-722', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog722.categories.includes(c))).slice(0, 3);
