...
export const blog721: BlogPost = {
  id: 721,
  slug: 'mumbai-stocks-trends-2025-guide-721',
  title: 'Mumbai 2025: Stock Market & SIP Discipline — A Practical Guide (721)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Mumbai 2025: Stock Market & SIP Discipline — A Practical Guide (721)' },
  openGraph: { title: 'Mumbai 2025: Stock Market & SIP Discipline — A Practical Guide (721)', description: 'Mumbai practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/6802042/pexels-photo-6802042.jpeg', url: '/blog/mumbai-stocks-trends-2025-guide-721', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog721.categories.includes(c))).slice(0, 3);
