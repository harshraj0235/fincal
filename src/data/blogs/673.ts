...
export const blog673: BlogPost = {
  id: 673,
  slug: 'financial-investment-guide-673',
  title: 'Financial Investment Guide 673',
  ...
  metaDescription: 'Comprehensive guide on financial investment guide 673. Learn about the latest trends, strategies, and opportunities in the Indian financial market.',
  excerpt: 'Discover the latest insights and strategies for financial investment guide 673. This comprehensive guide covers everything you need to know about making informed financial decisions.',
  categories: ['Investment', 'Finance', 'India'],
  keywords: ['financial investment guide 673', 'investment', 'finance', 'india', 'financial planning'],
  date: '2025-08-15',
  coverImage: 'https://moneycal.in/images/blogs/financial-investment-guide-673.jpg',
  content: [
    { type: 'heading', content: 'Financial Investment Guide 673' },
    { type: 'paragraph', content: 'The Indian financial market is experiencing significant changes in 2025, with new opportunities emerging for savvy investors. This comprehensive guide explores the latest trends and strategies for financial investment guide 673.' },
