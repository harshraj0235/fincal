...
export const blog714: BlogPost = {
  id: 714,
  slug: 'kochi-jobs-trends-2025-guide-714',
  title: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (714)',
  author: 'Harsh Raj',
  ...
  metaDescription: 'Kochi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  excerpt: 'Kochi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.',
  categories: ['Guides','Kochi','JOBS'],
  keywords: ["kochi","jobs 2025","jobs 2025","salary bands","reskilling","careers India"],
  date: '2025-08-09',
  coverImage: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg',
  content: [
  {
    "type": "heading",
    "content": "Kochi 2025: Jobs, Reskilling & Salaries"
  },
  {
    "type": "paragraph",
    "content": "Kochi is seeing steady momentum in Jobs, Reskilling & Salaries through 2025 as teams formalize measured, metrics-driven execution across product and operations."
  },
  {
    "type": "subheading",
  ...
  {
    "type": "paragraph",
    "content": "Local networks in Kochi—meetups, demo days, and peer reviews—accelerate feedback loops and help practitioners benchmark their work against industry standards."
  },
  {
    "type": "paragraph",
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (714)' },
  openGraph: { title: 'Kochi 2025: Jobs, Reskilling & Salaries — A Practical Guide (714)', description: 'Kochi practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/kochi-jobs-trends-2025-guide-714', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog714.categories.includes(c))).slice(0, 3);
