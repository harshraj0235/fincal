...
export const blog706: BlogPost = {
  id: 706,
  slug: 'chennai-jobs-trends-2025-guide-706',
  title: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (706)',
  author: 'Harsh Raj',
  ...
  readingTime: 6,
  schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', headline: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (706)' },
  openGraph: { title: 'Chennai 2025: Jobs, Reskilling & Salaries — A Practical Guide (706)', description: 'Chennai practitioners in 2025 focus on disciplined delivery: scoped releases, measurable outcomes, and risk-aware planning.', image: 'https://images.pexels.com/photos/7063778/pexels-photo-7063778.jpeg', url: '/blog/chennai-jobs-trends-2025-guide-706', type: 'article', siteName: 'MoneyCal India' },
  discoverOptimized: { highQualityImages: true, originalReporting: true, expertiseSignals: true, freshContent: true }
};

export const relatedBlogPosts = blogPosts.filter(p => p.categories?.some(c => blog706.categories.includes(c))).slice(0, 3);
