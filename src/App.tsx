...
const PromoDesigner = lazy(() => import('./pages/tools/PromoDesigner'));

// Marketing Tools
const PosterMaker = lazy(() => import('./pages/tools/marketing/PosterMaker'));
const SIPDelayVisualizer = lazy(() => import('./pages/tools/marketing/SIPDelayVisualizer'));
const LoanSavingsVisualizer = lazy(() => import('./pages/tools/marketing/LoanSavingsVisualizer'));
const EmailSignatureGenerator = lazy(() => import('./pages/tools/marketing/EmailSignatureGenerator'));
const ROIComparisonDesigner = lazy(() => import('./pages/tools/marketing/ROIComparisonDesigner'));
const TaxBucketVisualizer = lazy(() => import('./pages/tools/marketing/TaxBucketVisualizer'));
const InvestmentRiskProfiler = lazy(() => import('./pages/tools/marketing/InvestmentRiskProfiler'));
const EducationCostVisualizer = lazy(() => import('./pages/tools/marketing/EducationCostVisualizer'));
const RetirementScorecard = lazy(() => import('./pages/tools/marketing/RetirementScorecard'));
...
const UniversalArticleDispatcher = lazy(() => import('./pages/UniversalArticleDispatcher'));
const NewsCategoryDispatcher = lazy(() => import('./pages/NewsCategoryDispatcher'));

// IPO Section Components
const IpoHub = lazy(() => import('./pages/ipo/IpoHub'));
const IpoDetail = lazy(() => import('./pages/ipo/IpoDetail'));
const IpoTargetPage = lazy(() => import('./pages/ipo/IpoTargetPage'));

const StockMarketHub = lazy(() => import('./pages/StockMarketHub'));

// Market Rates Components
const MarketRatesHub = lazy(() => import('./pages/market/MarketRatesHub'));
...
const BrowseAll = lazy(() => import('./pages/BrowseAll'));
const CreditCardFinder = lazy(() => import('./calculators/CreditCardFinder'));
const CorporateMasterclass = lazy(() => import('./pages/MasterclassSeries'));
...
const GovernmentSchemeCategoryPage = lazy(() => import('./pages/GovernmentSchemeCategoryPage'));
const SiloPost = lazy(() => import('./pages/SiloPost'));
...
const EMICalculatorCompleteGuide = lazy(() => import('./pages/learn/loans/EMICalculatorCompleteGuide'));
const TaxToolsHub = lazy(() => import('./pages/TaxToolsHub'));
const TaxSimplifier = lazy(() => import('./pages/TaxSimplifier'));
const SIPSimplifier = lazy(() => import('./pages/SIPSimplifier'));
const EMISimplifier = lazy(() => import('./pages/EMISimplifier'));
...
const PDFConvertersHub = lazy(() => import('./pages/finance-tools/PDFConvertersHub'));
const SalarySlipPdfToExcel = lazy(() => import('./pages/finance-tools/salary-slip/SalarySlipPdfToExcel'));
const MultipleSalarySlipsToYearlyExcel = lazy(() => import('./pages/finance-tools/salary-slip/MultipleSalarySlipsToYearlyExcel'));
const SalarySlipPdfToCleanPdf = lazy(() => import('./pages/finance-tools/salary-slip/SalarySlipPdfToCleanPdf'));
const OldSalarySlipToNewExcel = lazy(() => import('./pages/finance-tools/salary-slip/OldSalarySlipToNewExcel'));
const BonusSalarySlipBreakdown = lazy(() => import('./pages/finance-tools/salary-slip/BonusSalarySlipBreakdown'));
const GovernmentSalarySlipPdfToExcel = lazy(() => import('./pages/finance-tools/salary-slip/GovernmentSalarySlipPdfToExcel'));
const PrivateCompanySalarySlipPdfToExcel = lazy(() => import('./pages/finance-tools/salary-slip/PrivateCompanySalarySlipPdfToExcel'));
const SalarySlipBatchToYearlyReport = lazy(() => import('./pages/finance-tools/salary-slip/SalarySlipBatchToYearlyReport'));
const SalarySlipPdfToCSVTransactions = lazy(() => import('./pages/finance-tools/salary-slip/SalarySlipPdfToCSVTransactions'));
const SalarySlipHRAExemptionExcel = lazy(() => import('./pages/finance-tools/salary-slip/SalarySlipHRAExemptionExcel'));
const Form16PartABPdfToExcel = lazy(() => import('./pages/finance-tools/form16/Form16PartABPdfToExcel'));
const Form16PdfToITRInputExcel = lazy(() => import('./pages/finance-tools/form16/Form16PdfToITRInputExcel'));
const Form16MultipleYearsToTaxHistory = lazy(() => import('./pages/finance-tools/form16/Form16MultipleYearsToTaxHistory'));

// Market Tools
const JewelleryPriceEstimator = lazy(() => import('./pages/market/JewelleryPriceEstimator'));
const SalarySlipAndForm16ToExcel = lazy(() => import('./pages/finance-tools/form16/SalarySlipAndForm16ToExcel'));
const ExcelSalaryDataToPayslipPdf = lazy(() => import('./pages/finance-tools/salary-slip/ExcelSalaryDataToPayslipPdf'));
const Form16ToolsSuite = lazy(() => import('./pages/finance-tools/form16/Form16ToolsSuite'));
const BankStatementPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/BankStatementPdfToExcel'));
const HDFCSBIAxisStatementPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/HDFCSBIAxisStatementPdfToExcel'));
const MultipleBankStatementsToConsolidatedExcel = lazy(() => import('./pages/finance-tools/bank-statement/MultipleBankStatementsToConsolidatedExcel'));
const BankStatementPdfToCSV = lazy(() => import('./pages/finance-tools/bank-statement/BankStatementPdfToCSV'));
const CreditCardStatementPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/CreditCardStatementPdfToExcel'));
const ICICIKotakCreditCardPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/ICICIKotakCreditCardPdfToExcel'));
const BankStatementUPIPdfToCategoryExcel = lazy(() => import('./pages/finance-tools/bank-statement/BankStatementUPIPdfToCategoryExcel'));
const OldBankPassbookPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/OldBankPassbookPdfToExcel'));
const BankStatementPdfToMonthlySummary = lazy(() => import('./pages/finance-tools/bank-statement/BankStatementPdfToMonthlySummary'));
const CreditCardRewardPointsPdfToExcel = lazy(() => import('./pages/finance-tools/bank-statement/CreditCardRewardPointsPdfToExcel'));
...
const GKHub = lazy(() => import('./pages/gk/GKHub'));
const GKCategoryPage = lazy(() => import('./pages/gk/GKCategoryPage'));
...
const GramToTolaConverter = lazy(() => import('./calculators/GramToTolaConverter'));
...
const ComparisonGuide = lazy(() => import('./pages/insurance/ComparisonGuide'));
...
const UltimateTaxGuide = lazy(() => import('./pages/learn/taxation/UltimateTaxGuide'));
...
const CreditCardCertificate = lazy(() => import('./pages/learn/credit-cards/Certificate'));
...
const AdSenseVerification = lazy(() => import('./pages/AdSenseVerification'));
const MoneycalGK = lazy(() => import('./pages/MoneycalGK'));
...
const StepUpSipCalculator = lazy(() =>
  import('./calculators/StepUpSipCalculator').then((m) => ({ default: m.StepUpSipCalculator }))
);
const TaxSaverWizard = lazy(() =>
  import('./calculators/TaxSaverWizard').then((m) => ({ default: m.TaxSaverWizard }))
);
...
const LoanComparisonCalculator = lazy(() =>
  import('./calculators/LoanComparisonCalculator').then((m) => ({ default: m.LoanComparisonCalculator }))
);
const LoanPrepaymentCalculator = lazy(() =>
  import('./calculators/LoanPrepaymentCalculator').then((m) => ({ default: m.LoanPrepaymentCalculator }))
);
...
const StampDutyCalculator = lazy(() => import('./calculators/StampDutyCalculator').then((m) => ({ default: m.StampDutyCalculator })));
const CapitalGainsTaxCalculator = lazy(() => import('./calculators/CapitalGainsTaxCalculator').then((m) => ({ default: m.CapitalGainsTaxCalculator })));
const GratuityCalculator = lazy(() => import('./calculators/GratuityCalculator').then((m) => ({ default: m.GratuityCalculator })));
const DaArrearsCalculator = lazy(() => import('./calculators/DaArrearsCalculator').then((m) => ({ default: m.DaArrearsCalculator })));
...
const FdCalculator = lazy(() => import('./calculators/FdCalculator').then((m) => ({ default: m.FdCalculator })));
const RdCalculator = lazy(() => import('./calculators/RdCalculator').then((m) => ({ default: m.RdCalculator })));
...
const StrategicHub2026 = lazy(() => import('./pages/learn/StrategicHub2026'));
const NotFound404 = lazy(() => import('./pages/NotFound404'));

// Games
const GamesHub = lazy(() => import('./pages/games/GamesHub'));
const BudgetChallenge = lazy(() => import('./pages/games/BudgetChallenge'));
const StockSimulator = lazy(() => import('./pages/games/StockSimulator'));
const MillionaireQuiz = lazy(() => import('./pages/games/MillionaireQuiz'));
const FinanceWordle = lazy(() => import('./pages/games/FinanceWordle'));
const CompoundRace = lazy(() => import('./pages/games/CompoundRace'));
...
function App() {
  ...
  useEffect(() => {
    ...
    const hasDuplicateDomain = currentPath.toLowerCase().includes('/moneycal.in');
    const hasTrailingSlash = currentPath !== '/' && currentPath.endsWith('/');

    if (hasDuplicateDomain || hasTrailingSlash) {
      let cleanedPath = currentPath;
      
      // Normalize accidental duplicated host segment path
      if (hasDuplicateDomain) {
        while (cleanedPath.toLowerCase().includes('/moneycal.in')) {
          cleanedPath = cleanedPath.replace(/\/moneycal\.in(?=\/|$)/gi, '');
        }
      }
      ...
      if (cleanedPath !== currentPath) {
        const nextUrl = `${cleanedPath}${location.search || ''}${location.hash || ''}`;
        // Use navigate with replace: true for smoother UX and to avoid full-page reload loops 
        // that reset animations (fixing the "faded content" issue).
  ...
  useEffect(() => {
    // Defer non-critical init to reduce TBT and avoid long main-thread tasks
    const runDeferred = () => {
    ...
    const id = useIdle
      ...
      : window.setTimeout(runDeferred, 100);
    const cleanup = () => {
    ...
    const isBlockedClientLikely = () => {
      // Respect privacy signals and skip ad script injection when blockers are likely active.
    ...
    const loadAds = () => {
      ...
      if (!document.querySelector('meta[name="google-adsense-account"]')) {
        ...
        adsenseMeta.content = 'ca-pub-6815277662449747';
  ...
  useEffect(() => {
    const normalizePath = (input: string) => {
      try {
        const parsed = input.startsWith('http') ? new URL(input) : new URL(`https://moneycal.in${input}`);
    ...
    const timeoutId = window.setTimeout(() => {
      ...
      const seoSource = (document.querySelector('meta[name="mc:seo-source"]') as HTMLMetaElement | null)?.content || '';
      const sourcePath = seoSource ? normalizePath(seoSource) : '';

      // Skip fallback if a page-level SEO component already applied tags for this route.
      if (sourcePath === currentPath) return;

      const pageName = humanizePath(currentPath);
      const section = currentPath.split('/').filter(Boolean)[0] || 'home';
      const sectionLabel = section.replace(/-/g, ' ');
      const lowQualityOrOffTopicPath = [
        '/astro-finance',
        '/gk',
        '/fun-engagement',
        '/backlink-building',
      ...
      const title = currentPath === '/'
        ? 'MoneyCal India - Free Financial Calculators & Tools'
        : `${pageName} - ${sectionLabel} | MoneyCal India`;
      const description = currentPath === '/'
        ? 'Free financial calculators, finance tools, and learning resources for India.'
        : `Use MoneyCal India's ${pageName.toLowerCase()} page for practical ${sectionLabel} guidance and tools.`;

      document.title = title;
      setMeta('description', description);
      setMeta(
        'robots',
        lowQualityOrOffTopicPath
          ? 'noindex, follow'
          : 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1'
      );
      setMeta('mc:seo', 'fallback');
      ...
      canonical.setAttribute('href', `https://moneycal.in${currentPath === '/' ? '/' : currentPath}`);
    }, 80);

    return () => window.clearTimeout(timeoutId);
  }, [location.pathname]);

  // Layout-stable skeleton: match hero height (~480px) to minimize CLS when Home loads
  const skeletonFallback = (
    <div className="min-h-[480px] w-full max-w-6xl mx-auto px-4 py-10" aria-hidden="true">
      <div className="skeleton h-3 w-48 mx-auto mb-4 rounded" />
      <div className="skeleton h-9 w-3/4 max-w-2xl mx-auto mb-4 rounded" />
      <div className="skeleton h-4 w-full max-w-xl mx-auto mb-2 rounded" />
      <div className="skeleton h-4 w-full max-w-2xl mx-auto mb-2 rounded" />
      <div className="skeleton h-24 w-full max-w-3xl mx-auto mt-8 rounded-2xl" />
    </div>
  );
  const fullPageSkeleton = (
    <div className="min-h-screen flex flex-col bg-white">
      <div className="h-16 flex-shrink-0 bg-white border-b border-gray-100" aria-hidden="true" />
      <div className="flex-1 pt-6">{skeletonFallback}</div>
    </div>
  );
    ...
    <GlobalErrorBoundary>
      ...
      <Suspense fallback={fullPageSkeleton}>
        <Routes>
          ...
          <Route path="/gk/category/:categorySlug" element={<Layout><GKCategoryPage /></Layout>} />
          ...
          {/* Standalone Discover Article Route (No Layout) */}
          <Route path="/discover/:slug" element={<Suspense fallback={skeletonFallback}><UniversalArticleDispatcher /></Suspense>} />

          {/* Blog Routes - Explicit high-level matching to avoid Layout catch-all conflicts */}
          <Route path="/blog" element={<Layout><Suspense fallback={skeletonFallback}><Blog /></Suspense></Layout>} />
          <Route path="/blog/category/:category" element={<Layout><Suspense fallback={skeletonFallback}><BlogCategory /></Suspense></Layout>} />
          <Route path="/blog/:slug" element={<Layout><Suspense fallback={skeletonFallback}><UniversalArticleDispatcher /></Suspense></Layout>} />
          <Route path="/blog/write" element={<Layout><Suspense fallback={skeletonFallback}><WriteBlog /></Suspense></Layout>} />
          <Route path="/blog/category/banking" element={<Layout><Suspense fallback={skeletonFallback}><BankingKnowledge /></Suspense></Layout>} />
            ...
            <Layout>
              ...
              <Suspense fallback={skeletonFallback}>
                <Routes>
                  ...
                  <Route path="/finance-gpt" element={<FinanceGPT />} />
                  ...
                  <Route path="/calculators/gram-to-tola-converter" element={<GramToTolaConverter />} />
                  ...
                  {/* Blog routes moved to top level for better matching */}

                  {/* Learn Platform - Main Hub */}
                  <Route path="/learn" element={<LearnHome />} />

                  {/* Browse All Pages hub to reduce orphan pages */}
                  <Route path="/browse-all" element={<BrowseAll />} />

                  {/* Category Path Redirects for SEO and User Convenience */}
                  <Route path="/learn/savings-bank" element={<Navigate to="/learn/savings-bank-products" replace />} />
                  <Route path="/learn/investing" element={<Navigate to="/learn/investing-wealth" replace />} />
                  <Route path="/learn/wealth" element={<Navigate to="/learn/investing-wealth" replace />} />
                  <Route path="/learn/insurance" element={<Navigate to="/learn/insurance-retirement" replace />} />
                  <Route path="/learn/retirement" element={<Navigate to="/learn/insurance-retirement" replace />} />
                  <Route path="/learn/taxation" element={<Navigate to="/learn/taxation-compliance" replace />} />
                  <Route path="/learn/tax" element={<Navigate to="/learn/taxation-compliance" replace />} />
                  <Route path="/learn/compliance" element={<Navigate to="/learn/taxation-compliance" replace />} />
                  <Route path="/learn/fintech" element={<Navigate to="/learn/fintech-digital-payments" replace />} />
                  <Route path="/learn/digital-payments" element={<Navigate to="/learn/fintech-digital-payments" replace />} />
                  <Route path="/learn/business" element={<Navigate to="/learn/business-finance-entrepreneurship" replace />} />
                  <Route path="/learn/startup" element={<Navigate to="/learn/business-finance-entrepreneurship" replace />} />
                  <Route path="/learn/advanced" element={<Navigate to="/learn/advanced-specialised-finance" replace />} />
                  <Route path="/learn/specialised-finance" element={<Navigate to="/learn/advanced-specialised-finance" replace />} />
                  <Route path="/learn/behavioural-finance" element={<Navigate to="/learn/behavioural-finance-money-psychology" replace />} />
                  <Route path="/learn/money-psychology" element={<Navigate to="/learn/behavioural-finance-money-psychology" replace />} />
                  <Route path="/learn/budgeting" element={<Navigate to="/learn/money-management" replace />} />
                  ...
                  <Route path="/learn/taxation/ultimate-tax-guide" element={<UltimateTaxGuide />} />
                  ...
                  <Route path="/learn/taxation-compliance/tax-planning-strategies-minimize-tax-liability-legally-india" element={<TaxPlanningStrategies />} />
                  ...
                  <Route path="/learn/money-management/cash-flow-net-worth-assets-vs-liabilities-india" element={<CashFlowNetWorth />} />
                  <Route path="/learn/money-management/financial-habits-saving-first-spending-later-discipline" element={<FinancialHabits />} />
                  ...
                  <Route path="/learn/loans/emi-calculator-complete-guide-india" element={<EMICalculatorCompleteGuide />} />
                  ...
                  {/* Learn Platform - Home Loans (20 lessons) */}
                  ...
                  {/* Learn Platform - Personal Loans (20 lessons) */}
                  ...
                  {/* Learn Platform - Vehicle Loans (15 lessons) */}
                  ...
                  {/* Learn Platform - Education Loans (10 lessons) */}
                  ...
                  {/* Learn Platform - Business Loans (15 lessons) */}
                  ...
                  {/* Learn Platform - Gold Loans (10 lessons) */}
                  ...
                  {/* Learn Platform - Credit Cards (20 lessons) */}
                  ...
                  <Route path="/learn/credit-cards/certificate" element={<CreditCardCertificate />} />
                  ...
                  {/* Learn Platform - Credit Score (10 lessons) */}
                  ...
                  <Route path="/ipo/list/:type" element={<IpoTargetPage />} />
                  <Route path="/ipo/:slug" element={<IpoDetail />} />

                  <Route path="/stock-market-hub" element={<StockMarketHub />} />

                  {/* Market Rates Section */}
                  <Route path="/gold-rate" element={<MarketRatesHub />} />
                  <Route path="/silver-rate" element={<MarketRatesHub />} />

                  <Route path="/gold-tools/jewellery-price-estimator" element={<JewelleryPriceEstimator />} />
                  ...
                  <Route path="/news/:categorySlug/:slug" element={<UniversalArticleDispatcher />} />
                  ...
                  <Route path="/calculators/gratuity-calculator" element={<GratuityCalculator />} />
                  <Route path="/calculators/da-arrears-calculator" element={<DaArrearsCalculator />} />
                  <Route path="/calculators/salary-slip-generator" element={<SalarySlipGenerator />} />
                  <Route path="/calculators/ctc-calculator" element={<CtcCalculator />} />
                  <Route path="/calculators/8th-pay-commission-calculator" element={<EighthPayCommissionCalculator />} />
                  ...
                  <Route path="/calculators/tax-strategy-wizard" element={<TaxSaverWizard />} />
                  ...
                  {/* Programmatic SEO routes Master Dispatcher */}
                  <Route path="/calculators/:slug" element={<ProgrammaticMasterDispatcher />} />
                  <Route path="/series/corporate-wealth-masterclass" element={<CorporateMasterclass />} />
                  <Route path="/series/corporate-wealth-masterclass/:slug" element={<MasterclassLesson />} />

                  <Route path="/excel-tools" element={<ExcelToolsPage />} />
                  <Route path="/excel-tools/:slug" element={<ExcelToolDetail />} />
                  <Route path="/government-schemes" element={<GovernmentSchemes />} />
                  <Route path="/government-schemes/category/:categorySlug" element={<GovernmentSchemeCategoryPage />} />
                  <Route path="/government-schemes/:slug" element={<GovernmentSchemePost />} />
                  <Route path="/msme-subsidies/:slug" element={<SiloPost />} />
                  <Route path="/land-records/:slug" element={<SiloPost />} />
                  <Route path="/scholarships/:slug" element={<SiloPost />} />
                  <Route path="/youth-banking/:slug" element={<SiloPost />} />
                  <Route path="/taxation-2026/:slug" element={<SiloPost />} />
                  <Route path="/scam-diagnostics/:slug" element={<SiloPost />} />
                  <Route path="/trading-terminals/:slug" element={<SiloPost />} />
                  <Route path="/macro-trends/:slug" element={<SiloPost />} />
                  <Route path="/insurance-niche/:slug" element={<SiloPost />} />
                  <Route path="/stamp-duty/state/:state" element={<StateStampDutyGuide />} />
                  ...
                  <Route path="/crypto/:slug" element={<UniversalArticleDispatcher />} />
                  {/* AstroFinance route */}
                  ...
                  <Route path="/tax-simplifier" element={<TaxSimplifier />} />
                  <Route path="/2026-financial-strategy" element={<StrategicHub2026 />} />
                  <Route path="/sip-simplifier" element={<SIPSimplifier />} />
                  <Route path="/emi-simplifier" element={<EMISimplifier />} />
                  <Route path="/finance-tools" element={<FinanceTools />} />
                  <Route path="/finance-tools/pdf-converters" element={<PDFConvertersHub />} />
                  <Route path="/finance-tools/pdf-converters/form16-suite" element={<Form16ToolsSuite />} />
                  <Route path="/finance-tools/pdf-converters/salary-slip-pdf-to-excel" element={<SalarySlipPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/multiple-salary-slips-to-yearly-excel" element={<MultipleSalarySlipsToYearlyExcel />} />
                  <Route path="/finance-tools/pdf-converters/salary-slip-pdf-to-clean-pdf" element={<SalarySlipPdfToCleanPdf />} />
                  <Route path="/finance-tools/pdf-converters/old-salary-slip-to-new-excel" element={<OldSalarySlipToNewExcel />} />
                  <Route path="/finance-tools/pdf-converters/bonus-salary-slip-breakdown" element={<BonusSalarySlipBreakdown />} />
                  <Route path="/finance-tools/pdf-converters/government-salary-slip-pdf-to-excel" element={<GovernmentSalarySlipPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/private-company-salary-slip-pdf-to-excel" element={<PrivateCompanySalarySlipPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/batch-salary-slips-to-yearly-report" element={<SalarySlipBatchToYearlyReport />} />
                  <Route path="/finance-tools/pdf-converters/salary-slip-pdf-to-csv-transaction" element={<SalarySlipPdfToCSVTransactions />} />
                  <Route path="/finance-tools/pdf-converters/salary-slip-hra-to-exemption-excel" element={<SalarySlipHRAExemptionExcel />} />
                  <Route path="/finance-tools/pdf-converters/form16-part-ab-pdf-to-excel" element={<Form16PartABPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/form16-pdf-to-itr-input-excel" element={<Form16PdfToITRInputExcel />} />
                  <Route path="/finance-tools/pdf-converters/form16-multiple-years-to-tax-history" element={<Form16MultipleYearsToTaxHistory />} />
                  <Route path="/finance-tools/pdf-converters/salary-slip-plus-form16-to-excel" element={<SalarySlipAndForm16ToExcel />} />
                  <Route path="/finance-tools/pdf-converters/excel-salary-data-to-payslip-pdf" element={<ExcelSalaryDataToPayslipPdf />} />
                  <Route path="/finance-tools/pdf-converters/bank-statement-pdf-to-excel" element={<BankStatementPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/hdfc-sbi-axis-statement-pdf-to-excel" element={<HDFCSBIAxisStatementPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/multiple-bank-statements-to-consolidated-excel" element={<MultipleBankStatementsToConsolidatedExcel />} />
                  <Route path="/finance-tools/pdf-converters/bank-statement-pdf-to-csv" element={<BankStatementPdfToCSV />} />
                  <Route path="/finance-tools/pdf-converters/credit-card-statement-pdf-to-excel" element={<CreditCardStatementPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/icici-kotak-credit-card-pdf-to-excel" element={<ICICIKotakCreditCardPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/bank-statement-upi-pdf-to-category-excel" element={<BankStatementUPIPdfToCategoryExcel />} />
                  <Route path="/finance-tools/pdf-converters/old-bank-passbook-pdf-to-excel" element={<OldBankPassbookPdfToExcel />} />
                  <Route path="/finance-tools/pdf-converters/bank-statement-pdf-to-monthly-summary-excel" element={<BankStatementPdfToMonthlySummary />} />
                  <Route path="/finance-tools/pdf-converters/credit-card-reward-points-pdf-to-excel" element={<CreditCardRewardPointsPdfToExcel />} />
                  ...
                  {/* Excel Tool Hub route - Redirected above */}
                  ...
                  <Route path="/tools/marketing/poster-maker" element={<PosterMaker />} />
                  <Route path="/tools/marketing/sip-delay-visualizer" element={<SIPDelayVisualizer />} />
                  <Route path="/tools/marketing/loan-savings-visualizer" element={<LoanSavingsVisualizer />} />
                  <Route path="/tools/marketing/email-signature-generator" element={<EmailSignatureGenerator />} />
                  <Route path="/tools/marketing/roi-comparison-designer" element={<ROIComparisonDesigner />} />
                  <Route path="/tools/marketing/tax-bucket-visualizer" element={<TaxBucketVisualizer />} />
                  <Route path="/tools/marketing/investment-risk-profiler" element={<InvestmentRiskProfiler />} />
                  <Route path="/tools/marketing/education-cost-visualizer" element={<EducationCostVisualizer />} />
                  <Route path="/tools/marketing/retirement-scorecard" element={<RetirementScorecard />} />
                  <Route path="/tools/marketing/referral-message-builder" element={<ReferralMessageBuilder />} />
                  <Route path="/tools/promo-designer" element={<PromoDesigner />} />
                  <Route path="/promo-designer" element={<Navigate to="/tools/promo-designer" replace />} />
                  ...
                  <Route path="/festival-info/:slug" element={<FestivalInformationHistory />} />
                ...
                <Route path="/seo-tools/adsense-verification" element={<AdSenseVerification />} />
                  ...
                  <Route path="/insurance/compare/:slug" element={<ComparisonGuide />} />
                  <Route path="/insurance/guide/:slug" element={<ComparisonGuide />} />
                  ...
                  <Route path="/tools/gst-slab-finder" element={<GSTSlabFinder />} />
                  <Route path="/gst-tools/gst-einvoice-qr-validator" element={<GSTEInvoiceQRValidator />} />
                  <Route path="/tools/gst-einvoice-qr-validator" element={<GSTEInvoiceQRValidator />} />
                  ...
                  <Route path="/tools/gst-eway-distance-calculator" element={<GSTEWayDistanceCalculator />} />
                  <Route path="/gst-tools/gst-turnover-tracker" element={<GSTTurnoverTracker />} />
                  <Route path="/tools/gst-turnover-tracker" element={<GSTTurnoverTracker />} />
                  <Route path="/gst-tools/gst-rate-impact-analyzer" element={<GSTRateImpactAnalyzer />} />
                  <Route path="/tools/gst-rate-impact-analyzer" element={<GSTRateImpactAnalyzer />} />
                  ...
                  <Route path="/tools/composition-scheme-eligibility-checker" element={<CompositionSchemeCheckerPage />} />
                  ...
                  <Route path="/tools/gst-refund-eligibility-checker" element={<GSTRefundCheckerPage />} />
                  ...
                  <Route path="/games/budget-challenge" element={<BudgetChallenge />} />
                  <Route path="/games/stock-simulator" element={<StockSimulator />} />
                  <Route path="/games/millionaire-quiz" element={<MillionaireQuiz />} />
                  <Route path="/games/finance-wordle" element={<FinanceWordle />} />
                  <Route path="/games/compound-race" element={<CompoundRace />} />

                  {/* Standardized Article 2-part greedy route (Economy, SIP, etc.) */}
                  <Route path="/:category/:slug" element={<UniversalArticleDispatcher />} />

                  {/* Market Rates or News Category 1-part greedy route */}
                  <Route path="/:slug" element={<NewsCategoryDispatcher />} />
