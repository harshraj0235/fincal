...
const FlexiSIPPlanner = lazy(() => import('./pages/finance-tools/FlexiSIPPlanner'));
const SIPTrackerWithGoalThermometer = lazy(() => import('./pages/finance-tools/SIPTrackerWithGoalThermometer'));
const SIPReturnDeviationChart = lazy(() => import('./pages/finance-tools/SIPReturnDeviationChart'));
...
const MutualFundStarRatingsExplorer = lazy(() => import('./pages/finance-tools/MutualFundStarRatingsExplorer'));
const MutualFundOverlapChecker = lazy(() => import('./pages/finance-tools/MutualFundOverlapChecker'));
const MutualFundHistoricalNAVVisualizer = lazy(() => import('./pages/finance-tools/MutualFundHistoricalNAVVisualizer'));
const MutualFundTracker = lazy(() => import('./pages/finance-tools/MutualFundTracker'));
const ETFVsMutualFundComparison = lazy(() => import('./pages/finance-tools/ETFVsMutualFundComparison'));
...
const PortfolioRebalancingReminderTool = lazy(() => import('./pages/finance-tools/PortfolioRebalancingReminderTool'));
const InvestmentTimelineVisualizer = lazy(() => import('./pages/finance-tools/InvestmentTimelineVisualizer'));
const FiveYCAGRVsVolatilityAnalyzer = lazy(() => import('./pages/finance-tools/FiveYCAGRVsVolatilityAnalyzer'));
const InvestmentGoalCountdownWidget = lazy(() => import('./pages/finance-tools/InvestmentGoalCountdownWidget'));
const ELSSVsPPFReturnVisualizer = lazy(() => import('./pages/finance-tools/ELSSVsPPFReturnVisualizer'));
const GoldVsEquityTenYearReturnComparator = lazy(() => import('./pages/finance-tools/GoldVsEquityTenYearReturnComparator'));
const CryptoVsEquityInvestmentRiskTool = lazy(() => import('./pages/finance-tools/CryptoVsEquityInvestmentRiskTool'));
const REITsVsFDROIVisualizer = lazy(() => import('./pages/finance-tools/REITsVsFDROIVisualizer'));
const LongTermCapitalGainsEstimator = lazy(() => import('./pages/finance-tools/LongTermCapitalGainsEstimator'));
const StockSplitAdjustedROICalculator = lazy(() => import('./pages/finance-tools/StockSplitAdjustedROICalculator'));
const ExpenseRatioImpactVisualTool = lazy(() => import('./pages/finance-tools/ExpenseRatioImpactVisualTool'));
const GoalBasedInvestmentAllocator = lazy(() => import('./pages/finance-tools/GoalBasedInvestmentAllocator'));
const NPSVsPPFComparison = lazy(() => import('./pages/finance-tools/NPSVsPPFComparison'));
const RealEstateVsStockROITool = lazy(() => import('./pages/finance-tools/RealEstateVsStockROITool'));
const MonthlyPassiveIncomeCalculator = lazy(() => import('./pages/finance-tools/MonthlyPassiveIncomeCalculator'));
const ShareholdingPatternVisualizer = lazy(() => import('./pages/finance-tools/ShareholdingPatternVisualizer'));
const TopSectorAllocationAnalyzer = lazy(() => import('./pages/finance-tools/TopSectorAllocationAnalyzer'));
const AMCFeeAnalyzerTool = lazy(() => import('./pages/finance-tools/AMCFeeAnalyzerTool'));
const SimpleStockValuationTool = lazy(() => import('./pages/finance-tools/SimpleStockValuationTool'));
const ULIPVsTermInsuranceReturnCalculator = lazy(() => import('./pages/finance-tools/ULIPVsTermInsuranceReturnCalculator'));
const GoldSIPVsGoldETFReturnVisualizer = lazy(() => import('./pages/finance-tools/GoldSIPVsGoldETFReturnVisualizer'));
                ...
                <Route path="/astro-finance" element={<AstroFinance />} />
                 ...
                 <Route path="/stock-market" element={<StockMarket />} />
                  ...
                  <Route path="/tax-tools" element={<TaxToolsHub />} />
                   ...
                   <Route path="/finance-tools/flexi-sip-planner" element={<FlexiSIPPlanner />} />
                   <Route path="/finance-tools/sip-tracker-with-goal-thermometer" element={<SIPTrackerWithGoalThermometer />} />
                   <Route path="/finance-tools/sip-return-deviation-chart" element={<SIPReturnDeviationChart />} />
                   ...
                   <Route path="/finance-tools/mutual-fund-star-ratings-explorer" element={<MutualFundStarRatingsExplorer />} />
                   <Route path="/finance-tools/mutual-fund-overlap-checker" element={<MutualFundOverlapChecker />} />
                   <Route path="/finance-tools/mutual-fund-historical-nav-visualizer" element={<MutualFundHistoricalNAVVisualizer />} />
                   <Route path="/finance-tools/mutual-fund-tracker" element={<MutualFundTracker />} />
                   <Route path="/finance-tools/etf-vs-mutual-fund-comparison" element={<ETFVsMutualFundComparison />} />
                   ...
                   <Route path="/finance-tools/portfolio-rebalancing-reminder-tool" element={<PortfolioRebalancingReminderTool />} />
                   <Route path="/finance-tools/investment-timeline-visualizer" element={<InvestmentTimelineVisualizer />} />
                   <Route path="/finance-tools/5y-cagr-vs-volatility-analyzer" element={<FiveYCAGRVsVolatilityAnalyzer />} />
                   <Route path="/finance-tools/investment-goal-countdown-widget" element={<InvestmentGoalCountdownWidget />} />
                   <Route path="/finance-tools/elss-vs-ppf-return-visualizer" element={<ELSSVsPPFReturnVisualizer />} />
                   <Route path="/finance-tools/gold-vs-equity-10-year-return-comparator" element={<GoldVsEquityTenYearReturnComparator />} />
                   <Route path="/finance-tools/crypto-vs-equity-investment-risk-tool" element={<CryptoVsEquityInvestmentRiskTool />} />
                   <Route path="/finance-tools/reits-vs-fd-roi-visualizer" element={<REITsVsFDROIVisualizer />} />
                   <Route path="/finance-tools/long-term-capital-gains-estimator" element={<LongTermCapitalGainsEstimator />} />
                   <Route path="/finance-tools/stock-split-adjusted-roi-calculator" element={<StockSplitAdjustedROICalculator />} />
                   <Route path="/finance-tools/expense-ratio-impact-visual-tool" element={<ExpenseRatioImpactVisualTool />} />
                   <Route path="/finance-tools/goal-based-investment-allocator" element={<GoalBasedInvestmentAllocator />} />
                   <Route path="/finance-tools/nps-vs-ppf-comparison" element={<NPSVsPPFComparison />} />
                   <Route path="/finance-tools/real-estate-vs-stock-roi-tool" element={<RealEstateVsStockROITool />} />
                   <Route path="/finance-tools/monthly-passive-income-calculator" element={<MonthlyPassiveIncomeCalculator />} />
                   <Route path="/finance-tools/shareholding-pattern-visualizer" element={<ShareholdingPatternVisualizer />} />
                   <Route path="/finance-tools/top-sector-allocation-analyzer" element={<TopSectorAllocationAnalyzer />} />
                   <Route path="/finance-tools/amc-fee-analyzer-tool" element={<AMCFeeAnalyzerTool />} />
                   <Route path="/finance-tools/simple-stock-valuation-tool" element={<SimpleStockValuationTool />} />
                   <Route path="/finance-tools/ulip-vs-term-insurance-return-calculator" element={<ULIPVsTermInsuranceReturnCalculator />} />
                   <Route path="/finance-tools/gold-sip-vs-gold-etf-return-visualizer" element={<GoldSIPVsGoldETFReturnVisualizer />} />
