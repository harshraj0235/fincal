...
import { X, ChevronRight, FileText, Map, Shield, IndianRupee, PhoneCall } from 'lucide-react';
...
export const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, onClose }) => {
  ...
  const handleCalculatorClick = (calculatorId: string) => {
    navigate.push(`/calculators/${calculatorId}`);
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex justify-end">
      ...
      >
        ...
        <nav className="p-4 space-y-1">
          ...
          <Link 
            href="/missed-call-banking-directory" 
            className="block py-3 px-4 text-gray-900 hover:bg-gray-50 rounded-xl transition-colors touch-manipulation flex items-center"
            onClick={onClose}
          >
