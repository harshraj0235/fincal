...
import { IndianRupee, ArrowUp, Mail, Globe, Shield, Star, TrendingUp, Clock } from "lucide-react";
...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'Globe / X', icon: Globe, href: 'https://twitter.com/MoneyCalIN' },
    { name: 'LinkedIn', icon: Globe, href: 'https://linkedin.com/company/moneycal' },
  ];
        ...
        <div className="mb-14">
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="lg:w-72 flex-shrink-0">
              <Link href="/" className="flex items-center space-x-3 mb-5" aria-label="MoneyCal.in Home">
