...
export const Footer: React.FC = () => {
  ...
  // Reserve exact space for footer to prevent layout shift
  const footerHeight = '650px';
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden" style={{ minHeight: footerHeight, height: footerHeight, contain: 'layout style paint' }}>
      {/* Background Pattern */}
