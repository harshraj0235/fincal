...
import { Share2, Globe, Link as LinkIcon, MessageSquare, Heart, Bookmark } from "lucide-react";
...
const StickyShareBar: React.FC<StickyShareBarProps> = ({ url, title }) => {
  const shareLinks = [
    { icon: Globe, plat: 'facebook', color: 'hover:text-blue-600 hover:bg-blue-50' },
    { icon: Globe, plat: 'twitter', color: 'hover:text-sky-500 hover:bg-sky-50' },
