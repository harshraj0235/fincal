...
import { Share2, Globe, MessageCircle, Heart, Eye, Users, TrendingUp, Calendar } from "lucide-react";
...
const SocialMediaHub: React.FC = () => {
  ...
  const platforms = [
    { name: 'Globe', icon: Globe, color: 'text-blue-600', bgColor: 'bg-blue-50' },
    { name: 'Globe', icon: Globe, color: 'text-blue-400', bgColor: 'bg-blue-50' },
    { name: 'LinkedIn', icon: Globe, color: 'text-blue-700', bgColor: 'bg-blue-50' },
    { name: 'Globe', icon: Globe, color: 'text-pink-600', bgColor: 'bg-pink-50' },
    { name: 'YouTube', icon: Globe, color: 'text-red-600', bgColor: 'bg-red-50' }
  ];
