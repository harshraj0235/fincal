...
const GlobalSearch: React.FC = () => {
  ...
  const searchData: SearchResult[] = [
    ...
    // Excel Tools
    { id: 'excel-tools', title: 'Excel Tools', description: 'Excel templates, formulas, and financial tools', type: 'page', url: '/excel-tools-page', category: 'Excel Tools', icon: <Building className="w-5 h-5" />, tags: ['excel', 'templates', 'formulas', 'spreadsheet tools'] },
    ...
    // Invoicing Tools
    { id: 'invoicing-tools', title: 'Invoicing Tools', description: 'Invoice generation and receivables management', type: 'page', url: '/invoice-generator-business', category: 'Invoicing Tools', icon: <FileText className="w-5 h-5" />, tags: ['invoicing', 'invoice generator', 'receivables', 'business tools'] },
