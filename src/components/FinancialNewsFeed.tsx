...
import { Newspaper, TrendingUp, TrendingDown, Clock, ExternalLink, Bookmark, Share2, Eye, Tag, Calendar, Globe, AlertCircle, CheckCircle, Info, RefreshCw } from "lucide-react";
