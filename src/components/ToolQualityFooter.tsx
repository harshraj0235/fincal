          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-5">
              ...
              <div className="space-y-2">
                <Link href="/calculators" className="flex items-center justify-between text-sm font-semibold text-blue-700">
                  Browse calculators
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/tools" className="flex items-center justify-between text-sm font-semibold text-blue-700">
                  Explore all tools
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/learn" className="flex items-center justify-between text-sm font-semibold text-blue-700">
