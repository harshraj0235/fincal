                  ...
                  >
                    ...
                    <div className="space-y-3 text-left mb-8">
                      {totalScore < 80 && answers['emergency'] < 15 && (
                        <Link href="/calculators/fd-calculator" className="flex items-center gap-3 p-4 rounded-xl bg-amber-50 border border-amber-100 hover:bg-amber-100 transition-colors group">
                      ...
                      {answers['investment'] < 15 && (
                        <Link href="/calculators/sip-calculator" className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 border border-blue-100 hover:bg-blue-100 transition-colors group">
                      ...
                      {answers['taxplan'] < 15 && (
                        <Link href="/learn/taxation/ultimate-tax-guide" className="flex items-center gap-3 p-4 rounded-xl bg-indigo-50 border border-indigo-100 hover:bg-indigo-100 transition-colors group">
                      ...
                      {totalScore >= 80 && (
                        <Link href="/calculators/retirement-calculator" className="flex items-center gap-3 p-4 rounded-xl bg-emerald-50 border border-emerald-100 hover:bg-emerald-100 transition-colors group">
