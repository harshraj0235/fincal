...
const MarketWatchlist: React.FC<MarketWatchlistProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    const savedWatchlist = (typeof window !== 'undefined' ? window.localStorage : { getItem: () => null, setItem: () => {}, removeItem: () => {} }).getItem('marketWatchlist');
    if (savedWatchlist) {
  ...
  useEffect(() => {
    ...
    (typeof window !== 'undefined' ? window.localStorage : { getItem: () => null, setItem: () => {}, removeItem: () => {} }).setItem('marketWatchlist', JSON.stringify(watchlist));
  }, [watchlist]);
