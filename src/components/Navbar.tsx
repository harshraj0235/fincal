            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-72 bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-all duration-200 z-50">
                  <div className="p-3 grid grid-cols-1 gap-1">
                    <Link href="/learn/investing-wealth" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 rounded-lg transition-colors">
                      <TrendingUp className="w-4 h-4 mr-3 text-emerald-600" />
                      Investing Basics
                    </Link>
                    <Link href="/learn" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 rounded-lg transition-colors">
                      <Banknote className="w-4 h-4 mr-3 text-blue-600" />
                      Loan Guides
                    </Link>
                    <Link href="/learn/taxation-compliance" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 rounded-lg transition-colors">
                      <Percent className="w-4 h-4 mr-3 text-orange-600" />
                      Taxation & Savings
                    </Link>
                    <Link href="/learn/money-management" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 rounded-lg transition-colors">
                      <Wallet className="w-4 h-4 mr-3 text-purple-600" />
                      Money Management
                    </Link>
                    <div className="border-t border-gray-100 my-1"></div>
                    <Link href="/learn" className="flex items-center px-3 py-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-semibold">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-56 bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-all duration-200 z-50">
                  <div className="p-2">
                    <Link href="/gold-rate" className="flex items-center px-3 py-2 text-gray-700 hover:bg-amber-50 rounded-lg transition-colors">
                    ...
                    <Link href="/silver-rate" className="flex items-center px-3 py-2 text-gray-700 hover:bg-slate-50 rounded-lg transition-colors">
                    ...
                    <Link href="/crypto" className="flex items-center px-3 py-2 text-gray-700 hover:bg-yellow-50 rounded-lg transition-colors">
                      <Coins className="w-4 h-4 mr-3 text-yellow-600" />
                      Crypto Rates
                    </Link>
                    <div className="border-t border-gray-100 my-1"></div>
                    <Link href="/news-reel" className="flex items-center px-3 py-2 text-gray-700 hover:bg-green-50 rounded-lg transition-colors">
              ...
              <Link
                href="/real-time-stock-portfolio-tracker"
                className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center"
              ...
              <Link
                href='/invoice-generator-business'
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-64 bg-white/95 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-all duration-200 z-50">
                  <div className="p-2">
                    <Link href="/calculators/bank-locker-finder" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">
                      <Shield className="w-4 h-4 mr-2" />
                      Bank Locker Finder
                    </Link>
                    <Link href="/calculators/bank-charges-analyzer" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">
                      <Percent className="w-4 h-4 mr-2" />
                      Bank Charges Analyzer
                    </Link>
                    <Link href="/missed-call-banking-directory" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">
                      <Zap className="w-4 h-4 mr-2" />
                      Missed Call Banking
                    </Link>
                    <Link href="/calculators/cheque-bounce-charges-calculator" className="flex items-center px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">
                      <Banknote className="w-4 h-4 mr-2" />
                      Cheque Bounce Charges
                    </Link>
                    <div className="border-t border-gray-200 my-1"></div>
                    <Link href="/bank-tools" className="flex items-center px-3 py-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-semibold">
              ...
              <div className="p-4 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <Link href="/calculators/emi-calculator" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-3 bg-slate-50 hover:bg-blue-50 rounded-2xl transition-all border border-slate-100 group">
                    ...
                    <Link href="/calculators/sip-calculator" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-3 bg-slate-50 hover:bg-emerald-50 rounded-2xl transition-all border border-slate-100 group">
                    ...
                    <Link href="/calculators/income-tax-calculator" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-3 bg-slate-50 hover:bg-orange-50 rounded-2xl transition-all border border-slate-100 group">
                    ...
                    <Link href="/calculators" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-3 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-200">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link href="/tools" onClick={() => setIsMobileMenuOpen(false)} className="flex flex-col items-center justify-center p-4 bg-indigo-50 rounded-3xl border border-indigo-100 group">
                  ...
                  <Link href="/ipo" onClick={() => setIsMobileMenuOpen(false)} className="flex flex-col items-center justify-center p-4 bg-rose-50 rounded-3xl border border-rose-100 group">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <Link href="/gold-rate" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-between p-4 bg-amber-50 rounded-2xl border border-amber-100">
                    ...
                    <Link href="/silver-rate" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-200">
                      <div className="flex items-center">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white rounded-[2rem] border border-slate-100 overflow-hidden shadow-sm">
                    <Link href="/learn" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-4 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                      <BookOpen className="w-5 h-5 text-blue-600 mr-4" />
                      <span className="font-bold text-slate-700 flex-1">Learn</span>
                      <ChevronDown className="w-4 h-4 text-slate-400 rotate-[-90deg]" />
                    </Link>
                    <Link href="/blog" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-4 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                      <BookOpen className="w-5 h-5 text-purple-600 mr-4" />
                      <span className="font-bold text-slate-700 flex-1">Blog</span>
                    </Link>
                    <Link href="/news-reel" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-4 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                      <Newspaper className="w-5 h-5 text-emerald-600 mr-4" />
                      <span className="font-bold text-slate-700 flex-1">News</span>
                    </Link>
                    <Link href="/government-schemes" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center p-4 hover:bg-slate-50 transition-colors">
