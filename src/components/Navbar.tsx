...
import { Newspaper, Menu, X, Banknote, PhoneCall } from "lucide-react";
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link 
                to="/missed-call-banking-directory" 
                className="flex items-center bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition-colors text-base font-medium"
                onClick={() => setIsMobileMenuOpen(false)}
              >
