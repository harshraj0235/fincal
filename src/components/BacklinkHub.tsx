...
import { Link as LinkIcon, ExternalLink, TrendingUp, Target, Users, Globe, Award, Search, Filter, CheckCircle, AlertCircle, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            <LinkIcon className="w-8 h-8 text-indigo-600 mx-auto mb-2" />
