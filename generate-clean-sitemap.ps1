...
$uniqueUrls = $uniqueUrls | Where-Object { Is-IndexableUrl $_ }
Write-Host "✅ After filtering blocked patterns: $($uniqueUrls.Count)" -ForegroundColor Green
...
Write-Host "`nClean sitemap generated!" -ForegroundColor Green
...
# Show statistics
$catGroups = $categorizedUrls | Group-Object -Property Category
Write-Host "`nURL Distribution by Category:" -ForegroundColor Cyan
($catGroups | Sort-Object -Property Count -Descending) | ForEach-Object {
    Write-Host "  $($_.Name): $($_.Count) URLs" -ForegroundColor White
}

$priGroups = $categorizedUrls | Group-Object -Property Priority
Write-Host "`nPriority Distribution:" -ForegroundColor Cyan
($priGroups | Sort-Object -Property Name -Descending) | ForEach-Object {
    Write-Host "  Priority $($_.Name): $($_.Count) URLs" -ForegroundColor White
}

Write-Host "`nDone! Review public/sitemap-clean.xml" -ForegroundColor Green
